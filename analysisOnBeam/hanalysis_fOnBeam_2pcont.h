...
// Mon Aug 13 12:09:11 2018 by ROOT version 6.06/08
...
#ifndef hanalysis_fOnBeam_2pcont_h
#define hanalysis_fOnBeam_2pcont_h
...
class hanalysis_fOnBeam_2pcont : public TSelector {
public :
   ...
   hanalysis_fOnBeam_2pcont(TTree * /*tree*/ =0) { }
   virtual ~hanalysis_fOnBeam_2pcont() { }
   ...
   ClassDef(hanalysis_fOnBeam_2pcont,0);

};

#endif

#ifdef hanalysis_fOnBeam_2pcont_cxx
void hanalysis_fOnBeam_2pcont::Init(TTree *tree)
{
...
Bool_t hanalysis_fOnBeam_2pcont::Notify()
{
...
#endif // #ifdef hanalysis_fOnBeam_2pcont_cxx
