...
// Mon Aug 13 12:09:02 2018 by ROOT version 6.06/08
...
#ifndef hanalysis_fOnBeam_3trks_h
#define hanalysis_fOnBeam_3trks_h
...
class hanalysis_fOnBeam_3trks : public TSelector {
public :
   ...
   hanalysis_fOnBeam_3trks(TTree * /*tree*/ =0) { }
   virtual ~hanalysis_fOnBeam_3trks() { }
   ...
   ClassDef(hanalysis_fOnBeam_3trks,0);

};

#endif

#ifdef hanalysis_fOnBeam_3trks_cxx
void hanalysis_fOnBeam_3trks::Init(TTree *tree)
{
...
Bool_t hanalysis_fOnBeam_3trks::Notify()
{
...
#endif // #ifdef hanalysis_fOnBeam_3trks_cxx
