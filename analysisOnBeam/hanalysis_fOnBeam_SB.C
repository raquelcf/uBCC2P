...
// The class definition in hanalysis_fOnBeam_SB.h has been generated automatically
...
//
// root> T->Process("hanalysis_fOnBeam_SB.C")
// root> T->Process("hanalysis_fOnBeam_SB.C","some options")
// root> T->Process("hanalysis_fOnBeam_SB.C+")
//
...
double EnuCCQE(double emuon, double pmuon, double cosmuon) {
  // the W boson is absorbed by a nucleon of mass M at rest
  double mmuon= 105.6/1000.;
  double M = 0.938;

  double numeccqe = M*emuon - (mmuon*mmuon)/2.;
  double deneccqe = M-emuon + pmuon*cosmuon;

  double eccqe = numeccqe /deneccqe;
  return eccqe; // return result in GeV
}
...
void hanalysis_fOnBeam_SB::Begin(TTree * /*tree*/)
{
   ...
   fanalysis_OnBeam_PID= new TFile("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/analysis_OnBeam_PRL_SB.root","RECREATE");
   outfileOnBeam_PID.open("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/info_PRL_OnBeam_SB.txt");
   outfileOnBeam_evt.open("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/evd_all2P_OnBeam_PRL_SB.txt");
   outfileOnBeam_evt_btb_hammer.open("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/evd_all2P_btb_OnBeam_hammerLF_PRL_SB.txt");
   outfileOnBeam_evt_btb_CM.open("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/evd_all2P_btb_OnBeam_CM_PRL_SB.txt");
   outfileOnBeam_evt_btb_nobtbLFlowPT_CM.open("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/evd_all2P__btb_nobtbLFlowPT_CM_OnBeam_PRL_SB.txt");

   outfileOnBeam_evt_lowPT_prel2_golden.open("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/evd_golden_SB.txt");
   outfileOnBeam_evt_lowPT_candidates.open("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/evd_candidates_SB.txt");
   ...
   reco_projprel_OnBeam_lowPT= new TH1D("reco_projprel_OnBeam_lowPT", "reco_projprel_OnBeam_lowPT", 10, 0.,1.2);
   reco_projprel_OnBeam_lowPT_1binCM= new TH1D("reco_projprel_OnBeam_lowPT_1binCM", "reco_projprel_OnBeam_lowPT_1binCM", 10, 0.,1.2);
   reco_projprel_OnBeam= new TH1D("reco_projprel_OnBeam", "reco_projprel_OnBeam", 10, 0.,1.2);
   reco_projprel_OnBeam_1binCM= new TH1D("reco_projprel_OnBeam_1binCM", "reco_projprel_OnBeam_1binCM", 10, 0.,1.2);
...
Bool_t hanalysis_fOnBeam_SB::Process(Long64_t entry)
{
   ...
   if(track_pfp_Id.GetSize()==3){/// minColl requirement
     ...
     if(muind !=-1 && p1ind !=-1 && p2ind !=-1 && tempflag){/// requirements
       ...
       if(minColl){
	 //if(track_pfp_chi2_proton[muind]>88. && track_pfp_chi2_proton[p1ind]<88. &&track_pfp_chi2_proton[p2ind]<88.){// selects 1 muon + 2proton
	 if(track_pfp_chi2_proton[muind]>88. && (track_pfp_chi2_proton[p1ind]>88. || track_pfp_chi2_proton[p2ind]> 88.)){// selects 1 muon + 2proton \\ ***SB
	 ...
	 //std::cout<<"pasa por el corte de 300 MeV en los dos protones"<<std::endl;
	     ...
	     reco_projprel_OnBeam->Fill(projprel);

	     if(reco_CosAnglep1p2CM<-0.9) {
	       all2p++;
	       reco_PT_OnBeam_1binCM_PID->Fill(reco_PTmiss);
	       reco_projprel_OnBeam_1binCM->Fill(projprel);
	     }
	     ...
	     if(reco_PTmiss<0.3) {
	       ...
	       reco_projprel_OnBeam_lowPT->Fill(projprel);
	   ...
	   if(reco_CosAnglep1p2CM<-0.9) {
	     ...
	     reco_projprel_OnBeam_lowPT_1binCM->Fill(projprel);
...
void hanalysis_fOnBeam_SB::Terminate()
{
  ...
  cout<<" number of entries low PT and prel/2>300MeV/c = " << n14<<std::endl;
  cout<<" total prel/2>300 and low PT 1rst bin = " <<ncCM1st <<std::endl;

  cout << "longest proton "<<maxplen <<" max momentum "<< maxpm << endl;
  ...
  c1->Update();
  c1-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/selall_dEdx_vs_resrange_all_PID_OnBeam.eps");
  ...
  gStyle->SetTitleOffset(1.,"x");
   ...
   c3->Update();
   c3-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_p1_p2_300.pdf");
   c3-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_p1_p2_300.eps");
   ...
   c4->Update();
   c4-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_costheta_lab_vs_p2_300.pdf");
   c4-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_costheta_lab_vs_p2_300.eps");
   ...
   c5->Update();
   c5-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_costheta_lab_vs_costheta_CM_300.pdf");
   c5-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_costheta_lab_vs_costheta_CM_300.eps");
   ...
   c6->Update();
   c6-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_costheta_lab_vs_costheta_CM_300_rmp1p2btb.pdf");
   c6-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_costheta_lab_vs_costheta_CM_300_rmp1p2btb.eps");
   ...
   c7->Update();
   c7-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_costheta_lab_vs_p2_300_btb.pdf");
   c7-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_costheta_lab_vs_p2_300_btb.eps");
   ...
   c8->Update();
   c8-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_Enu_vs_difcostheta.pdf");
   c8-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_Enu_vs_difcostheta.eps");
   ...
   c9->Update();
   c9-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_PT_vs_difcostheta.pdf");
   c9-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_PT_vs_difcostheta.eps");
  ...
  c10->Update();
  c10->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/EnuReco_PID_OnBeam.pdf");
  c10->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/EnuReco_PID_OnBeam.eps");
  ...
  c11->Update();
  c11->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/PTReco_PID_OnBeam.pdf");  
  c11->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/PTReco_PID_OnBeam.eps");
  ...
  c12->Update();
  c12->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/pnReco_PID_OnBeam.pdf");  
  c12->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/pnReco_PID_OnBeam.eps");
  ...
  c13->Update();
  c13->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/cosanglep1p2RecoLF_PID_OnBeam_zoom.pdf");  
  c13->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/cosanglep1p2RecoLF_PID_OnBeam_zoom.eps");
  ...
  c14->Update();
  c14->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/cosanglep1p2RecoCM_PID_OnBeam_zoom.pdf");  
  c14->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/cosanglep1p2RecoCM_PID_OnBeam_zoom.eps");
  ...
  c15->Update();
  c15->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/PTReco_1bibCM_PID_OnBeam.pdf");
  c15->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/PTReco_1bibCM_PID_OnBeam.eps");
  ...
  c16->Update();
  c16->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/costhetaCM_SRCrest_PID_OnBeam.pdf");   
  c16->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/costhetaCM_SRCrest_PID_OnBeam.eps");
  ...
  c17->Update();
  c17->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/costhetaCM_SRCrest_PT_LFbtb_PID_OnBeam.pdf");   
  c17->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/costhetaCM_SRCrest_PT_LFbtb_PID_OnBeam.eps");
  ...
  c18->Update();
  c18->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/reco_PT_nobtbLF_PID_OnBeam.pdf");
  c18->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/reco_PT_nobtbLF_PID_OnBeam.eps");  
  ...
  c19->Update();
  c19->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/costhetaCM_LFbtb_PID_OnBeam.pdf");   
  c19->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/costhetaCM_LFbtb_PID_OnBeam.eps");
  ...
  c20->Update();
  c20->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/costhetaCM_LFbtbPT_PID_OnBeam.pdf");   
  c20->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/costhetaCM_LFbtbPT_PID_OnBeam.eps");  
  ...
  c21->Update();
  c21-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_PT_vs_costhetaCM_sel_SRCPTbtbLF.pdf");
  c21-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_PT_vs_costhetaCM_sel_SRCPTbtbLF.eps");
  ...
  c22->Update();
  c22-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_Pn_vs_costhetaCM_sel_SRCPTbtbLF.pdf");
  c22-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_Pn_vs_costhetaCM_sel_SRCPTbtbLF.eps");
  ...
  c23->Update();
  c23-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_P2_vs_costhetaCM_sel_SRCPTbtbLF.pdf");
  c23-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_P2_vs_costhetaCM_sel_SRCPTbtbLF.eps");
  ...
  c24->Update();
  c24->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/recoEnu_calo_vs_Res_btbLF_OnBeam.pdf");   
  c24->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/recoEnu_calo_vs_Res_btbLF_OnBeam.eps");    
  ...
  c25->Update();
  c25->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/recoEnu_calo_vs_CCQE_btbLF_OnBeam.pdf");       
  c25->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/recoEnu_calo_vs_CCQE_btbLF_OnBeam.eps");
  ...
  c26->Update();
  c26->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/costhetaCM_recotests_PT_LFbtb_OnBeam.pdf");   
  c26->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/costhetaCM_recotests_PT_LFbtb_OnBeam.eps");  
  ...
  c27->Update();
  c27->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/Q2_recotests_SRCrest_PT_LFbtb_OnBeam_1bin.pdf");   
  c27->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/Q2_recotests_SRCrest_PT_LFbtb_OnBeam_1bin.eps");
  ...
  c28->Update();
  c28->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/Q2_recotests_SRCrest_PT_LFbtb_OnBeam.pdf");   
  c28->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/Q2_recotests_SRCrest_PT_LFbtb_OnBeam.eps");    
  ...
  c29->Update();
  c29->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/costhetaCM_testsdeltaE_PT_LFbtb_OnBeam.pdf");   
  c29->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/costhetaCM_testsdeltaE_PT_LFbtb_OnBeam.eps");
  ...
  c30->Update();
  c30->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/diffQ2_recotests_SRCrest_PT_LFbtb_OnBeam.pdf");   
  c30->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/diffQ2_recotests_SRCrest_PT_LFbtb_OnBeam.eps");
   ...
   c31->Update();
   c31-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_diffq3p1p2x.pdf");
   c31-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_diffq3p1p2x.eps");
   ...
   c32->Update();
   c32-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_diffq3p1p2y.pdf");
   c32-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_diffq3p1p2y.eps");
   ...
   c33->Update();
   c33-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_diffq3p1p2z.pdf");
   c33-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_diffq3p1p2z.eps");    
   ...
   c34->Update();
   c34-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_diffq3p1p2z_vs_cosCM.pdf");
   c34-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_diffq3p1p2z_vs_cosCM.eps");
   ...
   c35->Update();
   c35-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_PT_cosCM_nobtbLF.pdf");
   c35-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_PT_cosCM_nobtbLF.eps");
   ...
   c36->Update();
   c36-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_W_cosLF_nocuts.pdf");
   c36-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_W_cosLF_nocuts.eps");
   ...
   c37->Update();
   c37-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_xB_cosLF_nocuts.pdf");
   c37-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_xB_cosLF_nocuts.eps");
   ...
   c38->Update();
   c38-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_W_cosCM_nobtbLF_lowPT.pdf");
   c38-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_W_cosCM_nobtbLF_lowPT.eps");
   ...
   c39->Update();
   c39-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_xB_cosCM_nobtbLF_lowPT.pdf");
   c39-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_xB_cosCM_nobtbLF_lowPT.eps");
   ...
   c40->Update();
   c40-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prel_cosCM_nobtbLF_lowPT.pdf");
   c40-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prel_cosCM_nobtbLF_lowPT.eps");
   ...
   c41->Update();
   c41-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prel_Q2_nocut.pdf");
   c41-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prel_Q2_nocut.eps");
   ...
   c42->Update();
   c42-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prel_Q2_nobtb_lowPT.pdf");
   c42-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prel_Q2_nobtb_lowPT.eps");
   ...
   c43->Update();
   c43-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_q3_q0_nocuts.pdf");
   c43-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_q3_q0_nocuts.eps");
   ...
   c44->Update();
   c44-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_q3_q0_nobtb_lowPT.pdf");
   c44-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_q3_q0_nobtb_lowPT.eps");
   ...
   c45->Update();
   c45-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cp1q3_cCM_nocuts.pdf");
   c45-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cp1q3_cCM_nocuts.eps");
   ...
   c46->Update();
   c46-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cp2q3_cCM_nocuts.pdf");
   c46-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cp2q3_cCM_nocuts.eps");
   ...
   c47->Update();
   c47-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cpnq3_cCM_nocuts.pdf");
   c47-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cpnq3_cCM_nocuts.eps");
   ...
   c48->Update();
   c48-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cp1q3_Q2_nocuts.pdf");
   c48-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cp1q3_Q2_nocuts.eps");
   ...
   c49->Update();
   c49-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cp2q3_Q2_nocuts.pdf");
   c49-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cp2q3_Q2_nocuts.eps");
   ...
   c50->Update();
   c50-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cpnq3_Q2_nocuts.pdf");
   c50-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cpnq3_Q2_nocuts.eps");
   ...
   c51->Update();
   c51-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cp1q3_cCM_nobtb_lowPT.pdf");
   c51-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cp1q3_cCM_nobtb_lowPT.eps");
   ...
   c52->Update();
   c52-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cp2q3_cCM_nobtb_lowPT.pdf");
   c52-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cp2q3_cCM_nobtb_lowPT.eps");
   ...
   c53->Update();
   c53-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cpnq3_cCM_nobtb_lowPT.pdf");
   c53-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cpnq3_cCM_nobtb_lowPT.eps");
   ...
   c54->Update();
   c54-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cp1q3_Q2_nobtb_lowPT.pdf");
   c54-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cp1q3_Q2_nobtb_lowPT.eps");
   ...
   c55->Update();
   c55-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cp2q3_Q2_nobtb_lowPT.pdf");
   c55-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cp2q3_Q2_nobtb_lowPT.eps");
   ...
   c56->Update();
   c56-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cpnq3_Q2_nobtb_lowPT.pdf");
   c56-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cpnq3_Q2_nobtb_lowPT.eps");
   ...
   c57->Update();
   c57-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prelperp_cCM_nocuts.pdf");
   c57-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prelperp_cCM_nocuts.eps");
   ...
   c58->Update();
   c58-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prelp1p2perp_cCM_nocuts.pdf");
   c58-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prelp1p2perp_cCM_nocuts.eps");
   ...
   c59->Update();
   c59-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_ptotperp_cCM_nocuts.pdf");
   c59-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_ptotperp_cCM_nocuts.eps");
   ...
   c60->Update();
   c60-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_ptotp1p2perp_cCM_nocuts.pdf");
   c60-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_ptotp1p2perp_cCM_nocuts.eps");
   ...
   c61->Update();
   c61-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prelperp_cCM_nobtb_lowPT.pdf");
   c61-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prelperp_cCM_nobtb_lowPT.eps");
   ...
   c62->Update();
   c62-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prelp1p2perp_cCM_nobtb_lowPT.pdf");
   c62-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prelp1p2perp_cCM_nobtb_lowPT.eps");
   ...
   c63->Update();
   c63-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_ptotperp_cCM_nobtb_lowPT.pdf");
   c63-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_ptotperp_cCM_nobtb_lowPT.eps");
   ...
   c64->Update();
   c64-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_ptotp1p2perp_cCM_nobtb_lowPT.pdf");
   c64-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_ptotp1p2perp_cCM_nobtb_lowPT.eps");   
   ...
   c65->Update();
   c65-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/ratiocCM_nobtb_lowPT.pdf");
   c65-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/ratiocCM_nobtb_lowPT.eps");
   ...
   c66->Update();
   c66-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_costheta_lab_vs_pT_300.pdf");
   c66-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_costheta_lab_vs_pT_300.eps");
   ...
   c67->Update();
   c67-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prelVStotperp_cCM_lowPT.pdf");
   c67-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prelVStotperp_cCM_lowPT.eps");
   ...
   c68->Update();
   c68-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prelVStotperp_cCM_lowPT_1stbin.pdf");
   c68-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prelVStotperp_cCM_lowPT_1stbin.eps");
   ...
   c69->Update();
   c69-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prelVStotperp_cCM_lowPT_nobin.pdf");
   c69-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prelVStotperp_cCM_lowPT_nobin.eps");
   ...
   c70->Update();
   c70-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prelVSpn_cCM_lowPT_1stbin.pdf");
   c70-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prelVSpn_cCM_lowPT_1stbin.eps");
   ...
   c71->Update();
   c71-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_p2VSpn_cCM_lowPT_1stbin.pdf");
   c71-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_p2VSpn_cCM_lowPT_1stbin.eps");
   ...
   c72->Update();
   c72-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_p2VSpn_cCM_lowPT_golden.pdf");
   c72-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_p2VSpn_cCM_lowPT_golden.eps");
   ...
   c73->Update();
   c73-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_absTotVSRel_lowPT.pdf");
   c73-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_absTotVSRel_lowPT.eps");
   ...
   c74->Update();
   c74-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_absTotVSRel_lowPT_pnup.pdf");
   c74-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_absTotVSRel_lowPT_pnup.eps");
   ...
   c75->Update();
   c75-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_absTotVSRel_lowPT_prel2.pdf");
   c75-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_absTotVSRel_lowPT_prel2.eps");
   ...
   c76->Update();
   c76-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_absTotVSRel_lowPT_prel2_1stbin.pdf");
   c76-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_absTotVSRel_lowPT_prel2_1stbin.eps");
   ...
   c77->Update();
   c77-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_perpTotVSRel_lowPT_pnup.pdf");
   c77-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_perTotVSRel_lowPT_pnup.eps");    
   ...
   c78->Update();
   c78-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_pnVSp2_lowPT_prel2.pdf");
   c78-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_pnVSp2_lowPT_prel2.eps");
   ...
   c79->Update();
   c79-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_pnVSp2_lowPT_prel2_1stbin.pdf");
   c79-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_pnVSp2_lowPT_prel2_1stbin.eps");
   ...
   c80->Update();
   c80-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cCMVSpn_lowPT_prel2.pdf");
   c80-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cCMVSpn_lowPT_prel2.eps");
   ...
   c81->Update();
   c81-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cCMVSabsrel_lowPT_prel2.pdf");
   c81-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cCMVSabsrel_lowPT_prel2.eps");
   ...
   c82->Update();
   c82-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prel2VSpn_lowPT.pdf");
   c82-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prel2VSpn_lowPT.eps");
   ...
   c83->Update();
   c83-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prel2VSpn_lowPT_1stbin.pdf");
   c83-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prel2VSpn_lowPT_1stbin.eps");
   ...
   c84->Update();
   c84-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cCM_PT_nocut.pdf");
   c84-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_cCM_PT_nocut.eps");
   ...
   c85->Update();
   c85-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prelVSpn_cCM_lowPT_1stbincolor.pdf");
   c85-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/SB/Plots/gr_prelVSpn_cCM_lowPT_1stbincolor.eps");
