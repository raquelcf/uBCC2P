#define hanalysis_fOnBeam_SB_cxx
...
#include "hanalysis_fOnBeam_SB.h"
#include <TH2.h>
#include <TStyle.h>
...
ofstream outfileOnBeam_evt_lowPT_prel2_golden;
ofstream outfileOnBeam_evt_lowPT_candidates;
...
TH1D *reco_PT_OnBeam_lowPT_PID;
TH1D *reco_PT_OnBeam_1binCM_PID;
TH1D *reco_PT_OnBeam_1binCM_lowPT_PID;

TH1D *reco_projprel_OnBeam_lowPT;
TH1D *reco_projprel_OnBeam_lowPT_1binCM;
TH1D *reco_projprel_OnBeam;
TH1D *reco_projprel_OnBeam_1binCM;

TH1D *reco_pnp2_OnBeam_lowPT;
TH1D *reco_pnp2_OnBeam_lowPT_1binCM;
TH1D *reco_pnp2_OnBeam;
TH1D *reco_pnp2_OnBeam_1binCM;
TH1D *reco_pnp2_OnBeam_lowPT_prel;
TH1D *reco_pnp2_OnBeam_lowPT_prel_1binCM;
...
TH1D *reco_pn_OnBeam_nobtbLF_PID;
TH1D *reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin;
TH1D *reco_angle_p1p2_OnBeam_PID_CM_rebin;

TH1D *reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin1;
TH1D *reco_angle_p1p2_OnBeam_PID_CM_rebin1;
TH1D *reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin2;
TH1D *reco_angle_p1p2_OnBeam_PID_CM_rebin2;
TH1D *reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin3;
TH1D *reco_angle_p1p2_OnBeam_PID_CM_rebin3;

// per cut

TH1D *reco_angle_p1p2_OnBeam_PT_PID_CM_rebin3;
TH1D *reco_angle_p1p2_OnBeam_btb_PID_CM_rebin3;

TH1D *reco_pn_OnBeam_PID_all;
TH1D *reco_pn_OnBeam_PID_lowPT;
TH1D *reco_pn_OnBeam_PID_lowPT_1stbin;

TH1D *cosCMT_nocut_OnBeam;
TH1D *cosCMT_nocut_1stbin_OnBeam;
TH1D *cosCMT_lowPT_OnBeam;
TH1D *cosCMT_lowPT_1stbin_OnBeam;
TH1D *cosCMT_lowPT_prel_OnBeam;
TH1D *cosCMT_lowPT_prel_1stbin_OnBeam;

/// PRL
TH1D *reco_angle_p1p2_OnBeam_PT_CM_rebin3;


const int nbinscCMerr = 4;
const double binscCMerr[nbinscCMerr+1] = { -1.,-0.9,-0.8,-0.6,1.};

const int nbinscCMerr1 = 5; // prueba 1
const double binscCMerr1[nbinscCMerr1+1] = { -1.,-0.9,-0.8,-0.6,0.,1.};

const int nbinscCMerr2 = 6; // prueba 2
const double binscCMerr2[nbinscCMerr2+1] = { -1.,-0.9,-0.8,-0.6,0.,0.4,1.};

const int nbinscCMerr3 = 9; // prueba 2
const double binscCMerr3[nbinscCMerr3+1] = { -1.,-0.9,-0.8,-0.6,-0.4,-0.2,0.,0.2,0.5,1.};

TH1D *reco_pn_OnBeam_nobtbLF_PT_PID;
TH1D *reco_Enu_OnBeam_nobtbLF_PT_PID;
TH1D *reco_projprel_OnBeam_nobtb_lowPT;
TH1D *reco_projptot_OnBeam_nobtb_lowPT;
...
Int_t all2p=0, allpT2p=0, firstpT2p=0, allnobtb2p=0, firstnobtb2p=0;
...
std::vector<double> cosCMT_nocut;
std::vector<double> cosCMT_nocut_1stbin;
std::vector<double> PT_nocut_1stbin;
Int_t n5 = 0;/// selCM
...
///// PRL
Int_t n10 =0;
std::vector<double> projprel_lowPT;
std::vector<double> projptot_lowPT;

std::vector<double> projpn_lowPT;
std::vector<double> projp2_lowPT;

std::vector<double> cosCMT_lowPT;
std::vector<double> cosCMT_lowPT_1stbin;

Int_t n11 =0;
std::vector<double> projprel_lowPT_1stbin;
std::vector<double> projptot_lowPT_1stbin;
std::vector<double> projpn_lowPT_1stbin;
std::vector<double> projp2_lowPT_1stbin;

Int_t n12 =0;
std::vector<double> projprel_lowPT_nobin;
std::vector<double> projptot_lowPT_nobin;

double avgprel_lowPT_nobin =0.;
double avgprel_lowPT_1stbin =0.;

std::vector<double> projpn_lowPT_golden;
std::vector<double> projp2_lowPT_golden;
int ngolden =0;

Int_t n13 =0;
std::vector<double> projprel_lowPT_pnup;
std::vector<double> projptot_lowPT_pnup;

std::vector<double> projpn_lowPT_pnup;
std::vector<double> projp2_lowPT_pnup;

Int_t n14 =0;
Int_t ncCM1st =0;// candidates after rel momenta>300
std::vector<double> cCM_lowPT_prel;
std::vector<double> projptot_lowPT_prel;
std::vector<double> projprel_lowPT_prel_1stbin;

std::vector<double> projpn_lowPT_prel;
std::vector<double> projp2_lowPT_prel;

std::vector<double> projpn_lowPT_prel_1stbin;
std::vector<double> projp2_lowPT_prel_1stbin;

std::vector<double> cosCMT_lowPT_prel;
std::vector<double> cosCMT_lowPT_prel_1stbin;

Int_t n15=0;
std::vector<double> projprel_lowPT_noprel_1stbin;
std::vector<double> projpn_lowPT_noprel_1stbin;
...
int cosCMT_nocut1srtbin =0;
int cosCMT_lowPT1srtbin =0;
int cosCMT_lowPTprel1srtbin =0;
...
void hanalysis_fOnBeam_SB::Begin(TTree * /*tree*/)
{
   ...
   fanalysis_OnBeam_PID= new TFile("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/MC/analysis_SB_OnBeam_PRL.root","RECREATE");
   outfileOnBeam_PID.open("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/MC/info_PRL_OnBeam_SB.txt");
   outfileOnBeam_evt.open("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/MC/evd_all2P_OnBeam_PRL_SB.txt");
   outfileOnBeam_evt_btb_hammer.open("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/MC/evd_all2P_btb_OnBeam_hammerLF_PRL_SB.txt");
   outfileOnBeam_evt_btb_CM.open("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/MC/evd_all2P_btb_OnBeam_CM_PRL_SB.txt");
   outfileOnBeam_evt_btb_nobtbLFlowPT_CM.open("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/MC/evd_all2P__btb_nobtbLFlowPT_CM_OnBeam_PRL_SB.txt");

   outfileOnBeam_evt_lowPT_prel2_golden.open("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/MC/evd_golden_SB.txt");
   outfileOnBeam_evt_lowPT_candidates.open("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/MC/evd_candidates_SB.txt");
   ...
   reco_PT_OnBeam_lowPT_PID= new TH1D("reco_PT_OnBeam_lowPT_PID", "reco_PT_OnBeam_lowPT_PID", 10, 0.,2.);
   reco_PT_OnBeam_1binCM_lowPT_PID= new TH1D("reco_PT_OnBeam_1binCM_lowPT_PID", "reco_PT_OnBeam_1binCM_lowPT_PID", 10, 0.,2.);
   ...
   reco_angle_p1p2_OnBeam_PID_CM_rebin= new TH1D("reco_angle_p1p2_OnBeam_PID_CM_rebin", "reco_angle_p1p2_OnBeam_PID_CM_rebin",nbinscCMerr,binscCMerr);

   reco_angle_p1p2_OnBeam_PID_CM_rebin1= new TH1D("reco_angle_p1p2_OnBeam_PID_CM_rebin1", "reco_angle_p1p2_OnBeam_PID_CM_rebin1",nbinscCMerr1,binscCMerr1);
   reco_angle_p1p2_OnBeam_PID_CM_rebin2= new TH1D("reco_angle_p1p2_OnBeam_PID_CM_rebin2", "reco_angle_p1p2_OnBeam_PID_CM_rebin2",nbinscCMerr2,binscCMerr2);
   reco_angle_p1p2_OnBeam_PID_CM_rebin3= new TH1D("reco_angle_p1p2_OnBeam_PID_CM_rebin3", "reco_angle_p1p2_OnBeam_PID_CM_rebin3",nbinscCMerr3,binscCMerr3);

   reco_angle_p1p2_OnBeam_btb_PID_CM_rebin3= new TH1D("reco_angle_p1p2_OnBeam_btb_PID_CM_rebin3", "reco_angle_p1p2_OnBeam_btb_PID_CM_rebin3",nbinscCMerr3,binscCMerr3);
   reco_angle_p1p2_OnBeam_PT_PID_CM_rebin3= new TH1D("reco_angle_p1p2_OnBeam_PT_PID_CM_rebin3", "reco_angle_p1p2_OnBeam_PT_PID_CM_rebin3",nbinscCMerr3,binscCMerr3);
   ...
   reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin= new TH1D("reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin", "reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin",nbinscCMerr,binscCMerr);

   reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin1= new TH1D("reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin1", "reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin1",nbinscCMerr1,binscCMerr1);
   reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin2= new TH1D("reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin2", "reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin2",nbinscCMerr2,binscCMerr2);
   reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin3= new TH1D("reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin3", "reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin3",nbinscCMerr3,binscCMerr3);
   ...
   reco_angle_p1p2_OnBeam_PT_CM_rebin3= new TH1D("reco_angle_p1p2_OnBeam_PT_CM_rebin3", "reco_angle_p1p2_OnBeam_PT_CM_rebin3",nbinscCMerr3,binscCMerr3);
   
   /////////////////

   reco_pn_OnBeam_nobtbLF_PID= new TH1D("reco_pn_OnBeam_nobtbLF_PID", "reco_pn_OnBeam_nobtbLF_PID", 10, 0.,2.);

   reco_pn_OnBeam_nobtbLF_PT_PID= new TH1D("reco_pn_OnBeam_nobtbLF_PT_PID", "reco_pn_OnBeam_nobtbLF_PT_PID", 10, 0.,2.);
   reco_Enu_OnBeam_nobtbLF_PT_PID = new TH1D("reco_Enu_OnBeam_nobtbLF_PT_PID", "reco_Enu_OnBeam_nobtbLF_PT_PID", 10, 0.,2.5);
   reco_projprel_OnBeam_nobtb_lowPT= new TH1D("reco_projprel_OnBeam_nobtb_lowPT", "reco_projprel_OnBeam_nobtb_lowPT", 10, 0.,2.);
   reco_projptot_OnBeam_nobtb_lowPT= new TH1D("reco_projptot_OnBeam_nobtb_lowPT", "reco_projptot_OnBeam_nobtb_lowPT", 10, 0.,2.);

   reco_projprel_OnBeam_lowPT= new TH1D("reco_projprel_OnBeam_lowPT", "reco_projprel_OnBeam_lowPT", 10, 0.,1.);
   reco_projprel_OnBeam_lowPT_1binCM= new TH1D("reco_projprel_OnBeam_lowPT_1binCM", "reco_projprel_OnBeam_lowPT_1binCM", 10, 0.,1.);
   reco_projprel_OnBeam= new TH1D("reco_projprel_OnBeam", "reco_projprel_OnBeam", 10, 0.,1.);
   reco_projprel_OnBeam_1binCM= new TH1D("reco_projprel_OnBeam_1binCM", "reco_projprel_OnBeam_1binCM", 10, 0.,1.);

   reco_pnp2_OnBeam_lowPT= new TH1D("reco_pnp2_OnBeam_lowPT", "reco_pnp2_OnBeam_lowPT", 10, 0.,1.);
   reco_pnp2_OnBeam_lowPT_1binCM= new TH1D("reco_pnp2_OnBeam_lowPT_1binCM", "reco_pnp2_OnBeam_lowPT_1binCM", 10, 0.,1.);
   reco_pnp2_OnBeam= new TH1D("reco_pnp2_OnBeam", "reco_pnp2_OnBeam", 10, 0.,1.);
   reco_pnp2_OnBeam_1binCM= new TH1D("reco_pnp2_OnBeam_1binCM", "reco_pnp2_OnBeam_1binCM", 10, 0.,1.);
   reco_pnp2_OnBeam_lowPT_prel= new TH1D("reco_pnp2_OnBeam_lowPT_prel", "reco_pnp2_OnBeam_lowPT_prel", 10, 0.,1.);
   reco_pnp2_OnBeam_lowPT_prel_1binCM= new TH1D("reco_pnp2_OnBeam_lowPT_prel_1binCM", "reco_pnp2_OnBeam_lowPT_prel_1binCM", 10, 0.,1.);
   
   reco_pn_OnBeam_PID_all= new TH1D("reco_pn_OnBeam_PID_all", "reco_pn_OnBeam_PID_all", 20, 0.,2.);
   reco_pn_OnBeam_PID_lowPT= new TH1D("reco_pn_OnBeam_PID_lowPT", "reco_pn_OnBeam_PID_lowPT", 20, 0.,2.);
   reco_pn_OnBeam_PID_lowPT_1stbin= new TH1D("reco_pn_OnBeam_PID_lowPT_1stbin", "reco_pn_OnBeam_PID_lowPT_1stbin", 20, 0.,2.);

   cosCMT_nocut_OnBeam = new TH1D("cosCMT_nocut_OnBeam", "cosCMT_nocut_OnBeam",20, -1,1);
   cosCMT_nocut_1stbin_OnBeam = new TH1D("cosCMT_nocut_1stbin_OnBeam", "cosCMT_nocut_1stbin_OnBeam",20, -1,1);
   cosCMT_lowPT_OnBeam = new TH1D("cosCMT_lowPT_OnBeam", "cosCMT_lowPT_OnBeam",20, -1,1);
   cosCMT_lowPT_1stbin_OnBeam = new TH1D("cosCMT_lowPT_1stbin_OnBeam", "cosCMT_lowPT_1stbin_OnBeam",20, -1,1);
   cosCMT_lowPT_prel_OnBeam = new TH1D("cosCMT_lowPT_prel_OnBeam", "cosCMT_lowPT_prel_OnBeam",20, -1,1);
   cosCMT_lowPT_prel_1stbin_OnBeam = new TH1D("cosCMT_lowPT_prel_1stbin_OnBeam", "cosCMT_lowPT_prel_1stbin_OnBeam",20, -1,1);
   
}

void hanalysis_fOnBeam_SB::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t hanalysis_fOnBeam_SB::Process(Long64_t entry)
{
   ...
   if(track_pfp_Id.GetSize()==3){/// minColl requirement
	 ...
	 //std::cout<<"pasa por el corte de 300 MeV en los dos protones"<<std::endl;
       ...
       */
       ...
       TVector3 protonP2Trans;
       protonP2Trans[0] = protonP2[0];
       protonP2Trans[1] = protonP2[1];
       protonP2Trans[2] = 0;
       ...
       double normprotonP2Trans = sqrt(pow(protonP2Trans[0],2) + pow(protonP2Trans[1],2));
       double normPnTrans = sqrt(pow(PnTrans[0],2) + pow(PnTrans[1],2));
       
       if(reco_Enuvis>0) reco_CosCMT = protonP2Trans.Dot(PnTrans);
       reco_CosCMT =  reco_CosCMT/(normprotonP2Trans*normPnTrans);
	 ...
	 selmuon_chi2proton_uncont_OnBeam_PID->Fill(track_pfp_chi2_proton[muind]);
       ...
       if(track_pfp_length[p1ind] > maxplen) {
	 maxplen = track_pfp_length[p1ind];
	 maxpm= track_pfp_Mom_p[p1ind];
       }
       double fakepitch =0.;
       kinetic_energy1 =0.;
	 ...
	 cosCMT_nocut.push_back(reco_CosCMT);
	 cosCMT_nocut_OnBeam->Fill(reco_CosCMT);

	 if(reco_CosCMT<-0.9) cosCMT_nocut1srtbin++;
	 ...
	 reco_pn_OnBeam_PID_all->Fill(norm_recopndirT);
	 ...
	 reco_angle_p1p2_OnBeam_PID_CM_rebin->Fill(reco_CosAnglep1p2CM);
	 reco_angle_p1p2_OnBeam_PID_CM_rebin1->Fill(reco_CosAnglep1p2CM);
	 reco_angle_p1p2_OnBeam_PID_CM_rebin2->Fill(reco_CosAnglep1p2CM);
	 reco_angle_p1p2_OnBeam_PID_CM_rebin3->Fill(reco_CosAnglep1p2CM);
	 reco_kp1p2_OnBeam_PID->Fill(kp1p2);
	 reco_projprel_OnBeam->Fill(projprel/2);
	 reco_pnp2_OnBeam->Fill(norm_recopndirT-track_pfp_Mom_p[p2ind]);
	 
	 if(reco_CosAnglep1p2CM<-0.9) {
	   all2p++;
	   reco_PT_OnBeam_1binCM_PID->Fill(reco_PTmiss);
	   reco_projprel_OnBeam_1binCM->Fill(projprel/2);
	   reco_pnp2_OnBeam_1binCM->Fill(norm_recopndirT-track_pfp_Mom_p[p2ind]);
	   cosCMT_nocut_1stbin.push_back(reco_CosCMT);
	   cosCMT_nocut_1stbin_OnBeam->Fill(reco_CosCMT);
	   PT_nocut_1stbin.push_back(reco_PTmiss);
	 }
       
	 if(reco_PTmiss<0.3) {
	   reco_angle_p1p2_OnBeam_PT_PID_CM_rebin3->Fill(reco_CosAnglep1p2CM);
	   reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_zoom->Fill(reco_CosAnglep1p2CM);
	   allpT2p++;
	   n10++;
	   reco_PT_OnBeam_lowPT_PID->Fill(reco_PTmiss);
	   reco_projprel_OnBeam_lowPT->Fill(projprel/2);
	   reco_pnp2_OnBeam_lowPT->Fill(norm_recopndirT-track_pfp_Mom_p[p2ind]);
	   
	   projprel_lowPT.push_back(projprel);
	   projptot_lowPT.push_back(projptot);
	   reco_pn_OnBeam_PID_lowPT->Fill(norm_recopndirT);
	   projpn_lowPT.push_back(norm_recopndirT);
	   projp2_lowPT.push_back(track_pfp_Mom_p[p2ind]);
	   reco_angle_p1p2_OnBeam_PT_CM_rebin3->Fill(reco_CosAnglep1p2CM);
	   cosCMT_lowPT.push_back(reco_CosCMT);
	   cosCMT_lowPT_OnBeam->Fill(reco_CosCMT);

	   if(reco_CosCMT<-0.9) cosCMT_lowPT1srtbin++;
	   
	   if(norm_recopndirT>0.25){
	     n13++;
	     projprel_lowPT_pnup.push_back(projprel);
	     projptot_lowPT_pnup.push_back(projptot);
	     projpn_lowPT_pnup.push_back(norm_recopndirT);
	     projp2_lowPT_pnup.push_back(track_pfp_Mom_p[p2ind]);
	   }

	   if(projprel/2>0.3){
	     n14++;
	     cCM_lowPT_prel.push_back(reco_CosAnglep1p2CM);
	     projptot_lowPT_prel.push_back(projptot);
	     projpn_lowPT_prel.push_back(norm_recopndirT);
	     projp2_lowPT_prel.push_back(track_pfp_Mom_p[p2ind]);

	     cosCMT_lowPT_prel.push_back(reco_CosCMT);
	     cosCMT_lowPT_prel_OnBeam->Fill(reco_CosCMT);

	     reco_pnp2_OnBeam_lowPT_prel->Fill(norm_recopndirT-track_pfp_Mom_p[p2ind]);
	     
	     if(reco_CosCMT<-0.9) cosCMT_lowPTprel1srtbin++;
	     
	     if(reco_CosAnglep1p2CM<-0.9){
	       ncCM1st++;
	       reco_pnp2_OnBeam_lowPT_prel_1binCM->Fill(norm_recopndirT-track_pfp_Mom_p[p2ind]);
	       projpn_lowPT_prel_1stbin.push_back(norm_recopndirT);
	       projp2_lowPT_prel_1stbin.push_back(track_pfp_Mom_p[p2ind]);
	       projprel_lowPT_prel_1stbin.push_back(projprel);
	       cosCMT_lowPT_prel_1stbin.push_back(reco_CosCMT);
	       cosCMT_lowPT_prel_1stbin_OnBeam->Fill(reco_CosCMT);
	       outfileOnBeam_evt_lowPT_prel2_golden<<"run: "<<*run<<" subrun: "<<*subrun<<" event: "<<*event<<" start z muon: "<<track_pfp_startz[muind] <<" end z muon: "<<track_pfp_endz[muind]<< " lenght muon "<<track_pfp_length[muind]<<" cosCM: "<<reco_CosAnglep1p2CM<<" cosLF "<<anglep1p2<<" mom p1 "<<track_pfp_Mom_p[p1ind]<<" mom p2 "<<track_pfp_Mom_p[p2ind]<<" mom muon "<<*track_pfp_mom_mucand<<" reco Enu "<<reco_Enuvis<<" chi2 p1 "<<track_pfp_chi2_proton[p1ind]<<" chi2 p2 "<<track_pfp_chi2_proton[p2ind]<<std::endl;
	     }
	   }
	   else if(projprel/2<=0.3){
	     if(reco_CosAnglep1p2CM<-0.9){
	       n15++;
	       projpn_lowPT_noprel_1stbin.push_back(norm_recopndirT);
	       projprel_lowPT_noprel_1stbin.push_back(projprel);
	     }
	   }
	   ...
	   if(reco_CosAnglep1p2CM<-0.9) {
	     firstpT2p++;
	     n11++;
	     reco_PT_OnBeam_1binCM_lowPT_PID->Fill(reco_PTmiss);
	     reco_projprel_OnBeam_lowPT_1binCM->Fill(projprel/2);
	     reco_pnp2_OnBeam_lowPT_1binCM->Fill(norm_recopndirT-track_pfp_Mom_p[p2ind]);
	     projprel_lowPT_1stbin.push_back(projprel);
	     projptot_lowPT_1stbin.push_back(projptot);
	     reco_pn_OnBeam_PID_lowPT_1stbin->Fill(norm_recopndirT);
	     avgprel_lowPT_1stbin = avgprel_lowPT_1stbin+ projprel;
	     projpn_lowPT_1stbin.push_back(norm_recopndirT);
	     projp2_lowPT_1stbin.push_back(track_pfp_Mom_p[p2ind]);
	     cosCMT_lowPT_1stbin.push_back(reco_CosCMT);
	     cosCMT_lowPT_1stbin_OnBeam->Fill(reco_CosCMT);
	     outfileOnBeam_evt_lowPT_candidates<<"run: "<<*run<<" subrun: "<<*subrun<<" event: "<<*event<<" start z muon: "<<track_pfp_startz[muind] <<" end z muon: "<<track_pfp_endz[muind]<< " lenght muon "<<track_pfp_length[muind]<<" cosCM: "<<reco_CosAnglep1p2CM<<" cosLF "<<anglep1p2<<" mom p1 "<<track_pfp_Mom_p[p1ind]<<" mom p2 "<<track_pfp_Mom_p[p2ind]<<" mom muon "<<*track_pfp_mom_mucand<<" reco Enu "<<reco_Enuvis<<" chi2 p1 "<<track_pfp_chi2_proton[p1ind]<<" chi2 p2 "<<track_pfp_chi2_proton[p2ind]<<std::endl;
	     
	     if(projprel>0.422){
	       projpn_lowPT_golden.push_back(norm_recopndirT);
	       projp2_lowPT_golden.push_back(track_pfp_Mom_p[p2ind]);
	       ngolden++;
	     }
	     
	   }
	   else if(reco_CosAnglep1p2CM>=-0.9){
	     n12++;
	     projprel_lowPT_nobin.push_back(projprel);
	     projptot_lowPT_nobin.push_back(projptot);
	     avgprel_lowPT_nobin = avgprel_lowPT_nobin+ projprel;
	   }
	 }
	 
	 if(anglep1p2>-0.8) {
	   reco_angle_p1p2_OnBeam_btb_PID_CM_rebin3->Fill(reco_CosAnglep1p2CM);
	   allnobtb2p++;
	   if(reco_CosAnglep1p2CM<-0.9) firstnobtb2p++;
	 }
	 ...
	 // removing back-to-back events
	   ...
	   reco_pn_OnBeam_nobtbLF_PID->Fill(norm_recopndirT);
	   ...
	   if(reco_PTmiss<0.3) {
	     //reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_zoom->Fill(reco_CosAnglep1p2CM);
	     reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin->Fill(reco_CosAnglep1p2CM);
	     reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin1->Fill(reco_CosAnglep1p2CM);
	     reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin2->Fill(reco_CosAnglep1p2CM);
	     reco_angle_p1p2_OnBeam_nobtbLF_PT_PID_CM_rebin3->Fill(reco_CosAnglep1p2CM);
	     reco_pn_OnBeam_nobtbLF_PT_PID->Fill(norm_recopndirT);
	     reco_Enu_OnBeam_nobtbLF_PT_PID->Fill(reco_Enuvis);
	     reco_projprel_OnBeam_nobtb_lowPT->Fill(projprel);
	     reco_projptot_OnBeam_nobtb_lowPT->Fill(projptot); 
...
void hanalysis_fOnBeam_SB::SlaveTerminate()
{
...
void hanalysis_fOnBeam_SB::Terminate()
{
  ...
  outfileOnBeam_PID<< "........................." << std::endl;
  outfileOnBeam_PID<< "testing cuts independently "<< std::endl;

  outfileOnBeam_PID<< "All CC2proton "<< std::endl;
  outfileOnBeam_PID<< "first bin in CM: "<<all2p << std::endl;
  outfileOnBeam_PID<< "Number of events sel with >300MeV/c, no hammer: "<<allnobtb2p << std::endl;
  outfileOnBeam_PID<< "first bin in CM: "<<firstnobtb2p << std::endl;
  outfileOnBeam_PID<< "Number of events sel with >300MeV/c, low PT: "<<allpT2p << std::endl;
  outfileOnBeam_PID<< "first bin in CM: "<<firstpT2p << std::endl;

  cout<<" total prel = " <<avgprel_lowPT_nobin << "number of entries  "<< n12<<std::endl;
  cout<<" total prel 1rst bin = " <<avgprel_lowPT_1stbin << "number of entries  "<< n11<<std::endl;

  cout<<" golden events = "<< ngolden<<std::endl;


  cout<<" number of entries low PT and pn>250MeV/c = " << n13<<std::endl;
  outfileOnBeam_PID<<" number of entries low PT and prel/2>300MeV/c = " << n14<<std::endl;
  outfileOnBeam_PID<<" total prel/2>300 and low PT 1rst bin = " <<ncCM1st <<std::endl;

  outfileOnBeam_PID<< "longest proton "<<maxplen <<" max momentum "<< maxpm << endl;

  outfileOnBeam_PID<< "........................." << std::endl;
  outfileOnBeam_PID<< "........................." << std::endl;
  outfileOnBeam_PID<<" transverse cos theta 1rst bin, no cuts = " <<cosCMT_nocut1srtbin <<std::endl;
  outfileOnBeam_PID<<" transverse cos theta 1rst bin, low PT = " <<cosCMT_lowPT1srtbin <<std::endl;
  outfileOnBeam_PID<<" transverse cos theta 1rst bin, low PT, prel>300MeV/c = " <<cosCMT_lowPTprel1srtbin <<std::endl;
  ...
  Double_t x11[n1], y11[n1], x22[n2], y22[n2], x33[n3], y33[n3], x22a[n2a], y22a[n2a], x33a[n3a], y33a[n3a], dCMLF[n1], rEnu[n1],rPT[n1], recoPTsel[n5], recocosCMsel[n5], recopnsel[n5], recop2sel[n5], recoq3xp1p2[n1], recoq3yp1p2[n1], recoq3zp1p2[n1], recopTall[n1], recocosCMPT0[n6], recoq3zp1p2PT0[n6], recocCM_nobtb[n7], recopT_nobtb[n7], recocLF[n1], recoWnocut[n1], recoxBnocut[n1], recocCM[n8], recoW_nobtb_lowPT[n8], recoxB_nobtb_lowPT[n8], recoprel_nobtb_lowPT[n8], recoQ2[n1], recoprelnocut[n1], recoQ2_nobtb_lowPT[n8], recoq3_nocut[n1], recoq0_nocut[n1], recoq3_nobtb_lowPT[n8], recoq0_nobtb_lowPT[n8], recocp1q3_nocut[n1], recocp2q3_nocut[n1], recocpnq3_nocut[n1], recocp1q3_nobtb_lowPT[n8], recocp2q3_nobtb_lowPT[n8], recocpnq3_nobtb_lowPT[n8], recoprojprel_nocut[n1],recoprojprelp1p2_nocut[n1], recoprojptot_nocut[n1], recoprojptotp1p2_nocut[n1], recoprojprel_nobtb_lowPT[n8], recoprojprelp1p2_nobtb_lowPT[n8], recoprojptot_nobtb_lowPT[n8], recoprojptotp1p2_nobtb_lowPT[n8], recoprojprel_lowPT[n10], recoprojptot_lowPT[n10], recoprojprel_lowPT_1stbin[n11], recoprojptot_lowPT_1stbin[n11], recoprojprel_lowPT_nobin[n12], recoprojptot_lowPT_nobin[n12], recoprojpn_lowPT[n10], recoprojp2_lowPT[n10], recoprojpn_lowPT_1stbin[n11], recoprojp2_lowPT_1stbin[n11], recoprojpn_lowPT_golden[ngolden], recoprojp2_lowPT_golden[ngolden], recoprojprel2_lowPT_1stbin[n11], recocosCMT_nocut[n1], recocosCMT_lowPT[n10], recocosCMT_lowPT_prel[n14], recocosCMT_nocut_1stbin[all2p], recoPT_nocut_1stbin[all2p], recocosCMT_lowPT_1stbin[n11];

  Double_t recoabstotpnp2_lowPT[n10], recoabsrelpnp2_lowPT[n10], recoabstotpnp2_lowPT_pnup[n13], recoabsrelpnp2_lowPT_pnup[n13],recoabstotpnp2_lowPT_prel2[n14], recoabsrelpnp2_lowPT_prel2[n14], recoabstotpnp2_lowPT_prel2_1stbin[ncCM1st], recoabsrelpnp2_lowPT_prel2_1stbin[ncCM1st], recoprojprel_lowPT_pnup[n13], recoprojptot_lowPT_pnup[n13], recoprojpn_lowPT_prel[n14], recoprojp2_lowPT_prel[n14], recoprojpn_lowPT_prel_1stbin[ncCM1st], recoprojp2_lowPT_prel_1stbin[ncCM1st], recocCM_lowPT_prel[n14], recoprojprel2_lowPT[n10], recoprojprel_lowPT_prel_1stbin[ncCM1st], recoprojprel_lowPT_noprel_1stbin[n15], recoprojpn_lowPT_noprel_1stbin[n15];
  ...
  for (Int_t i=0;i<n1;i++) {
    ...
    recocosCMT_nocut[i] = cosCMT_nocut[i];
  }
  ...
  for (Int_t i=0;i<n10;i++) {
    recoprojprel_lowPT[i]=projprel_lowPT[i];
    recoprojptot_lowPT[i]=projptot_lowPT[i];

    recoprojprel2_lowPT[i] = projprel_lowPT[i]/2;

    recoprojpn_lowPT[i]=projpn_lowPT[i];
    recoprojp2_lowPT[i]=projp2_lowPT[i];

    recoabstotpnp2_lowPT[i] = projpn_lowPT[i] + projp2_lowPT[i];
    recoabsrelpnp2_lowPT[i] = abs(projpn_lowPT[i] - projp2_lowPT[i]);

    recocosCMT_lowPT[i] = cosCMT_lowPT[i];
  }
    for (Int_t i=0;i<n11;i++) {
    recoprojprel_lowPT_1stbin[i]=projprel_lowPT_1stbin[i];
    recoprojptot_lowPT_1stbin[i]=projptot_lowPT_1stbin[i];
    recoprojpn_lowPT_1stbin[i]=projpn_lowPT_1stbin[i];
    recoprojp2_lowPT_1stbin[i]=projp2_lowPT_1stbin[i];
    recoprojprel2_lowPT_1stbin[i] = projprel_lowPT_1stbin[i]/2;
    recocosCMT_lowPT_1stbin[i] = cosCMT_lowPT_1stbin[i];
    }
    for (Int_t i=0;i<n12;i++) {
    recoprojprel_lowPT_nobin[i]=projprel_lowPT_nobin[i];
    recoprojptot_lowPT_nobin[i]=projptot_lowPT_nobin[i];
    }

    for (Int_t i=0;i<ngolden;i++) {
    recoprojpn_lowPT_golden[i]=projpn_lowPT_golden[i];
    recoprojp2_lowPT_golden[i]=projp2_lowPT_golden[i];
    }

    for (Int_t i=0;i<n13;i++) {
    recoabstotpnp2_lowPT_pnup[i] = projpn_lowPT_pnup[i] + projp2_lowPT_pnup[i];
    recoabsrelpnp2_lowPT_pnup[i] = abs(projpn_lowPT_pnup[i] - projp2_lowPT_pnup[i]);
    recoprojprel_lowPT_pnup[i] = projprel_lowPT_pnup[i];
    recoprojptot_lowPT_pnup[i] =  projptot_lowPT_pnup[i];
    }
    
    for (Int_t i=0;i<n14;i++) {
      recoabstotpnp2_lowPT_prel2[i] = projpn_lowPT_prel[i] + projp2_lowPT_prel[i];
      recoabsrelpnp2_lowPT_prel2[i] =  abs(projpn_lowPT_prel[i] - projp2_lowPT_prel[i]);
      recoprojpn_lowPT_prel[i] = projpn_lowPT_prel[i];
      recoprojp2_lowPT_prel[i] = projp2_lowPT_prel[i];
      recocCM_lowPT_prel[i] = cCM_lowPT_prel[i];

      recocosCMT_lowPT_prel[i] = cosCMT_lowPT_prel[i];
    }

    for (Int_t i=0;i<ncCM1st;i++) {
      recoprojpn_lowPT_prel_1stbin[i] = projpn_lowPT_prel_1stbin[i];
      recoprojp2_lowPT_prel_1stbin[i] = projp2_lowPT_prel_1stbin[i];
      recoabstotpnp2_lowPT_prel2_1stbin[i] = projpn_lowPT_prel_1stbin[i] + projp2_lowPT_prel_1stbin[i];
      recoabsrelpnp2_lowPT_prel2_1stbin[i] = abs(projpn_lowPT_prel_1stbin[i] - projp2_lowPT_prel_1stbin[i]);
      recoprojprel_lowPT_prel_1stbin[i] = projprel_lowPT_prel_1stbin[i]/2;
    }

    for (Int_t i=0;i<n15;i++) {
      recoprojprel_lowPT_noprel_1stbin[i] = projprel_lowPT_noprel_1stbin[i]/2;
      recoprojpn_lowPT_noprel_1stbin[i] = projpn_lowPT_noprel_1stbin[i];
    }

    for (Int_t i=0;i<all2p;i++) {
      recocosCMT_nocut_1stbin[i] = cosCMT_nocut_1stbin[i];
      recoPT_nocut_1stbin[i] = PT_nocut_1stbin[i];
    }
  ...
  gStyle->SetTitleOffset(1.,"x");
   ...
   c3->Update();
   c3-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_p1_p2_300.pdf");
   c3-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_p1_p2_300.eps");
   ...
   c4->Update();
   c4-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_costheta_lab_vs_p2_300.pdf");
   c4-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_costheta_lab_vs_p2_300.eps");
   ...
   c5->Update();
   c5-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_costheta_lab_vs_costheta_CM_300.pdf");
   c5-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_costheta_lab_vs_costheta_CM_300.eps");
   ...
   c6->Update();
   c6-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_costheta_lab_vs_costheta_CM_300_rmp1p2btb.pdf");
   c6-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_costheta_lab_vs_costheta_CM_300_rmp1p2btb.eps");
   ...
   c7->Update();
   c7-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_costheta_lab_vs_p2_300_btb.pdf");
   c7-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_costheta_lab_vs_p2_300_btb.eps");
   ...
   c8->Update();
   c8-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_Enu_vs_difcostheta.pdf");
   c8-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_Enu_vs_difcostheta.eps");
   ...
   c9->Update();
   c9-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_PT_vs_difcostheta.pdf");
   c9-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_PT_vs_difcostheta.eps");
  ...
  c10->Update();
  c10->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/EnuReco_PID_OnBeam.pdf");
  c10->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/EnuReco_PID_OnBeam.eps");
  ...
  c11->Update();
  c11->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/PTReco_PID_OnBeam.pdf");  
  c11->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/PTReco_PID_OnBeam.eps");
  ...
  c12->Update();
  c12->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/pnReco_PID_OnBeam.pdf");  
  c12->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/pnReco_PID_OnBeam.eps");
  ...
  c13->Update();
  c13->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/cosanglep1p2RecoLF_PID_OnBeam_zoom.pdf");  
  c13->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/cosanglep1p2RecoLF_PID_OnBeam_zoom.eps");
  ...
  c14->Update();
  c14->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/cosanglep1p2RecoCM_PID_OnBeam_zoom.pdf");  
  c14->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/cosanglep1p2RecoCM_PID_OnBeam_zoom.eps");
  ...
  c15->Update();
  c15->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/PTReco_1bibCM_PID_OnBeam.pdf");
  c15->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/PTReco_1bibCM_PID_OnBeam.eps");
  ...
  c16->Update();
  c16->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/costhetaCM_SRCrest_PID_OnBeam.pdf");   
  c16->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/costhetaCM_SRCrest_PID_OnBeam.eps");
  ...
  c17->Update();
  c17->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/costhetaCM_SRCrest_PT_LFbtb_PID_OnBeam.pdf");   
  c17->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/costhetaCM_SRCrest_PT_LFbtb_PID_OnBeam.eps");
  ...
  c18->Update();
  c18->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/reco_PT_nobtbLF_PID_OnBeam.pdf");
  c18->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/reco_PT_nobtbLF_PID_OnBeam.eps");  
  ...
  c19->Update();
  c19->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/costhetaCM_LFbtb_PID_OnBeam.pdf");   
  c19->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/costhetaCM_LFbtb_PID_OnBeam.eps");
  ...
  c20->Update();
  c20->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/costhetaCM_LFbtbPT_PID_OnBeam.pdf");   
  c20->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/costhetaCM_LFbtbPT_PID_OnBeam.eps");  
  ...
  c21->Update();
  c21-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_PT_vs_costhetaCM_sel_SRCPTbtbLF.pdf");
  c21-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_PT_vs_costhetaCM_sel_SRCPTbtbLF.eps");
  ...
  c22->Update();
  c22-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_Pn_vs_costhetaCM_sel_SRCPTbtbLF.pdf");
  c22-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_Pn_vs_costhetaCM_sel_SRCPTbtbLF.eps");
  ...
  c23->Update();
  c23-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_P2_vs_costhetaCM_sel_SRCPTbtbLF.pdf");
  c23-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_P2_vs_costhetaCM_sel_SRCPTbtbLF.eps");
  ...
  c24->Update();
  c24->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/recoEnu_calo_vs_Res_btbLF_OnBeam.pdf");   
  c24->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/recoEnu_calo_vs_Res_btbLF_OnBeam.eps");    
  ...
  c25->Update();
  c25->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/recoEnu_calo_vs_CCQE_btbLF_OnBeam.pdf");       
  c25->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/recoEnu_calo_vs_CCQE_btbLF_OnBeam.eps");
  ...
  c26->Update();
  c26->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/costhetaCM_recotests_PT_LFbtb_OnBeam.pdf");   
  c26->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/costhetaCM_recotests_PT_LFbtb_OnBeam.eps");  
  ...
  c27->Update();
  c27->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/Q2_recotests_SRCrest_PT_LFbtb_OnBeam_1bin.pdf");   
  c27->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/Q2_recotests_SRCrest_PT_LFbtb_OnBeam_1bin.eps");
  ...
  c28->Update();
  c28->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/Q2_recotests_SRCrest_PT_LFbtb_OnBeam.pdf");   
  c28->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/Q2_recotests_SRCrest_PT_LFbtb_OnBeam.eps");    
  ...
  c29->Update();
  c29->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/costhetaCM_testsdeltaE_PT_LFbtb_OnBeam.pdf");   
  c29->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/costhetaCM_testsdeltaE_PT_LFbtb_OnBeam.eps");
  ...
  c30->Update();
  c30->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/diffQ2_recotests_SRCrest_PT_LFbtb_OnBeam.pdf");   
  c30->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/diffQ2_recotests_SRCrest_PT_LFbtb_OnBeam.eps");
   ...
   c31->Update();
   c31-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_diffq3p1p2x.pdf");
   c31-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_diffq3p1p2x.eps");
   ...
   c32->Update();
   c32-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_diffq3p1p2y.pdf");
   c32-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_diffq3p1p2y.eps");
   ...
   c33->Update();
   c33-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_diffq3p1p2z.pdf");
   c33-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_diffq3p1p2z.eps");    
   ...
   c34->Update();
   c34-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_diffq3p1p2z_vs_cosCM.pdf");
   c34-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_diffq3p1p2z_vs_cosCM.eps");
   ...
   c35->Update();
   c35-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_PT_cosCM_nobtbLF.pdf");
   c35-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_PT_cosCM_nobtbLF.eps");
   ...
   c36->Update();
   c36-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_W_cosLF_nocuts.pdf");
   c36-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_W_cosLF_nocuts.eps");
   ...
   c37->Update();
   c37-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_xB_cosLF_nocuts.pdf");
   c37-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_xB_cosLF_nocuts.eps");
   ...
   c38->Update();
   c38-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_W_cosCM_nobtbLF_lowPT.pdf");
   c38-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_W_cosCM_nobtbLF_lowPT.eps");
   ...
   c39->Update();
   c39-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_xB_cosCM_nobtbLF_lowPT.pdf");
   c39-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_xB_cosCM_nobtbLF_lowPT.eps");
   ...
   c40->Update();
   c40-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prel_cosCM_nobtbLF_lowPT.pdf");
   c40-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prel_cosCM_nobtbLF_lowPT.eps");
   ...
   c41->Update();
   c41-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prel_Q2_nocut.pdf");
   c41-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prel_Q2_nocut.eps");
   ...
   c42->Update();
   c42-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prel_Q2_nobtb_lowPT.pdf");
   c42-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prel_Q2_nobtb_lowPT.eps");
   ...
   c43->Update();
   c43-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_q3_q0_nocuts.pdf");
   c43-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_q3_q0_nocuts.eps");
   ...
   c44->Update();
   c44-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_q3_q0_nobtb_lowPT.pdf");
   c44-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_q3_q0_nobtb_lowPT.eps");
   ...
   c45->Update();
   c45-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cp1q3_cCM_nocuts.pdf");
   c45-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cp1q3_cCM_nocuts.eps");
   ...
   c46->Update();
   c46-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cp2q3_cCM_nocuts.pdf");
   c46-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cp2q3_cCM_nocuts.eps");
   ...
   c47->Update();
   c47-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cpnq3_cCM_nocuts.pdf");
   c47-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cpnq3_cCM_nocuts.eps");
   ...
   c48->Update();
   c48-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cp1q3_Q2_nocuts.pdf");
   c48-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cp1q3_Q2_nocuts.eps");
   ...
   c49->Update();
   c49-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cp2q3_Q2_nocuts.pdf");
   c49-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cp2q3_Q2_nocuts.eps");
   ...
   c50->Update();
   c50-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cpnq3_Q2_nocuts.pdf");
   c50-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cpnq3_Q2_nocuts.eps");
   ...
   c51->Update();
   c51-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cp1q3_cCM_nobtb_lowPT.pdf");
   c51-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cp1q3_cCM_nobtb_lowPT.eps");
   ...
   c52->Update();
   c52-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cp2q3_cCM_nobtb_lowPT.pdf");
   c52-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cp2q3_cCM_nobtb_lowPT.eps");
   ...
   c53->Update();
   c53-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cpnq3_cCM_nobtb_lowPT.pdf");
   c53-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cpnq3_cCM_nobtb_lowPT.eps");
   ...
   c54->Update();
   c54-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cp1q3_Q2_nobtb_lowPT.pdf");
   c54-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cp1q3_Q2_nobtb_lowPT.eps");
   ...
   c55->Update();
   c55-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cp2q3_Q2_nobtb_lowPT.pdf");
   c55-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cp2q3_Q2_nobtb_lowPT.eps");
   ...
   c56->Update();
   c56-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cpnq3_Q2_nobtb_lowPT.pdf");
   c56-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cpnq3_Q2_nobtb_lowPT.eps");
   ...
   c57->Update();
   c57-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prelperp_cCM_nocuts.pdf");
   c57-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prelperp_cCM_nocuts.eps");
   ...
   c58->Update();
   c58-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prelp1p2perp_cCM_nocuts.pdf");
   c58-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prelp1p2perp_cCM_nocuts.eps");
   ...
   c59->Update();
   c59-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_ptotperp_cCM_nocuts.pdf");
   c59-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_ptotperp_cCM_nocuts.eps");
   ...
   c60->Update();
   c60-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_ptotp1p2perp_cCM_nocuts.pdf");
   c60-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_ptotp1p2perp_cCM_nocuts.eps");
   ...
   c61->Update();
   c61-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prelperp_cCM_nobtb_lowPT.pdf");
   c61-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prelperp_cCM_nobtb_lowPT.eps");
   ...
   c62->Update();
   c62-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prelp1p2perp_cCM_nobtb_lowPT.pdf");
   c62-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prelp1p2perp_cCM_nobtb_lowPT.eps");
   ...
   c63->Update();
   c63-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_ptotperp_cCM_nobtb_lowPT.pdf");
   c63-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_ptotperp_cCM_nobtb_lowPT.eps");
   ...
   c64->Update();
   c64-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_ptotp1p2perp_cCM_nobtb_lowPT.pdf");
   c64-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_ptotp1p2perp_cCM_nobtb_lowPT.eps");   
   ...
   c65->Update();
   c65-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/ratiocCM_nobtb_lowPT.pdf");
   c65-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/ratiocCM_nobtb_lowPT.eps");
   ...
   c66->Update();
   c66-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_costheta_lab_vs_pT_300.pdf");
   c66-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_costheta_lab_vs_pT_300.eps");

   ////// ****** prel vs ptotal por cuts y bin

   TGraph *gr67  = new TGraph(n10,recoprojprel_lowPT,recoprojptot_lowPT);
   TCanvas *c67 = new TCanvas("c67","",900, 900);
   TH1F *hr67 = c58->DrawFrame(0.,0,1.25,0.5);

   c67->SetGrid();
   gr67->SetTitle("");
   gr67->GetXaxis()->SetTitle("p^{#perp}_{pn-p2} [GeV/c]");
   gr67->GetYaxis()->SetTitle("p^{#perp}_{pn+p2} [GeV/c]");
   //gr67->GetXaxis()->SetLimits(0., 1.);
   gr67->GetYaxis()->SetLimits(0., 1.25);
   gr67->GetYaxis()->SetRangeUser(0, 0.5);
   gr67->GetXaxis()->SetRangeUser(0., 1.25);
   //gr67->GetXaxis()->SetRangeUser(-1., 1.);
   gr67->SetMarkerColor(kRed);
   gr67->Draw("same A*");

   c67->Update();
   c67-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prelVStotperp_cCM_lowPT.pdf");
   c67-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prelVStotperp_cCM_lowPT.eps");

   TGraph *gr68 = new TGraph(n11,recoprojprel_lowPT_1stbin,recoprojptot_lowPT_1stbin);
   TCanvas *c68 = new TCanvas("c68","",900, 900);
   TH1F *hr68 = c68->DrawFrame(0.,0,1.25,0.5);

   c68->SetGrid();
   gr68->SetTitle("");
   gr68->GetXaxis()->SetTitle("p^{#perp}_{pn-p2} [GeV/c]");
   gr68->GetYaxis()->SetTitle("p^{#perp}_{pn+p2} [GeV/c]");
   //gr68->GetXaxis()->SetLimits(0., 1.);
   gr68->GetXaxis()->SetLimits(0., 1.25);
   gr68->GetYaxis()->SetRangeUser(0, 0.5);
   gr68->GetXaxis()->SetRangeUser(0.,1.25);
   //gr68->GetXaxis()->SetRangeUser(-1., 1.);
   gr68->SetMarkerColor(kRed);
   gr68->Draw("same A*");

   TLine *fgolden=new TLine(0.422,0.,0.422,0.5);
   fgolden->SetLineColor(kMagenta+1);
   fgolden->SetLineWidth(2);
   fgolden->Draw("same");

   c68->Update();
   c68-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prelVStotperp_cCM_lowPT_1stbin.pdf");
   c68-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prelVStotperp_cCM_lowPT_1stbin.eps");

   TGraph *gr69 = new TGraph(n12,recoprojprel_lowPT_nobin,recoprojptot_lowPT_nobin);
   TCanvas *c69 = new TCanvas("c69","",900, 900);
   TH1F *hr69 = c69->DrawFrame(0.,0,1.25,0.5);

   c69->SetGrid();
   gr69->SetTitle("");
   gr69->GetXaxis()->SetTitle("p^{#perp}_{pn-p2} [GeV/c]");
   gr69->GetYaxis()->SetTitle("p^{#perp}_{pn+p2} [GeV/c]");
   //gr69->GetXaxis()->SetLimits(0., 1.);
   gr69->GetYaxis()->SetLimits(0., 1.25);
   gr69->GetYaxis()->SetRangeUser(0, 0.5);
   gr69->GetXaxis()->SetRangeUser(0., 1.25);
   gr69->SetMarkerColor(kRed);
   gr69->Draw("same A*");
   
   c69->Update();
   c69-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prelVStotperp_cCM_lowPT_nobin.pdf");
   c69-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prelVStotperp_cCM_lowPT_nobin.eps");

   TGraph *gr70 = new TGraph(n11,recoprojprel_lowPT_1stbin,recoprojpn_lowPT_1stbin);
   TCanvas *c70 = new TCanvas("c70","",900, 900);
   TH1F *hr70 = c70->DrawFrame(0.,0.,1.5,1.5);

   c70->SetGrid();
   gr70->SetTitle("");
   gr70->GetXaxis()->SetTitle("p^{#perp}_{pn-p2} [GeV/c]");
   gr70->GetYaxis()->SetTitle("p_{n} [GeV/c]");
   gr70->GetXaxis()->SetLimits(0., 1.5);
   gr70->GetYaxis()->SetLimits(0., 1.5);
   gr70->GetYaxis()->SetRangeUser(0, 1.5);
   gr70->GetXaxis()->SetRangeUser(0., 1.5);
   gr70->SetMarkerColor(kRed);
   gr70->Draw("same A*");

   TLine *fgolden1=new TLine(0.422,0.,0.422,1.5);
   fgolden1->SetLineColor(kBlue);
   fgolden1->SetLineWidth(2);
   fgolden1->Draw("same");
   
   c70->Update();
   c70-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prelVSpn_cCM_lowPT_1stbin.pdf");
   c70-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prelVSpn_cCM_lowPT_1stbin.eps");

   TGraph *gr71 = new TGraph(n11,recoprojp2_lowPT_1stbin,recoprojpn_lowPT_1stbin);
   TCanvas *c71 = new TCanvas("c71","",900, 900);
   TH1F *hr71 = c71->DrawFrame(0.,0,1.5,1.5);

   c71->SetGrid();
   gr71->SetTitle("");
   gr71->GetXaxis()->SetTitle("p_{2} [GeV/c]");
   gr71->GetYaxis()->SetTitle("p_{n} [GeV/c]");
   gr71->GetXaxis()->SetLimits(0., 1.5);
   gr71->GetYaxis()->SetLimits(0., 1.5);
   gr71->GetYaxis()->SetRangeUser(0, 1.5);
   gr71->GetXaxis()->SetRangeUser(0., 1.5);
   gr71->SetMarkerColor(kRed);
   gr71->Draw("same A*");

   TLine *fcorr=new TLine(0.,0.,1.5,1.5);
   fcorr->SetLineColor(kMagenta+1);
   fcorr->SetLineWidth(2);
   fcorr->Draw("same");
   
   c71->Update();
   c71-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_p2VSpn_cCM_lowPT_1stbin.pdf");
   c71-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_p2VSpn_cCM_lowPT_1stbin.eps");

   TGraph *gr72 = new TGraph(ngolden,recoprojp2_lowPT_golden,recoprojpn_lowPT_golden);
   TCanvas *c72 = new TCanvas("c72","",900, 900);
   TH1F *hr72 = c72->DrawFrame(0.,0,1.5,1.5);

   c72->SetGrid();
   gr72->SetTitle("");
   gr72->GetXaxis()->SetTitle("p_{2} [GeV/c]");
   gr72->GetYaxis()->SetTitle("p_{n} [GeV/c]");
   gr72->GetXaxis()->SetLimits(0., 1.5);
   gr72->GetYaxis()->SetLimits(0., 1.5);
   gr72->GetYaxis()->SetRangeUser(0, 1.5);
   gr72->GetXaxis()->SetRangeUser(0., 1.5);
   gr72->SetMarkerColor(kRed);
   gr72->Draw("same A*");

   fcorr->Draw("same");
   
   c72->Update();
   c72-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_p2VSpn_cCM_lowPT_golden.pdf");
   c72-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_p2VSpn_cCM_lowPT_golden.eps");

   TGraph *gr73 = new TGraph(n10,recoabsrelpnp2_lowPT,recoabstotpnp2_lowPT);
   TCanvas *c73 = new TCanvas("c73","",900, 900);
   TH1F *hr73 = c73->DrawFrame(0.,0,1.,3.);

   c73->SetGrid();
   gr73->SetTitle("");
   gr73->GetYaxis()->SetTitle("p_{n}+p_{2} [GeV/c]");
   gr73->GetXaxis()->SetTitle("|p_{n}-p_{2}| [GeV/c]");
   gr73->GetXaxis()->SetLimits(0., 1.);
   gr73->GetYaxis()->SetLimits(0., 3.);
   gr73->GetYaxis()->SetRangeUser(0, 3.);
   gr73->GetXaxis()->SetRangeUser(0., 1.);
   gr73->SetMarkerColor(kRed);
   gr73->Draw("same A*");
   
   c73->Update();
   c73-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_absTotVSRel_lowPT.pdf");
   c73-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_absTotVSRel_lowPT.eps");

   TGraph *gr74 = new TGraph(n13,recoabsrelpnp2_lowPT_pnup,recoabstotpnp2_lowPT_pnup);
   TCanvas *c74 = new TCanvas("c74","",900, 900);
   TH1F *hr74 = c74->DrawFrame(0.,0,1.,3.);

   c74->SetGrid();
   gr74->SetTitle("");
   gr74->GetYaxis()->SetTitle("p_{n}+p_{2} [GeV/c]");
   gr74->GetXaxis()->SetTitle("|p_{n}-p_{2}| [GeV/c]");
   gr74->GetXaxis()->SetLimits(0., 1.);
   gr74->GetYaxis()->SetLimits(0., 3.);
   gr74->GetYaxis()->SetRangeUser(0, 3.);
   gr74->GetXaxis()->SetRangeUser(0., 1.);
   gr74->SetMarkerColor(kRed);
   gr74->Draw("same A*");
   
   c74->Update();
   c74-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_absTotVSRel_lowPT_pnup.pdf");
   c74-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_absTotVSRel_lowPT_pnup.eps");

   TGraph *gr75 = new TGraph(n14,recoabsrelpnp2_lowPT_prel2,recoabstotpnp2_lowPT_prel2);
   TCanvas *c75 = new TCanvas("c75","",900, 900);
   TH1F *hr75 = c75->DrawFrame(0.,0,1.,3.);

   c75->SetGrid();
   gr75->SetTitle("");
   gr75->GetYaxis()->SetTitle("p_{n}+p_{2} [GeV/c]");
   gr75->GetXaxis()->SetTitle("|p_{n}-p_{2}| [GeV/c]");
   gr75->GetXaxis()->SetLimits(0., 1.);
   gr75->GetYaxis()->SetLimits(0., 3.);
   gr75->GetYaxis()->SetRangeUser(0, 3.);
   gr75->GetXaxis()->SetRangeUser(0., 1.);
   gr75->SetMarkerColor(kRed);
   gr75->Draw("same A*");
   
   c75->Update();
   c75-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_absTotVSRel_lowPT_prel2.pdf");
   c75-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_absTotVSRel_lowPT_prel2.eps");
      
   TGraph *gr76 = new TGraph(ncCM1st,recoabsrelpnp2_lowPT_prel2_1stbin,recoabstotpnp2_lowPT_prel2_1stbin);
   TCanvas *c76 = new TCanvas("c76","",900, 900);
   TH1F *hr76 = c76->DrawFrame(0.,0,1.,3.);

   c76->SetGrid();
   gr76->SetTitle("");
   gr76->GetYaxis()->SetTitle("p_{n}+p_{2} [GeV/c]");
   gr76->GetXaxis()->SetTitle("|p_{n}-p_{2}| [GeV/c]");
   gr76->GetXaxis()->SetLimits(0., 1.);
   gr76->GetYaxis()->SetLimits(0., 3.);
   gr76->GetYaxis()->SetRangeUser(0, 3.);
   gr76->GetXaxis()->SetRangeUser(0., 1.);
   gr76->SetMarkerColor(kRed);
   gr76->Draw("same A*");
   
   c76->Update();
   c76-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_absTotVSRel_lowPT_prel2_1stbin.pdf");
   c76-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_absTotVSRel_lowPT_prel2_1stbin.eps");
      
   TGraph *gr77 = new TGraph(n13,recoprojprel_lowPT_pnup,recoprojptot_lowPT_pnup);
   TCanvas *c77 = new TCanvas("c77","",900, 900);
   TH1F *hr77 = c77->DrawFrame(0.,0,1.5,0.5);

   c77->SetGrid();
   gr77->SetTitle("");
   gr77->GetYaxis()->SetTitle("p^{#perp}_{pn+p2} [GeV/c]");
   gr77->GetXaxis()->SetTitle("p^{#perp}_{pn-p2} [GeV/c]");
   gr77->GetXaxis()->SetLimits(0., 1.5);
   gr77->GetYaxis()->SetLimits(0., 0.5);
   gr77->GetYaxis()->SetRangeUser(0, 0.5);
   gr77->GetXaxis()->SetRangeUser(0., 1.5);
   gr77->SetMarkerColor(kRed);
   gr77->Draw("same A*");
   
   c77->Update();
   c77-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_perpTotVSRel_lowPT_pnup.pdf");
   c77-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_perTotVSRel_lowPT_pnup.eps");    
   
   TGraph *gr78 = new TGraph(n14,recoprojp2_lowPT_prel,recoprojpn_lowPT_prel);
   TCanvas *c78 = new TCanvas("c78","",900, 900);
   TH1F *hr78 = c78->DrawFrame(0.,0,1.5,1.5);

   c78->SetGrid();
   gr78->SetTitle("");
   gr78->GetYaxis()->SetTitle("p_{n} [GeV/c]");
   gr78->GetXaxis()->SetTitle("p_{2} [GeV/c]");
   gr78->GetXaxis()->SetLimits(0., 1.5);
   gr78->GetYaxis()->SetLimits(0., 1.5);
   gr78->GetYaxis()->SetRangeUser(0, 1.5);
   gr78->GetXaxis()->SetRangeUser(0., 1.5);
   gr78->SetMarkerColor(kRed);
   gr78->Draw("same A*");

   fcorr->Draw("same");
   
   c78->Update();
   c78-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_pnVSp2_lowPT_prel2.pdf");
   c78-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_pnVSp2_lowPT_prel2.eps");

   TGraph *gr79 = new TGraph(ncCM1st,recoprojp2_lowPT_prel_1stbin,recoprojpn_lowPT_prel_1stbin);
   TCanvas *c79 = new TCanvas("c79","",900, 900);
   TH1F *hr79 = c79->DrawFrame(0.,0,1.,1.);

   c79->SetGrid();
   gr79->SetTitle("");
   gr79->GetYaxis()->SetTitle("p_{n} [GeV/c]");
   gr79->GetXaxis()->SetTitle("p_{2} [GeV/c]");
   gr79->GetXaxis()->SetLimits(0., 1.);
   gr79->GetYaxis()->SetLimits(0., 1.);
   gr79->GetYaxis()->SetRangeUser(0, 1.);
   gr79->GetXaxis()->SetRangeUser(0., 1.);
   gr79->SetMarkerColor(kRed);
   gr79->SetMarkerSize(2);
   gr79->Draw("same A*");

   //fcorr->Draw("same");

   TLegend *lgr79 = new TLegend(0.53, 0.8, 0.9, 0.9);
   lgr79 -> AddEntry(gr79, "MicroBooNE on-beam data", "p");
   lgr79 ->SetTextSize(0.025);
   lgr79 -> Draw();
  
   
   c79->Update();
   c79-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_pnVSp2_lowPT_prel2_1stbin.pdf");
   c79-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_pnVSp2_lowPT_prel2_1stbin.eps");

   TGraph *gr80 = new TGraph(n14,recoprojpn_lowPT_prel,recocCM_lowPT_prel);
   TCanvas *c80 = new TCanvas("c80","",900, 900);
   TH1F *hr80 = c80->DrawFrame(0.,-1,1.5,1);

   c80->SetGrid();
   gr80->SetTitle("");
   gr80->GetYaxis()->SetTitle("cos #gamma_{CM}");
   gr80->GetXaxis()->SetTitle("p_{n} [GeV/c]");
   gr80->GetXaxis()->SetLimits(0., 1.5);
   gr80->GetYaxis()->SetLimits(-1, 1);
   gr80->GetYaxis()->SetRangeUser(-1, 1);
   gr80->GetXaxis()->SetRangeUser(0., 1.5);
   gr80->SetMarkerColor(kRed);
   gr80->Draw("same A*");
   
   c80->Update();
   c80-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cCMVSpn_lowPT_prel2.pdf");
   c80-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cCMVSpn_lowPT_prel2.eps");


   TGraph *gr81 = new TGraph(n14, recoabsrelpnp2_lowPT_prel2,recocCM_lowPT_prel);
   TCanvas *c81 = new TCanvas("c81","",900, 900);
   TH1F *hr81 = c80->DrawFrame(0.,-1,1,1);

   c81->SetGrid();
   gr81->SetTitle("");
   gr81->GetYaxis()->SetTitle("cos #gamma_{CM}");
   gr81->GetXaxis()->SetTitle("p_{n}-p_{2} [GeV/c]");
   gr81->GetXaxis()->SetLimits(0., 1.);
   gr81->GetYaxis()->SetLimits(-1, 1);
   gr81->GetYaxis()->SetRangeUser(-1, 1);
   gr81->GetXaxis()->SetRangeUser(0., 1.);
   gr81->SetMarkerColor(kRed);
   gr81->Draw("same A*");
   
   c81->Update();
   c81-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cCMVSabsrel_lowPT_prel2.pdf");
   c81-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cCMVSabsrel_lowPT_prel2.eps");


   TGraph *gr82 = new TGraph(n10, recoprojprel2_lowPT,recoprojpn_lowPT);
   TCanvas *c82 = new TCanvas("c82","",900, 900);
   TH1F *hr82 = c82->DrawFrame(0.,0.,1.5,1);

   c82->SetGrid();
   gr82->SetTitle("");
   gr82->GetXaxis()->SetTitle("p^{#perp}_{pn-p2}/2 [GeV/c]");
   gr82->GetYaxis()->SetTitle("p_{n}[GeV/c]");
   gr82->GetXaxis()->SetLimits(0., 1.5);
   gr82->GetYaxis()->SetLimits(0, 1);
   gr82->GetYaxis()->SetRangeUser(0, 1);
   gr82->GetXaxis()->SetRangeUser(0., 1.5);
   gr82->SetMarkerColor(kRed);
   gr82->Draw("same A*");
   
   c82->Update();
   c82-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prel2VSpn_lowPT.pdf");
   c82-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prel2VSpn_lowPT.eps");

   TGraph *gr83 = new TGraph(n11, recoprojprel2_lowPT_1stbin,recoprojpn_lowPT_1stbin);
   TCanvas *c83 = new TCanvas("c83","",900, 900);
   TH1F *hr83 = c83->DrawFrame(0.,0.,0.8,1);

   c83->SetGrid();
   gr83->SetTitle("");
   gr83->GetXaxis()->SetTitle("p^{#perp}_{pn-p2} [GeV/c]");
   gr83->GetYaxis()->SetTitle("p_{n}[GeV/c]");
   gr83->GetXaxis()->SetLimits(0.,0.8);
   gr83->GetYaxis()->SetLimits(0,1);
   gr83->GetYaxis()->SetRangeUser(0,1);
   gr83->GetXaxis()->SetRangeUser(0.,0.8);
   gr83->SetMarkerColor(kRed);
   gr83->Draw("same A*");
   
   c83->Update();
   c83-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prel2VSpn_lowPT_1stbin.pdf");
   c83-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prel2VSpn_lowPT_1stbin.eps");


   TGraph *gr84 = new TGraph(n1, recopTall,y33);
   TCanvas *c84 = new TCanvas("c84","",900, 900);
   TH1F *hr84 = c83->DrawFrame(0.,-1,1.6,1);

   c84->SetGrid();
   gr84->SetTitle("");
   gr84->GetXaxis()->SetTitle("p^{T}_{miss} [GeV/c]");
   gr84->GetYaxis()->SetTitle("cos #gamma_{CM}");
   gr84->GetXaxis()->SetLimits(0.,1.6);
   gr84->GetYaxis()->SetLimits(-1,1);
   gr84->GetYaxis()->SetRangeUser(-1,1);
   gr84->GetXaxis()->SetRangeUser(0.,1.6);
   gr84->SetMarkerColor(kRed);
   gr84->Draw("same A*");

   TLine *fptcut=new TLine(0.3,-1,0.3,1.);
   fptcut->SetLineColor(kMagenta+1);
   fptcut->SetLineWidth(3);
   fptcut->Draw("same");

   TLegend *lgr84 = new TLegend(0.53, 0.8, 0.9, 0.9);
   lgr84 -> AddEntry(gr84, "MicroBooNE on-beam data", "p");
   lgr84 ->SetTextSize(0.025);
   lgr84 -> Draw();
   
   c84->Update();
   c84-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cCM_PT_nocut.pdf");
   c84-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_cCM_PT_nocut.eps");

   TGraph *gr85 = new TGraph(n15, recoprojprel_lowPT_noprel_1stbin, recoprojpn_lowPT_noprel_1stbin);
   TCanvas *c85 = new TCanvas("c85","",900, 900);
   TH1F *hr85 = c85->DrawFrame(0.,0.,0.8,1.5);

   c85->SetGrid();
   gr85->SetTitle("");
   // gr85->GetXaxis()->SetTitle("p^{#perp}_{pn-p2} [GeV/c]");
   // gr85->GetYaxis()->SetTitle("p_{n} [GeV/c]");
   //gr85->GetXaxis()->SetLimits(0., 0.8);
   //gr85->GetYaxis()->SetLimits(0., 1.5);
   //gr85->GetYaxis()->SetRangeUser(0, 1.5);
   //gr85->GetXaxis()->SetRangeUser(0., 0.8);
   gr85->SetMarkerColor(kAzure+2);
   gr85->SetMarkerSize(2);
   gr85->SetMarkerStyle(20);
   gr85->SetDrawOption("same A*");
   gr85->SetTitle("strongly correlated nuclear pairs");
   gr85->SetFillStyle(0);
   gr85->SetLineColor(kWhite);

   //gr85->Draw("same A*");

   TGraph *gr85_a = new TGraph(ncCM1st, recoprojprel_lowPT_prel_1stbin, recoprojpn_lowPT_prel_1stbin);
   gr85_a->SetMarkerColor(kGreen+2);
   gr85_a->SetMarkerSize(2);
   gr85_a->SetMarkerStyle(20);
   gr85_a->SetDrawOption("same A*");
   gr85_a->SetTitle("NN-SRC CCQE golden candidates");
   gr85_a->SetFillStyle(0);
   gr85_a->SetLineColor(kWhite);
 
   //gr85_a->Draw("same A*");

   TMultiGraph *mg85 = new TMultiGraph();
   mg85->SetTitle("; p^{#perp}_{pn-p2} [GeV/c]; p_{n} [GeV/c]");
   mg85->Add(gr85);
   mg85->Add(gr85_a);

   mg85->GetXaxis()->SetTitle("p^{#perp}_{pn-p2} [GeV/c]");
   mg85->GetYaxis()->SetTitle("p_{n} [GeV/c]");
   mg85->GetHistogram()->GetXaxis()->SetRangeUser(0.,0.8);
   mg85->GetHistogram()->GetXaxis()->SetRangeUser(0.,1.5);
   mg85->GetHistogram()->GetXaxis()->SetTitle("p^{#perp}_{pn-p2} [GeV/c]");
   mg85->GetHistogram()->GetYaxis()->SetTitle("p_{n} [GeV/c]");
   //mg85->SetMarkerSize(3);
   //   mg85->GetXaxis()->SetLimits(0., 0.8);
   //   mg85->GetYaxis()->SetLimits(0., 1.5);
   //   mg85->GetYaxis()->SetRangeUser(0, 1.5);
   //   mg85->GetXaxis()->SetRangeUser(0., 0.8);
   ...
   //   TLegend *lgr85 = new TLegend(0.53, 0.8, 0.9, 0.9);
   //lgr85 -> AddEntry("MicroBooNE on-beam data");
   //lgr85 ->SetTextSize(0.025);
   //lgr85 -> Draw("A*");
   c85->BuildLegend();

   TLine *fgold=new TLine(0.3,0.,0.3,1.5);
   fgold->SetLineColor(kMagenta+1);
   fgold->SetLineWidth(2);
   fgold->Draw("same");
   
   c85->Update();
   c85-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prelVSpn_cCM_lowPT_1stbincolor.pdf");
   c85-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_prelVSpn_cCM_lowPT_1stbincolor.eps");


   TGraph *gr86 = new TGraph(n1, recopTall,recocosCMT_nocut);
   TCanvas *c86 = new TCanvas("c86","",900, 900);
   TH1F *hr86 = c86->DrawFrame(0.,-1,1.6,1);

   c86->SetGrid();
   gr86->SetTitle("");
   gr86->GetXaxis()->SetTitle("p^{T}_{miss} [GeV/c]");
   gr86->GetYaxis()->SetTitle("cos #gamma^{T}_{CM}");
   gr86->GetXaxis()->SetLimits(0.,1.6);
   gr86->GetYaxis()->SetLimits(-1,1);
   gr86->GetYaxis()->SetRangeUser(-1,1);
   gr86->GetXaxis()->SetRangeUser(0.,1.6);
   gr86->SetMarkerColor(kRed);
   gr86->Draw("same A*");

   fptcut->Draw("same");

   TLegend *lgr86 = new TLegend(0.53, 0.8, 0.9, 0.9);
   lgr86 -> AddEntry(gr86, "MicroBooNE on-beam data", "p");
   lgr86 ->SetTextSize(0.025);
   lgr86 -> Draw();
   
   c86->Update();
   c86-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_transcCM_PT_nocut.pdf");
   c86-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_transcCM_PT_nocut.eps");

   TGraph *gr87 = new TGraph(n1, recoPT_nocut_1stbin,recocosCMT_nocut_1stbin);
   TCanvas *c87 = new TCanvas("c87","",900, 900);
   TH1F *hr87 = c87->DrawFrame(0.,-1,1.6,1);

   c87->SetGrid();
   gr87->SetTitle("");
   gr87->GetXaxis()->SetTitle("p^{T}_{miss} [GeV/c]");
   gr87->GetYaxis()->SetTitle("cos #gamma^{T}_{CM}");
   gr87->GetXaxis()->SetLimits(0.,1.6);
   gr87->GetYaxis()->SetLimits(-1,1);
   gr87->GetYaxis()->SetRangeUser(-1,1);
   gr87->GetXaxis()->SetRangeUser(0.,1.6);
   gr87->SetMarkerColor(kRed);
   gr87->Draw("same A*");

   fptcut->Draw("same");

   TLegend *lgr87 = new TLegend(0.53, 0.8, 0.9, 0.9);
   lgr87 -> AddEntry(gr86, "MicroBooNE on-beam data", "p");
   lgr87 ->SetTextSize(0.025);
   lgr87 -> Draw();
   
   c87->Update();
   c87-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_transcCM_PT_nocut_1stbinCM.pdf");
   c87-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_transcCM_PT_nocut_1stbinCM.eps");
   ...
   cosCMT_nocut_OnBeam->SetMarkerColor(kRed+2);
   cosCMT_nocut_OnBeam->SetLineColor(kRed+2);
   cosCMT_nocut_OnBeam->SetMarkerStyle(20);
   cosCMT_nocut_OnBeam->SetMarkerSize(2);
   cosCMT_nocut_OnBeam->GetYaxis()->SetTitle("No. of Entries");
   cosCMT_nocut_OnBeam->GetXaxis()->SetTitle("reconstructed cos #gamma^{T}_{CM}");
   cosCMT_nocut_OnBeam->Draw("e1");
   cosCMT_nocut_OnBeam->GetYaxis()->SetTitleOffset(1.5);

   cosCMT_nocut_1stbin_OnBeam->SetMarkerColor(kRed);
   cosCMT_nocut_1stbin_OnBeam->SetLineColor(kRed);
   cosCMT_nocut_1stbin_OnBeam->SetMarkerStyle(21);
   cosCMT_nocut_1stbin_OnBeam->SetMarkerSize(2);
   cosCMT_nocut_1stbin_OnBeam->Draw("same e1");

   cosCMT_lowPT_OnBeam->SetMarkerColor(kAzure+2);
   cosCMT_lowPT_OnBeam->SetLineColor(kAzure+2);
   cosCMT_lowPT_OnBeam->SetMarkerStyle(20);
   cosCMT_lowPT_OnBeam->SetMarkerSize(2);
   cosCMT_lowPT_OnBeam->Draw("same e1");

   cosCMT_lowPT_1stbin_OnBeam->SetMarkerColor(kAzure);
   cosCMT_lowPT_1stbin_OnBeam->SetLineColor(kAzure);
   cosCMT_lowPT_1stbin_OnBeam->SetMarkerStyle(21);
   cosCMT_lowPT_1stbin_OnBeam->SetMarkerSize(2);
   cosCMT_lowPT_1stbin_OnBeam->Draw("same e1");
   
   cosCMT_lowPT_prel_OnBeam->SetMarkerColor(kGreen+2);
   cosCMT_lowPT_prel_OnBeam->SetLineColor(kGreen+2);
   cosCMT_lowPT_prel_OnBeam->SetMarkerStyle(20);
   cosCMT_lowPT_prel_OnBeam->SetMarkerSize(2);
   cosCMT_lowPT_prel_OnBeam->Draw("same e1");

   cosCMT_lowPT_prel_1stbin_OnBeam->SetMarkerColor(kGreen);
   cosCMT_lowPT_prel_1stbin_OnBeam->SetLineColor(kGreen);
   cosCMT_lowPT_prel_1stbin_OnBeam->SetMarkerStyle(21);
   cosCMT_lowPT_prel_1stbin_OnBeam->SetMarkerSize(2);
   cosCMT_lowPT_prel_1stbin_OnBeam->Draw("same e1");
   
   TLegend *l88 = new TLegend(0.4, 0.6, 0.9, 0.9);
   l88 -> AddEntry(cosCMT_nocut_OnBeam, "no cuts", "lep");
   l88 -> AddEntry(cosCMT_nocut_1stbin_OnBeam, "no cuts, cos #gamma_{CM}<-0.9", "lep");
   l88 -> AddEntry(cosCMT_lowPT_OnBeam, "p^{T}_{miss}<0.3GeV/c", "lep");
   l88 -> AddEntry(cosCMT_lowPT_1stbin_OnBeam, "p^{T}_{miss}<0.3GeV/c, cos #gamma_{CM}<-0.9", "lep");
   l88 -> AddEntry(cosCMT_lowPT_prel_OnBeam, "p^{T}_{miss}<0.3GeV/c, p^{#perp}_{pn-p2}>0.3GeV/c", "lep");
   l88 -> AddEntry(cosCMT_lowPT_prel_1stbin_OnBeam, "p^{T}_{miss}<0.3GeV/c, p^{#perp}_{pn-p2}>0.3GeV/c, cos #gamma_{CM}<-0.9", "lep");
   ...
   c88->Update();
   c88->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/transversecosCM_OnBeam.pdf");
   c88->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/transversecosCM_OnBeam.pdf");

   TCanvas *c89 = new TCanvas("c89", "c89", 900, 900);

   reco_projprel_OnBeam->SetMarkerColor(kRed+2);
   reco_projprel_OnBeam->SetLineColor(kRed+2);
   reco_projprel_OnBeam->SetMarkerStyle(20);
   reco_projprel_OnBeam->SetMarkerSize(2);
   reco_projprel_OnBeam->GetYaxis()->SetTitle("No. of Entries");
   reco_projprel_OnBeam->GetXaxis()->SetTitle("p^{#perp}_{pn-p2}");
   reco_projprel_OnBeam->Draw("e1");
   reco_projprel_OnBeam->GetYaxis()->SetTitleOffset(1.5);

   reco_projprel_OnBeam_1binCM->SetMarkerColor(kRed);
   reco_projprel_OnBeam_1binCM->SetLineColor(kRed);
   reco_projprel_OnBeam_1binCM->SetMarkerStyle(21);
   reco_projprel_OnBeam_1binCM->SetMarkerSize(2);
   reco_projprel_OnBeam_1binCM->Draw("same e1");

   reco_projprel_OnBeam_lowPT->SetMarkerColor(kAzure+2);
   reco_projprel_OnBeam_lowPT->SetLineColor(kAzure+2);
   reco_projprel_OnBeam_lowPT->SetMarkerStyle(20);
   reco_projprel_OnBeam_lowPT->SetMarkerSize(2);
   reco_projprel_OnBeam_lowPT->Draw("same e1");

   reco_projprel_OnBeam_lowPT_1binCM->SetMarkerColor(kAzure);
   reco_projprel_OnBeam_lowPT_1binCM->SetLineColor(kAzure);
   reco_projprel_OnBeam_lowPT_1binCM->SetMarkerStyle(21);
   reco_projprel_OnBeam_lowPT_1binCM->SetMarkerSize(2);
   reco_projprel_OnBeam_lowPT_1binCM->Draw("same e1");
      
   TLegend *l89 = new TLegend(0.4, 0.6, 0.9, 0.9);
   l89 -> AddEntry(reco_projprel_OnBeam, "no cuts", "lep");
   l89 -> AddEntry(reco_projprel_OnBeam_1binCM, "no cuts, cos #gamma_{CM}<-0.9", "lep");
   l89 -> AddEntry(reco_projprel_OnBeam_lowPT, "p^{T}_{miss}<0.3GeV/c", "lep");
   l89 -> AddEntry(reco_projprel_OnBeam_lowPT_1binCM, "p^{T}_{miss}<0.3GeV/c, cos #gamma_{CM}<-0.9", "lep");
   ...
   c89->Update();
   c89->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/prel_OnBeam.pdf");
   c89->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/prel_OnBeam.pdf");

   TCanvas *c90 = new TCanvas("c90", "c90", 900, 900);

   reco_pnp2_OnBeam->SetMarkerColor(kRed+2);
   reco_pnp2_OnBeam->SetLineColor(kRed+2);
   reco_pnp2_OnBeam->SetMarkerStyle(20);
   reco_pnp2_OnBeam->SetMarkerSize(2);
   reco_pnp2_OnBeam->GetYaxis()->SetTitle("No. of Entries");
   reco_pnp2_OnBeam->GetXaxis()->SetTitle("p_{n} - p_{2}");
   reco_pnp2_OnBeam->Draw("e1");
   reco_pnp2_OnBeam->GetYaxis()->SetTitleOffset(1.5);

   reco_pnp2_OnBeam_1binCM->SetMarkerColor(kRed);
   reco_pnp2_OnBeam_1binCM->SetLineColor(kRed);
   reco_pnp2_OnBeam_1binCM->SetMarkerStyle(21);
   reco_pnp2_OnBeam_1binCM->SetMarkerSize(2);
   reco_pnp2_OnBeam_1binCM->Draw("same e1");

   reco_pnp2_OnBeam_lowPT->SetMarkerColor(kAzure+2);
   reco_pnp2_OnBeam_lowPT->SetLineColor(kAzure+2);
   reco_pnp2_OnBeam_lowPT->SetMarkerStyle(20);
   reco_pnp2_OnBeam_lowPT->SetMarkerSize(2);
   reco_pnp2_OnBeam_lowPT->Draw("same e1");

   reco_pnp2_OnBeam_lowPT_1binCM->SetMarkerColor(kAzure);
   reco_pnp2_OnBeam_lowPT_1binCM->SetLineColor(kAzure);
   reco_pnp2_OnBeam_lowPT_1binCM->SetMarkerStyle(21);
   reco_pnp2_OnBeam_lowPT_1binCM->SetMarkerSize(2);
   reco_pnp2_OnBeam_lowPT_1binCM->Draw("same e1");
   
   reco_pnp2_OnBeam_lowPT_prel->SetMarkerColor(kGreen+2);
   reco_pnp2_OnBeam_lowPT_prel->SetLineColor(kGreen+2);
   reco_pnp2_OnBeam_lowPT_prel->SetMarkerStyle(20);
   reco_pnp2_OnBeam_lowPT_prel->SetMarkerSize(2);
   reco_pnp2_OnBeam_lowPT_prel->Draw("same e1");

   reco_pnp2_OnBeam_lowPT_prel_1binCM->SetMarkerColor(kGreen);
   reco_pnp2_OnBeam_lowPT_prel_1binCM->SetLineColor(kGreen);
   reco_pnp2_OnBeam_lowPT_prel_1binCM->SetMarkerStyle(21);
   reco_pnp2_OnBeam_lowPT_prel_1binCM->SetMarkerSize(2);
   reco_pnp2_OnBeam_lowPT_prel_1binCM->Draw("same e1");
   
   TLegend *l90 = new TLegend(0.4, 0.6, 0.9, 0.9);
   l90 -> AddEntry(reco_pnp2_OnBeam, "no cuts", "lep");
   l90 -> AddEntry(reco_pnp2_OnBeam_1binCM, "no cuts, cos #gamma_{CM}<-0.9", "lep");
   l90 -> AddEntry(reco_pnp2_OnBeam_lowPT, "p^{T}_{miss}<0.3GeV/c", "lep");
   l90 -> AddEntry(reco_pnp2_OnBeam_lowPT_1binCM, "p^{T}_{miss}<0.3GeV/c, cos #gamma_{CM}<-0.9", "lep");
   l90 -> AddEntry(reco_pnp2_OnBeam_lowPT_prel, "p^{T}_{miss}<0.3GeV/c, p^{#perp}_{pn-p2}<0.3GeV/c", "lep");
   l90 -> AddEntry(reco_pnp2_OnBeam_lowPT_prel_1binCM, "p^{T}_{miss}<0.3GeV/c, p^{#perp}_{pn-p2}<0.3GeV/c, cos #gamma_{CM}<-0.9", "lep");
   ...
   c90->Update();
   c90->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/pnp2_OnBeam.pdf");
   c90->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/pnp2_OnBeam.pdf");

   /////////

   TGraph *gr91 = new TGraph(n1, recoprojprel_nocut ,recocosCMT_nocut);
   TCanvas *c91 = new TCanvas("c91","",900, 900);
   TH1F *hr91 = c91->DrawFrame(0.,-1,1.6,1);

   c91->SetGrid();
   gr91->SetTitle("");
   gr91->GetXaxis()->SetTitle("p^{#perp}_{pn-p2} [GeV/c]");
   gr91->GetYaxis()->SetTitle("cos #gamma^{T}_{CM}");
   gr91->GetXaxis()->SetLimits(0.,1.6);
   gr91->GetYaxis()->SetLimits(-1,1);
   gr91->GetYaxis()->SetRangeUser(-1,1);
   gr91->GetXaxis()->SetRangeUser(0.,1.6);
   gr91->SetMarkerColor(kRed);
   gr91->Draw("same A*");

   TLegend *lgr91 = new TLegend(0.53, 0.8, 0.9, 0.9);
   lgr91 -> AddEntry(gr91, "MicroBooNE on-beam data", "p");
   lgr91 ->SetTextSize(0.025);
   lgr91 -> Draw();
   
   c91->Update();
   c91-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_transcCM_Prel2_nocut.pdf");
   c91-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_transcCM_Prel2_nocut.eps");
   
   TGraph *gr92 = new TGraph(n10, recoprojprel2_lowPT ,recocosCMT_lowPT);
   TCanvas *c92 = new TCanvas("c92","",900, 900);
   TH1F *hr92 = c92->DrawFrame(0.,-1,1.6,1);

   c92->SetGrid();
   gr92->SetTitle("");
   gr92->GetXaxis()->SetTitle("p^{#perp}_{pn-p2} [GeV/c]");
   gr92->GetYaxis()->SetTitle("cos #gamma^{T}_{CM}");
   gr92->GetXaxis()->SetLimits(0.,1.6);
   gr92->GetYaxis()->SetLimits(-1,1);
   gr92->GetYaxis()->SetRangeUser(-1,1);
   gr92->GetXaxis()->SetRangeUser(0.,1.6);
   gr92->SetMarkerColor(kRed);
   gr92->Draw("same A*");

   TLegend *lgr92 = new TLegend(0.53, 0.8, 0.9, 0.9);
   lgr92 -> AddEntry(gr92, "MicroBooNE on-beam data", "p");
   lgr92 ->SetTextSize(0.025);
   lgr92 -> Draw();
   
   c92->Update();
   c92-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_transcCM_Prel2_lowPT.pdf");
   c92-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_transcCM_Prel2_lowPT.eps");
   
   TGraph *gr93 = new TGraph(n11, recoprojprel2_lowPT_1stbin , recocosCMT_lowPT_1stbin);
   TCanvas *c93 = new TCanvas("c93","",900, 900);
   TH1F *hr93 = c93->DrawFrame(0.,-1,1.6,1);

   c93->SetGrid();
   gr93->SetTitle("");
   gr93->GetXaxis()->SetTitle("p^{#perp}_{pn-p2} [GeV/c]");
   gr93->GetYaxis()->SetTitle("cos #gamma^{T}_{CM}");
   gr93->GetXaxis()->SetLimits(0.,1.6);
   gr93->GetYaxis()->SetLimits(-1,1);
   gr93->GetYaxis()->SetRangeUser(-1,1);
   gr93->GetXaxis()->SetRangeUser(0.,1.6);
   gr93->SetMarkerColor(kRed);
   gr93->Draw("same A*");

   TLegend *lgr93 = new TLegend(0.53, 0.8, 0.9, 0.9);
   lgr93 -> AddEntry(gr93, "MicroBooNE on-beam data", "p");
   lgr93 ->SetTextSize(0.025);
   lgr93 -> Draw();
   
   c93->Update();
   c93-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_transcCM_Prel2_lowPT_1stbin.pdf");
   c93-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_transcCM_Prel2_lowPT_1stbin.eps");


   ///   
   TGraph *gr94 = new TGraph(n1, y33 ,recocosCMT_nocut);
   TCanvas *c94 = new TCanvas("c94","",900, 900);
   TH1F *hr94 = c94->DrawFrame(-1.,-1,1.,1);

   c94->SetGrid();
   gr94->SetTitle("");
   gr94->GetXaxis()->SetTitle("cos #gamma_{CM}");
   gr94->GetYaxis()->SetTitle("cos #gamma^{T}_{CM}");
   gr94->GetXaxis()->SetLimits(-1.,1.);
   gr94->GetYaxis()->SetLimits(-1,1);
   gr94->GetYaxis()->SetRangeUser(-1,1);
   gr94->GetXaxis()->SetRangeUser(-1.,1.);
   gr94->SetMarkerColor(kRed);
   gr94->Draw("same A*");

   TLegend *lgr94 = new TLegend(0.53, 0.8, 0.9, 0.9);
   lgr94 -> AddEntry(gr94, "MicroBooNE on-beam data", "p");
   lgr94 ->SetTextSize(0.025);
   lgr94 -> Draw();
   
   c94->Update();
   c94-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_transcCM_cCM_nocut.pdf");
   c94-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_transcCM_cCM_nocut.eps");
   
   TGraph *gr95 = new TGraph(n10, recocosCMPT0 ,recocosCMT_lowPT);
   TCanvas *c95 = new TCanvas("c95","",900, 900);
   TH1F *hr95 = c95->DrawFrame(-1.,-1,1.,1);

   c95->SetGrid();
   gr95->SetTitle("");
   gr95->GetXaxis()->SetTitle("cos #gamma_{CM}");
   gr95->GetYaxis()->SetTitle("cos #gamma^{T}_{CM}");
   gr95->GetXaxis()->SetLimits(-1.,1.);
   gr95->GetYaxis()->SetLimits(-1.,1.);
   gr95->GetYaxis()->SetRangeUser(-1.,1.);
   gr95->GetXaxis()->SetRangeUser(-1.,1.);
   gr95->SetMarkerColor(kRed);
   gr95->Draw("same A*");

   TLegend *lgr95 = new TLegend(0.53, 0.8, 0.9, 0.9);
   lgr95 -> AddEntry(gr95, "MicroBooNE on-beam data", "p");
   lgr95 ->SetTextSize(0.025);
   lgr95 -> Draw();
   
   c95->Update();
   c95-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_transcCM_cCM_lowPT.pdf");
   c95-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_data/SB/gr_transcCM_cCM_lowPT.eps");
