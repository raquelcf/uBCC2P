...
// Mon Aug 13 12:09:23 2018 by ROOT version 6.06/08
// from TTree cc1unptree/
// found on file: /uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/PlotsPID/files/merged_output_Aug092018_2135_v4/ubxsec_output_data_bnbon_merged_complete.root
//////////////////////////////////////////////////////////

#ifndef hanalysis_fOnBeam_minColl_h
#define hanalysis_fOnBeam_minColl_h
...
class hanalysis_fOnBeam_minColl : public TSelector {
public :
   ...
   hanalysis_fOnBeam_minColl(TTree * /*tree*/ =0) { }
   virtual ~hanalysis_fOnBeam_minColl() { }
   ...
   ClassDef(hanalysis_fOnBeam_minColl,0);

};

#endif

#ifdef hanalysis_fOnBeam_minColl_cxx
void hanalysis_fOnBeam_minColl::Init(TTree *tree)
{
...
Bool_t hanalysis_fOnBeam_minColl::Notify()
{
...
#endif // #ifdef hanalysis_fOnBeam_minColl_cxx
