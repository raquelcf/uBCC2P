...
#ifndef hanalysis_fOnBeam_PID_h
#define hanalysis_fOnBeam_PID_h
...
class hanalysis_fOnBeam_PID : public TSelector {
public :
   ...
   hanalysis_fOnBeam_PID(TTree * /*tree*/ =0) { }
   virtual ~hanalysis_fOnBeam_PID() { }
   ...
   ClassDef(hanalysis_fOnBeam_PID,0);

};

#endif

#ifdef hanalysis_fOnBeam_PID_cxx
void hanalysis_fOnBeam_PID::Init(TTree *tree)
{
...
Bool_t hanalysis_fOnBeam_PID::Notify()
{
...
#endif // #ifdef hanalysis_fOnBeam_PID_cxx
