...
#ifndef hanalysis_fOnBeam_SB_h
#define hanalysis_fOnBeam_SB_h
...
class hanalysis_fOnBeam_SB : public TSelector {
public :
   ...
   hanalysis_fOnBeam_SB(TTree * /*tree*/ =0) { }
   virtual ~hanalysis_fOnBeam_SB() { }
   ...
   ClassDef(hanalysis_fOnBeam_SB,0);

};

#endif

#ifdef hanalysis_fOnBeam_SB_cxx
void hanalysis_fOnBeam_SB::Init(TTree *tree)
{
...
Bool_t hanalysis_fOnBeam_SB::Notify()
{
...
#endif // #ifdef hanalysis_fOnBeam_SB_cxx
