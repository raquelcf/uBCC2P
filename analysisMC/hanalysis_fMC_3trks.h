...
// Mon Aug 13 12:05:18 2018 by ROOT version 6.06/08
...
#ifndef hanalysis_fMC_3trks_h
#define hanalysis_fMC_3trks_h
...
class hanalysis_fMC_3trks : public TSelector {
public :
   ...
   hanalysis_fMC_3trks(TTree * /*tree*/ =0) { }
   virtual ~hanalysis_fMC_3trks() { }
   ...
   ClassDef(hanalysis_fMC_3trks,0);

};

#endif

#ifdef hanalysis_fMC_3trks_cxx
void hanalysis_fMC_3trks::Init(TTree *tree)
{
...
Bool_t hanalysis_fMC_3trks::Notify()
{
...
#endif // #ifdef hanalysis_fMC_3trks_cxx
