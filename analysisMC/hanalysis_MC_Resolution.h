...
// Thu Jul 11 13:42:39 2019 by ROOT version 6.06/08
...
#ifndef hanalysis_MC_Resolution_h
#define hanalysis_MC_Resolution_h
...
class hanalysis_MC_Resolution : public TSelector {
public :
   ...
   hanalysis_MC_Resolution(TTree * /*tree*/ =0) { }
   virtual ~hanalysis_MC_Resolution() { }
   ...
   ClassDef(hanalysis_MC_Resolution,0);

};

#endif

#ifdef hanalysis_MC_Resolution_cxx
void hanalysis_MC_Resolution::Init(TTree *tree)
{
...
Bool_t hanalysis_MC_Resolution::Notify()
{
...
#endif // #ifdef hanalysis_MC_Resolution_cxx
