...
#ifndef hanalysis_fMC_PID_h
#define hanalysis_fMC_PID_h
...
class hanalysis_fMC_PID : public TSelector {
public :
   ...
   hanalysis_fMC_PID(TTree * /*tree*/ =0) { }
   virtual ~hanalysis_fMC_PID() { }
   ...
   ClassDef(hanalysis_fMC_PID,0);

};

#endif

#ifdef hanalysis_fMC_PID_cxx
void hanalysis_fMC_PID::Init(TTree *tree)
{
...
Bool_t hanalysis_fMC_PID::Notify()
{
...
#endif // #ifdef hanalysis_fMC_PID_cxx
