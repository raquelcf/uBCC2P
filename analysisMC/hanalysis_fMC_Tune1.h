...
#ifndef hanalysis_fMC_Tune1_h
#define hanalysis_fMC_Tune1_h
...
class hanalysis_fMC_Tune1 : public TSelector {
public :
   ...
   hanalysis_fMC_Tune1(TTree * /*tree*/ =0) { }
   virtual ~hanalysis_fMC_Tune1() { }
   ...
   ClassDef(hanalysis_fMC_Tune1,0);

};

#endif

#ifdef hanalysis_fMC_Tune1_cxx
void hanalysis_fMC_Tune1::Init(TTree *tree)
{
...
Bool_t hanalysis_fMC_Tune1::Notify()
{
...
#endif // #ifdef hanalysis_fMC_Tune1_cxx
