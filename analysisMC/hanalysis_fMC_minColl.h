...
// Mon Aug 13 12:05:33 2018 by ROOT version 6.06/08
...
#ifndef hanalysis_fMC_minColl_h
#define hanalysis_fMC_minColl_h
...
class hanalysis_fMC_minColl : public TSelector {
public :
   ...
   hanalysis_fMC_minColl(TTree * /*tree*/ =0) { }
   virtual ~hanalysis_fMC_minColl() { }
   ...
   ClassDef(hanalysis_fMC_minColl,0);

};

#endif

#ifdef hanalysis_fMC_minColl_cxx
void hanalysis_fMC_minColl::Init(TTree *tree)
{
...
Bool_t hanalysis_fMC_minColl::Notify()
{
...
#endif // #ifdef hanalysis_fMC_minColl_cxx
