...
// Mon Aug 13 12:05:26 2018 by ROOT version 6.06/08
...
#ifndef hanalysis_fMC_2pcont_h
#define hanalysis_fMC_2pcont_h
...
class hanalysis_fMC_2pcont : public TSelector {
public :
   ...
   hanalysis_fMC_2pcont(TTree * /*tree*/ =0) { }
   virtual ~hanalysis_fMC_2pcont() { }
   ...
   ClassDef(hanalysis_fMC_2pcont,0);

};

#endif

#ifdef hanalysis_fMC_2pcont_cxx
void hanalysis_fMC_2pcont::Init(TTree *tree)
{
...
Bool_t hanalysis_fMC_2pcont::Notify()
{
...
#endif // #ifdef hanalysis_fMC_2pcont_cxx
