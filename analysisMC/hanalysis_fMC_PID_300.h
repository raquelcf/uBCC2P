...
#ifndef hanalysis_fMC_PID_300_h
#define hanalysis_fMC_PID_300_h
...
class hanalysis_fMC_PID_300 : public TSelector {
public :
   ...
   hanalysis_fMC_PID_300(TTree * /*tree*/ =0) { }
   virtual ~hanalysis_fMC_PID_300() { }
   ...
   ClassDef(hanalysis_fMC_PID_300,0);

};

#endif

#ifdef hanalysis_fMC_PID_300_cxx
void hanalysis_fMC_PID_300::Init(TTree *tree)
{
...
Bool_t hanalysis_fMC_PID_300::Notify()
{
...
#endif // #ifdef hanalysis_fMC_PID_300_cxx
