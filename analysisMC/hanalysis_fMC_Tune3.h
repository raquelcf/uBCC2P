...
#ifndef hanalysis_fMC_Tune3_h
#define hanalysis_fMC_Tune3_h
...
class hanalysis_fMC_Tune3 : public TSelector {
public :
   ...
   hanalysis_fMC_Tune3(TTree * /*tree*/ =0) { }
   virtual ~hanalysis_fMC_Tune3() { }
   ...
   ClassDef(hanalysis_fMC_Tune3,0);

};

#endif

#ifdef hanalysis_fMC_Tune3_cxx
void hanalysis_fMC_Tune3::Init(TTree *tree)
{
...
Bool_t hanalysis_fMC_Tune3::Notify()
{
...
#endif // #ifdef hanalysis_fMC_Tune3_cxx
