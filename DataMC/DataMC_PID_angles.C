...
void DataMC_PID_angles(){ 
  ...
  TH1D* reco_Enu_CCQE_PID_300 = (TH1D*) BNBMC->Get("reco_Enu_CCQE_PID_300");
  TH1D* reco_Enu_CCRes_PID_300 = (TH1D*) BNBMC->Get("reco_Enu_CCRes_PID_300");
  TH1D* reco_Enu_CCCoh_PID_300 = (TH1D*) BNBMC->Get("reco_Enu_CCCoh_PID_300");
  TH1D* reco_Enu_CCDIS_PID_300 = (TH1D*) BNBMC->Get("reco_Enu_CCDIS_PID_300");
  TH1D* reco_Enu_CCMEC_PID_300 = (TH1D*) BNBMC->Get("reco_Enu_CCMEC_PID_300");
  TH1D* reco_Enu_CCNue_PID_300 = (TH1D*) BNBMC->Get("reco_Enu_CCNue_PID_300");
  TH1D* reco_Enu_NC_PID_300 = (TH1D*) BNBMC->Get("reco_Enu_NC_PID_300");
  TH1D* reco_Enu_other_PID_300 = (TH1D*) BNBMC->Get("reco_Enu_other_PID_300");

  TH1D* reco_PT_CCQE_PID_300 = (TH1D*) BNBMC->Get("reco_PT_CCQE_PID_300");
  TH1D* reco_PT_CCRes_PID_300 = (TH1D*) BNBMC->Get("reco_PT_CCRes_PID_300");
  TH1D* reco_PT_CCCoh_PID_300 = (TH1D*) BNBMC->Get("reco_PT_CCCoh_PID_300");
  TH1D* reco_PT_CCDIS_PID_300 = (TH1D*) BNBMC->Get("reco_PT_CCDIS_PID_300");
  TH1D* reco_PT_CCMEC_PID_300 = (TH1D*) BNBMC->Get("reco_PT_CCMEC_PID_300");
  TH1D* reco_PT_CCNue_PID_300 = (TH1D*) BNBMC->Get("reco_PT_CCNue_PID_300");
  TH1D* reco_PT_NC_PID_300 = (TH1D*) BNBMC->Get("reco_PT_NC_PID_300");
  TH1D* reco_PT_other_PID_300 = (TH1D*) BNBMC->Get("reco_PT_other_PID_300");

  TH1D* reco_p1p2_CCQE_PID_300 = (TH1D*) BNBMC->Get("reco_p1p2_CCQE_PID_300");
  TH1D* reco_p1p2_CCRes_PID_300 = (TH1D*) BNBMC->Get("reco_p1p2_CCRes_PID_300");
  TH1D* reco_p1p2_CCCoh_PID_300 = (TH1D*) BNBMC->Get("reco_p1p2_CCCoh_PID_300");
  TH1D* reco_p1p2_CCDIS_PID_300 = (TH1D*) BNBMC->Get("reco_p1p2_CCDIS_PID_300");
  TH1D* reco_p1p2_CCMEC_PID_300 = (TH1D*) BNBMC->Get("reco_p1p2_CCMEC_PID_300");
  TH1D* reco_p1p2_CCNue_PID_300 = (TH1D*) BNBMC->Get("reco_p1p2_CCNue_PID_300");
  TH1D* reco_p1p2_NC_PID_300 = (TH1D*) BNBMC->Get("reco_p1p2_NC_PID_300");
  TH1D* reco_p1p2_other_PID_300 = (TH1D*) BNBMC->Get("reco_p1p2_other_PID_300");

  TH1D* reco_dp1p2_CCQE_PID_300 = (TH1D*) BNBMC->Get("reco_dp1p2_CCQE_PID_300");
  TH1D* reco_dp1p2_CCRes_PID_300 = (TH1D*) BNBMC->Get("reco_dp1p2_CCRes_PID_300");
  TH1D* reco_dp1p2_CCCoh_PID_300 = (TH1D*) BNBMC->Get("reco_dp1p2_CCCoh_PID_300");
  TH1D* reco_dp1p2_CCDIS_PID_300 = (TH1D*) BNBMC->Get("reco_dp1p2_CCDIS_PID_300");
  TH1D* reco_dp1p2_CCMEC_PID_300 = (TH1D*) BNBMC->Get("reco_dp1p2_CCMEC_PID_300");
  TH1D* reco_dp1p2_CCNue_PID_300 = (TH1D*) BNBMC->Get("reco_dp1p2_CCNue_PID_300");
  TH1D* reco_dp1p2_NC_PID_300 = (TH1D*) BNBMC->Get("reco_dp1p2_NC_PID_300");
  TH1D* reco_dp1p2_other_PID_300 = (TH1D*) BNBMC->Get("reco_dp1p2_other_PID_300");

  TH1D* reco_kp1p2_CCQE_PID_300 = (TH1D*) BNBMC->Get("reco_kp1p2_CCQE_PID_300");
  TH1D* reco_kp1p2_CCRes_PID_300 = (TH1D*) BNBMC->Get("reco_kp1p2_CCRes_PID_300");
  TH1D* reco_kp1p2_CCCoh_PID_300 = (TH1D*) BNBMC->Get("reco_kp1p2_CCCoh_PID_300");
  TH1D* reco_kp1p2_CCDIS_PID_300 = (TH1D*) BNBMC->Get("reco_kp1p2_CCDIS_PID_300");
  TH1D* reco_kp1p2_CCMEC_PID_300 = (TH1D*) BNBMC->Get("reco_kp1p2_CCMEC_PID_300");
  TH1D* reco_kp1p2_CCNue_PID_300 = (TH1D*) BNBMC->Get("reco_kp1p2_CCNue_PID_300");
  TH1D* reco_kp1p2_NC_PID_300 = (TH1D*) BNBMC->Get("reco_kp1p2_NC_PID_300");
  TH1D* reco_kp1p2_other_PID_300 = (TH1D*) BNBMC->Get("reco_kp1p2_other_PID_300");

  TH1D* reco_kp1p2_CCQE_PID_300_btb = (TH1D*) BNBMC->Get("reco_kp1p2_CCQE_PID_300_btb");
  TH1D* reco_kp1p2_CCRes_PID_300_btb = (TH1D*) BNBMC->Get("reco_kp1p2_CCRes_PID_300_btb");
  TH1D* reco_kp1p2_CCCoh_PID_300_btb = (TH1D*) BNBMC->Get("reco_kp1p2_CCCoh_PID_300_btb");
  TH1D* reco_kp1p2_CCDIS_PID_300_btb = (TH1D*) BNBMC->Get("reco_kp1p2_CCDIS_PID_300_btb");
  TH1D* reco_kp1p2_CCMEC_PID_300_btb = (TH1D*) BNBMC->Get("reco_kp1p2_CCMEC_PID_300_btb");
  TH1D* reco_kp1p2_CCNue_PID_300_btb = (TH1D*) BNBMC->Get("reco_kp1p2_CCNue_PID_300_btb");
  TH1D* reco_kp1p2_NC_PID_300_btb = (TH1D*) BNBMC->Get("reco_kp1p2_NC_PID_300_btb");
  TH1D* reco_kp1p2_other_PID_300_btb = (TH1D*) BNBMC->Get("reco_kp1p2_other_PID_300_btb");

  TH1D* reco_PT_CCQE_1binCM_PID_300 = (TH1D*) BNBMC->Get("reco_PT_CCQE_1binCM_PID_300");
  TH1D* reco_PT_CCRes_1binCM_PID_300 = (TH1D*) BNBMC->Get("reco_PT_CCRes_1binCM_PID_300");
  TH1D* reco_PT_CCCoh_1binCM_PID_300 = (TH1D*) BNBMC->Get("reco_PT_CCCoh_1binCM_PID_300");
  TH1D* reco_PT_CCDIS_1binCM_PID_300 = (TH1D*) BNBMC->Get("reco_PT_CCDIS_1binCM_PID_300");
  TH1D* reco_PT_CCMEC_1binCM_PID_300 = (TH1D*) BNBMC->Get("reco_PT_CCMEC_1binCM_PID_300");
  TH1D* reco_PT_CCNue_1binCM_PID_300 = (TH1D*) BNBMC->Get("reco_PT_CCNue_1binCM_PID_300");
  TH1D* reco_PT_NC_1binCM_PID_300 = (TH1D*) BNBMC->Get("reco_PT_NC_1binCM_PID_300");
  TH1D* reco_PT_other_1binCM_PID_300 = (TH1D*) BNBMC->Get("reco_PT_other_1binCM_PID_300");
  
  TH1D* reco_pn_CCQE_PID_300 = (TH1D*) BNBMC->Get("reco_pn_CCQE_PID_300");
  TH1D* reco_pn_CCRes_PID_300 = (TH1D*) BNBMC->Get("reco_pn_CCRes_PID_300");
  TH1D* reco_pn_CCCoh_PID_300 = (TH1D*) BNBMC->Get("reco_pn_CCCoh_PID_300");
  TH1D* reco_pn_CCDIS_PID_300 = (TH1D*) BNBMC->Get("reco_pn_CCDIS_PID_300");
  TH1D* reco_pn_CCMEC_PID_300 = (TH1D*) BNBMC->Get("reco_pn_CCMEC_PID_300");
  TH1D* reco_pn_CCNue_PID_300 = (TH1D*) BNBMC->Get("reco_pn_CCNue_PID_300");
  TH1D* reco_pn_NC_PID_300 = (TH1D*) BNBMC->Get("reco_pn_NC_PID_300");
  TH1D* reco_pn_other_PID_300 = (TH1D*) BNBMC->Get("reco_pn_other_PID_300");

  TH2D* p1p2_PID_300 = (TH2D*) BNBMC->Get("p1p2_PID_300");
  TH2D* reco_angle_p1p2_p2_PID_300_LF = (TH2D*) BNBMC->Get("reco_angle_p1p2_p2_PID_300_LF");
  TH2D* reco_angle_p1p2_PID_300_LF_CM = (TH2D*) BNBMC->Get("reco_angle_p1p2_PID_300_LF_CM");

  TH2D* reco_angle_p1p2_p2_PID_300_LF_btb = (TH2D*) BNBMC->Get("reco_angle_p1p2_p2_PID_300_LF_btb");

  /// opening angle lab frame

  TH1D* reco_angle_p1p2_CCQE_PID_300_LF = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCQE_PID_300_LF");
  TH1D* reco_angle_p1p2_CCRes_PID_300_LF = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCRes_PID_300_LF");
  TH1D* reco_angle_p1p2_CCCoh_PID_300_LF = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCCoh_PID_300_LF");
  TH1D* reco_angle_p1p2_CCDIS_PID_300_LF = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCDIS_PID_300_LF");
  TH1D* reco_angle_p1p2_CCMEC_PID_300_LF = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCMEC_PID_300_LF");
  TH1D* reco_angle_p1p2_CCNue_PID_300_LF = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCNue_PID_300_LF");
  TH1D* reco_angle_p1p2_NC_PID_300_LF = (TH1D*) BNBMC->Get("reco_angle_p1p2_NC_PID_300_LF");
  TH1D* reco_angle_p1p2_other_PID_300_LF = (TH1D*) BNBMC->Get("reco_angle_p1p2_other_PID_300_LF");

  TH1D* reco_angle_p1p2_CCQE_PID_300_LF_btb = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCQE_PID_300_LF_btb");
  TH1D* reco_angle_p1p2_CCRes_PID_300_LF_btb = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCRes_PID_300_LF_btb");
  TH1D* reco_angle_p1p2_CCCoh_PID_300_LF_btb = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCCoh_PID_300_LF_btb");
  TH1D* reco_angle_p1p2_CCDIS_PID_300_LF_btb = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCDIS_PID_300_LF_btb");
  TH1D* reco_angle_p1p2_CCMEC_PID_300_LF_btb = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCMEC_PID_300_LF_btb");
  TH1D* reco_angle_p1p2_CCNue_PID_300_LF_btb = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCNue_PID_300_LF_btb");
  TH1D* reco_angle_p1p2_NC_PID_300_LF_btb = (TH1D*) BNBMC->Get("reco_angle_p1p2_NC_PID_300_LF_btb");
  TH1D* reco_angle_p1p2_other_PID_300_LF_btb = (TH1D*) BNBMC->Get("reco_angle_p1p2_other_PID_300_LF_btb");
  
  ///
  TH1D* reco_angle_p1p2_CCQE_PID_300_LF_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCQE_PID_300_LF_zoom");
  TH1D* reco_angle_p1p2_CCRes_PID_300_LF_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCRes_PID_300_LF_zoom");
  TH1D* reco_angle_p1p2_CCCoh_PID_300_LF_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCCoh_PID_300_LF_zoom");
  TH1D* reco_angle_p1p2_CCDIS_PID_300_LF_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCDIS_PID_300_LF_zoom");
  TH1D* reco_angle_p1p2_CCMEC_PID_300_LF_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCMEC_PID_300_LF_zoom");
  TH1D* reco_angle_p1p2_CCNue_PID_300_LF_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCNue_PID_300_LF_zoom");
  TH1D* reco_angle_p1p2_NC_PID_300_LF_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_NC_PID_300_LF_zoom");
  TH1D* reco_angle_p1p2_other_PID_300_LF_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_other_PID_300_LF_zoom");

  TH1D* reco_angle_p1p2_CCQE_PID_300_LF_btb_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCQE_PID_300_LF_btb_zoom");
  TH1D* reco_angle_p1p2_CCRes_PID_300_LF_btb_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCRes_PID_300_LF_btb_zoom");
  TH1D* reco_angle_p1p2_CCCoh_PID_300_LF_btb_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCCoh_PID_300_LF_btb_zoom");
  TH1D* reco_angle_p1p2_CCDIS_PID_300_LF_btb_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCDIS_PID_300_LF_btb_zoom");
  TH1D* reco_angle_p1p2_CCMEC_PID_300_LF_btb_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCMEC_PID_300_LF_btb_zoom");
  TH1D* reco_angle_p1p2_CCNue_PID_300_LF_btb_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCNue_PID_300_LF_btb_zoom");
  TH1D* reco_angle_p1p2_NC_PID_300_LF_btb_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_NC_PID_300_LF_btb_zoom");
  TH1D* reco_angle_p1p2_other_PID_300_LF_btb_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_other_PID_300_LF_btb_zoom");
  ...
  TH1D* reco_angle_p1p2_CCQE_PID_300_CM_btb = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCQE_PID_300_CM_btb");
  TH1D* reco_angle_p1p2_CCRes_PID_300_CM_btb = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCRes_PID_300_CM_btb");
  TH1D* reco_angle_p1p2_CCCoh_PID_300_CM_btb = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCCoh_PID_300_CM_btb");
  TH1D* reco_angle_p1p2_CCDIS_PID_300_CM_btb = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCDIS_PID_300_CM_btb");
  TH1D* reco_angle_p1p2_CCMEC_PID_300_CM_btb = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCMEC_PID_300_CM_btb");
  TH1D* reco_angle_p1p2_CCNue_PID_300_CM_btb = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCNue_PID_300_CM_btb");
  TH1D* reco_angle_p1p2_NC_PID_300_CM_btb = (TH1D*) BNBMC->Get("reco_angle_p1p2_NC_PID_300_CM_btb");
  TH1D* reco_angle_p1p2_other_PID_300_CM_btb = (TH1D*) BNBMC->Get("reco_angle_p1p2_other_PID_300_CM_btb");

  TH1D* reco_angle_p1p2_CCQE_PID_300_CM = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCQE_PID_300_CM");
  TH1D* reco_angle_p1p2_CCRes_PID_300_CM = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCRes_PID_300_CM");
  TH1D* reco_angle_p1p2_CCCoh_PID_300_CM = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCCoh_PID_300_CM");
  TH1D* reco_angle_p1p2_CCDIS_PID_300_CM = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCDIS_PID_300_CM");
  TH1D* reco_angle_p1p2_CCMEC_PID_300_CM = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCMEC_PID_300_CM");
  TH1D* reco_angle_p1p2_CCNue_PID_300_CM = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCNue_PID_300_CM");
  TH1D* reco_angle_p1p2_NC_PID_300_CM = (TH1D*) BNBMC->Get("reco_angle_p1p2_NC_PID_300_CM");
  TH1D* reco_angle_p1p2_other_PID_300_CM = (TH1D*) BNBMC->Get("reco_angle_p1p2_other_PID_300_CM");
  /////////

  TH1D* reco_angle_SRCrest_p1p2_CCQE_PID_300_CM = (TH1D*) BNBMC->Get("reco_angle_SRCrest_p1p2_CCQE_PID_300_CM");
  TH1D* reco_angle_SRCrest_p1p2_CCRes_PID_300_CM = (TH1D*) BNBMC->Get("reco_angle_SRCrest_p1p2_CCRes_PID_300_CM");
  TH1D* reco_angle_SRCrest_p1p2_CCCoh_PID_300_CM = (TH1D*) BNBMC->Get("reco_angle_SRCrest_p1p2_CCCoh_PID_300_CM");
  TH1D* reco_angle_SRCrest_p1p2_CCDIS_PID_300_CM = (TH1D*) BNBMC->Get("reco_angle_SRCrest_p1p2_CCDIS_PID_300_CM");
  TH1D* reco_angle_SRCrest_p1p2_CCMEC_PID_300_CM = (TH1D*) BNBMC->Get("reco_angle_SRCrest_p1p2_CCMEC_PID_300_CM");
  TH1D* reco_angle_SRCrest_p1p2_CCNue_PID_300_CM = (TH1D*) BNBMC->Get("reco_angle_SRCrest_p1p2_CCNue_PID_300_CM");
  TH1D* reco_angle_SRCrest_p1p2_NC_PID_300_CM = (TH1D*) BNBMC->Get("reco_angle_SRCrest_p1p2_NC_PID_300_CM");
  //TH1D* reco_angle_SRCrest_p1p2_other_PID_300_CM = (TH1D*) BNBMC->Get("reco_angle_SRCrest_p1p2_other_PID_300_CM");

  ///
  TH1D* reco_angle_p1p2_CCQE_PID_300_CM_btb_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCQE_PID_300_CM_btb_zoom");
  TH1D* reco_angle_p1p2_CCRes_PID_300_CM_btb_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCRes_PID_300_CM_btb_zoom");
  TH1D* reco_angle_p1p2_CCCoh_PID_300_CM_btb_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCCoh_PID_300_CM_btb_zoom");
  TH1D* reco_angle_p1p2_CCDIS_PID_300_CM_btb_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCDIS_PID_300_CM_btb_zoom");
  TH1D* reco_angle_p1p2_CCMEC_PID_300_CM_btb_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCMEC_PID_300_CM_btb_zoom");
  TH1D* reco_angle_p1p2_CCNue_PID_300_CM_btb_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCNue_PID_300_CM_btb_zoom");
  TH1D* reco_angle_p1p2_NC_PID_300_CM_btb_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_NC_PID_300_CM_btb_zoom");
  TH1D* reco_angle_p1p2_other_PID_300_CM_btb_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_other_PID_300_CM_btb_zoom");

  TH1D* reco_angle_p1p2_CCQE_PID_300_CM_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCQE_PID_300_CM_zoom");
  TH1D* reco_angle_p1p2_CCRes_PID_300_CM_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCRes_PID_300_CM_zoom");
  TH1D* reco_angle_p1p2_CCCoh_PID_300_CM_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCCoh_PID_300_CM_zoom");
  TH1D* reco_angle_p1p2_CCDIS_PID_300_CM_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCDIS_PID_300_CM_zoom");
  TH1D* reco_angle_p1p2_CCMEC_PID_300_CM_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCMEC_PID_300_CM_zoom");
  TH1D* reco_angle_p1p2_CCNue_PID_300_CM_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_CCNue_PID_300_CM_zoom");
  TH1D* reco_angle_p1p2_NC_PID_300_CM_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_NC_PID_300_CM_zoom");
  TH1D* reco_angle_p1p2_other_PID_300_CM_zoom = (TH1D*) BNBMC->Get("reco_angle_p1p2_other_PID_300_CM_zoom");
  ...
  ///// resolutions (MC)
  TH2D* res_Enu_PID_300 = (TH2D*) BNBMC->Get("res_Enu_PID_300");
  ...
  */
  ...
  reco_Enu_CCQE_PID_300->Scale(normMCBNB);
  reco_Enu_CCRes_PID_300->Scale(normMCBNB);
  reco_Enu_CCCoh_PID_300->Scale(normMCBNB);
  reco_Enu_CCDIS_PID_300->Scale(normMCBNB);
  reco_Enu_CCMEC_PID_300->Scale(normMCBNB);
  reco_Enu_CCNue_PID_300->Scale(normMCBNB);
  reco_Enu_NC_PID_300->Scale(normMCBNB);
  reco_Enu_other_PID_300->Scale(normMCBNB);

  reco_PT_CCQE_PID_300->Scale(normMCBNB);
  reco_PT_CCRes_PID_300->Scale(normMCBNB);
  reco_PT_CCCoh_PID_300->Scale(normMCBNB);
  reco_PT_CCDIS_PID_300->Scale(normMCBNB);
  reco_PT_CCMEC_PID_300->Scale(normMCBNB);
  reco_PT_CCNue_PID_300->Scale(normMCBNB);
  reco_PT_NC_PID_300->Scale(normMCBNB);
  reco_PT_other_PID_300->Scale(normMCBNB);

  reco_PT_CCQE_1binCM_PID_300->Scale(normMCBNB);
  reco_PT_CCRes_1binCM_PID_300->Scale(normMCBNB);
  reco_PT_CCCoh_1binCM_PID_300->Scale(normMCBNB);
  reco_PT_CCDIS_1binCM_PID_300->Scale(normMCBNB);
  reco_PT_CCMEC_1binCM_PID_300->Scale(normMCBNB);
  reco_PT_CCNue_1binCM_PID_300->Scale(normMCBNB);
  reco_PT_NC_1binCM_PID_300->Scale(normMCBNB);
  reco_PT_other_1binCM_PID_300->Scale(normMCBNB);

  reco_pn_CCQE_PID_300->Scale(normMCBNB);
  reco_pn_CCRes_PID_300->Scale(normMCBNB);
  reco_pn_CCCoh_PID_300->Scale(normMCBNB);
  reco_pn_CCDIS_PID_300->Scale(normMCBNB);
  reco_pn_CCMEC_PID_300->Scale(normMCBNB);
  reco_pn_CCNue_PID_300->Scale(normMCBNB);
  reco_pn_NC_PID_300->Scale(normMCBNB);
  reco_pn_other_PID_300->Scale(normMCBNB);

  reco_p1p2_CCQE_PID_300->Scale(normMCBNB);
  reco_p1p2_CCRes_PID_300->Scale(normMCBNB);
  reco_p1p2_CCCoh_PID_300->Scale(normMCBNB);
  reco_p1p2_CCDIS_PID_300->Scale(normMCBNB);
  reco_p1p2_CCMEC_PID_300->Scale(normMCBNB);
  reco_p1p2_CCNue_PID_300->Scale(normMCBNB);
  reco_p1p2_NC_PID_300->Scale(normMCBNB);
  reco_p1p2_other_PID_300->Scale(normMCBNB);

  reco_dp1p2_CCQE_PID_300->Scale(normMCBNB);
  reco_dp1p2_CCRes_PID_300->Scale(normMCBNB);
  reco_dp1p2_CCCoh_PID_300->Scale(normMCBNB);
  reco_dp1p2_CCDIS_PID_300->Scale(normMCBNB);
  reco_dp1p2_CCMEC_PID_300->Scale(normMCBNB);
  reco_dp1p2_CCNue_PID_300->Scale(normMCBNB);
  reco_dp1p2_NC_PID_300->Scale(normMCBNB);
  reco_dp1p2_other_PID_300->Scale(normMCBNB);

  reco_kp1p2_CCQE_PID_300->Scale(normMCBNB);
  reco_kp1p2_CCRes_PID_300->Scale(normMCBNB);
  reco_kp1p2_CCCoh_PID_300->Scale(normMCBNB);
  reco_kp1p2_CCDIS_PID_300->Scale(normMCBNB);
  reco_kp1p2_CCMEC_PID_300->Scale(normMCBNB);
  reco_kp1p2_CCNue_PID_300->Scale(normMCBNB);
  reco_kp1p2_NC_PID_300->Scale(normMCBNB);
  reco_kp1p2_other_PID_300->Scale(normMCBNB);

  reco_kp1p2_CCQE_PID_300_btb->Scale(normMCBNB);
  reco_kp1p2_CCRes_PID_300_btb->Scale(normMCBNB);
  reco_kp1p2_CCCoh_PID_300_btb->Scale(normMCBNB);
  reco_kp1p2_CCDIS_PID_300_btb->Scale(normMCBNB);
  reco_kp1p2_CCMEC_PID_300_btb->Scale(normMCBNB);
  reco_kp1p2_CCNue_PID_300_btb->Scale(normMCBNB);
  reco_kp1p2_NC_PID_300_btb->Scale(normMCBNB);
  reco_kp1p2_other_PID_300_btb->Scale(normMCBNB);

  reco_angle_p1p2_CCQE_PID_300_LF->Scale(normMCBNB);
  reco_angle_p1p2_CCRes_PID_300_LF->Scale(normMCBNB);
  reco_angle_p1p2_CCCoh_PID_300_LF->Scale(normMCBNB);
  reco_angle_p1p2_CCDIS_PID_300_LF->Scale(normMCBNB);
  reco_angle_p1p2_CCMEC_PID_300_LF->Scale(normMCBNB);
  reco_angle_p1p2_CCNue_PID_300_LF->Scale(normMCBNB);
  reco_angle_p1p2_NC_PID_300_LF->Scale(normMCBNB);
  reco_angle_p1p2_other_PID_300_LF->Scale(normMCBNB);

  reco_angle_p1p2_CCQE_PID_300_CM->Scale(normMCBNB);
  reco_angle_p1p2_CCRes_PID_300_CM->Scale(normMCBNB);
  reco_angle_p1p2_CCCoh_PID_300_CM->Scale(normMCBNB);
  reco_angle_p1p2_CCDIS_PID_300_CM->Scale(normMCBNB);
  reco_angle_p1p2_CCMEC_PID_300_CM->Scale(normMCBNB);
  reco_angle_p1p2_CCNue_PID_300_CM->Scale(normMCBNB);
  reco_angle_p1p2_NC_PID_300_CM->Scale(normMCBNB);
  reco_angle_p1p2_other_PID_300_CM->Scale(normMCBNB);

  reco_angle_SRCrest_p1p2_CCQE_PID_300_CM->Scale(normMCBNB);
  reco_angle_SRCrest_p1p2_CCRes_PID_300_CM->Scale(normMCBNB);
  reco_angle_SRCrest_p1p2_CCCoh_PID_300_CM->Scale(normMCBNB);
  reco_angle_SRCrest_p1p2_CCDIS_PID_300_CM->Scale(normMCBNB);
  reco_angle_SRCrest_p1p2_CCMEC_PID_300_CM->Scale(normMCBNB);
  reco_angle_SRCrest_p1p2_CCNue_PID_300_CM->Scale(normMCBNB);
  reco_angle_SRCrest_p1p2_NC_PID_300_CM->Scale(normMCBNB);
  //reco_angle_SRCrest_p1p2_other_PID_300_CM->Scale(normMCBNB);
  //
 
  reco_angle_p1p2_CCQE_PID_300_LF_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCRes_PID_300_LF_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCCoh_PID_300_LF_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCDIS_PID_300_LF_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCMEC_PID_300_LF_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCNue_PID_300_LF_zoom->Scale(normMCBNB);
  reco_angle_p1p2_NC_PID_300_LF_zoom->Scale(normMCBNB);
  reco_angle_p1p2_other_PID_300_LF_zoom->Scale(normMCBNB);

  reco_angle_p1p2_CCQE_PID_300_CM_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCRes_PID_300_CM_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCCoh_PID_300_CM_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCDIS_PID_300_CM_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCMEC_PID_300_CM_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCNue_PID_300_CM_zoom->Scale(normMCBNB);
  reco_angle_p1p2_NC_PID_300_CM_zoom->Scale(normMCBNB);
  reco_angle_p1p2_other_PID_300_CM_zoom->Scale(normMCBNB);
  //
  reco_angle_p1p2_CCQE_PID_300_LF_btb->Scale(normMCBNB);
  reco_angle_p1p2_CCRes_PID_300_LF_btb->Scale(normMCBNB);
  reco_angle_p1p2_CCCoh_PID_300_LF_btb->Scale(normMCBNB);
  reco_angle_p1p2_CCDIS_PID_300_LF_btb->Scale(normMCBNB);
  reco_angle_p1p2_CCMEC_PID_300_LF_btb->Scale(normMCBNB);
  reco_angle_p1p2_CCNue_PID_300_LF_btb->Scale(normMCBNB);
  reco_angle_p1p2_NC_PID_300_LF_btb->Scale(normMCBNB);
  reco_angle_p1p2_other_PID_300_LF_btb->Scale(normMCBNB);

  reco_angle_p1p2_CCQE_PID_300_CM_btb->Scale(normMCBNB);
  reco_angle_p1p2_CCRes_PID_300_CM_btb->Scale(normMCBNB);
  reco_angle_p1p2_CCCoh_PID_300_CM_btb->Scale(normMCBNB);
  reco_angle_p1p2_CCDIS_PID_300_CM_btb->Scale(normMCBNB);
  reco_angle_p1p2_CCMEC_PID_300_CM_btb->Scale(normMCBNB);
  reco_angle_p1p2_CCNue_PID_300_CM_btb->Scale(normMCBNB);
  reco_angle_p1p2_NC_PID_300_CM_btb->Scale(normMCBNB);
  reco_angle_p1p2_other_PID_300_CM_btb->Scale(normMCBNB);
  ////
  reco_angle_p1p2_CCQE_PID_300_LF_btb_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCRes_PID_300_LF_btb_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCCoh_PID_300_LF_btb_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCDIS_PID_300_LF_btb_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCMEC_PID_300_LF_btb_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCNue_PID_300_LF_btb_zoom->Scale(normMCBNB);
  reco_angle_p1p2_NC_PID_300_LF_btb_zoom->Scale(normMCBNB);
  reco_angle_p1p2_other_PID_300_LF_btb_zoom->Scale(normMCBNB);

  reco_angle_p1p2_CCQE_PID_300_CM_btb_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCRes_PID_300_CM_btb_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCCoh_PID_300_CM_btb_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCDIS_PID_300_CM_btb_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCMEC_PID_300_CM_btb_zoom->Scale(normMCBNB);
  reco_angle_p1p2_CCNue_PID_300_CM_btb_zoom->Scale(normMCBNB);
  reco_angle_p1p2_NC_PID_300_CM_btb_zoom->Scale(normMCBNB);
  reco_angle_p1p2_other_PID_300_CM_btb_zoom->Scale(normMCBNB);
 ...
 std::cout<<"hola 1"<<std::endl;
  ...
  l1 -> SetNColumns(2);
  l1 -> AddEntry(selproton1_costheta_CC0Pion0Proton_PID_300, "CC0P0#pi", "f");
  l1 -> AddEntry(selproton1_costheta_CCNue_PID_300, "CC#nu_{e}", "f");
  l1 -> AddEntry(selproton1_costheta_CC0Pion1Proton_PID_300, "CC1P0#pi", "f");
  l1 -> AddEntry(selproton1_costheta_NC_PID_300, "NC", "f");
  l1 -> AddEntry(selproton1_costheta_CC0Pion2Proton_PID_300, "CC2P0#pi", "f");
  l1 -> AddEntry(selproton1_costheta_OOFV_PID_300, "OOFV", "f");
  l1 -> AddEntry(selproton1_costheta_CC0PionNProton_PID_300, "CCNP0#pi", "f");
  l1 -> AddEntry(selproton1_costheta_EXT_PID_300, "cosmic", "f");
  l1 -> AddEntry(selproton1_costheta_CC1PionNProton_PID_300, "CCNP1#pi", "f");
  l1 -> AddEntry(selproton1_costheta_OffBeam_PID, "off-beam data", "f");
  l1 -> AddEntry(selproton1_costheta_CCNPionNProton_PID_300, "CCNPN#pi", "f");
  ...
  TH1 *last1 = (TH1*)selproton1_costheta_PID_300->GetStack()->Last();
  ...
  c1->Update();
  c1->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/selproton1_costheta_topo_PID_300.pdf");
  ...
  l2 -> SetNColumns(2);
  l2 -> AddEntry(selproton1_phi_CC0Pion0Proton_PID_300, "CC0P0#pi", "f");
  l2 -> AddEntry(selproton1_phi_CCNue_PID_300, "CC#nu_{e}", "f");
  l2 -> AddEntry(selproton1_phi_CC0Pion1Proton_PID_300, "CC1P0#pi", "f");
  l2 -> AddEntry(selproton1_phi_NC_PID_300, "NC", "f");
  l2 -> AddEntry(selproton1_phi_CC0Pion2Proton_PID_300, "CC2P0#pi", "f");
  l2 -> AddEntry(selproton1_phi_OOFV_PID_300, "OOFV", "f");
  l2 -> AddEntry(selproton1_phi_CC0PionNProton_PID_300, "CCNP0#pi", "f");
  l2 -> AddEntry(selproton1_phi_EXT_PID_300, "cosmic", "f");
  l2 -> AddEntry(selproton1_phi_CC1PionNProton_PID_300, "CCNP1#pi", "f");
  l2 -> AddEntry(selproton1_phi_OffBeam_PID, "off-beam data", "f");
  l2 -> AddEntry(selproton1_phi_CCNPionNProton_PID_300, "CCNPN#pi", "f");
  ...
  TH1 *last2 = (TH1*)selproton1_phi_PID_300->GetStack()->Last();
  ...
  c2->Update();
  c2->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/selproton1_phi_topo_PID_300.pdf");
  ...
  l3 -> SetNColumns(2);
  l3 -> AddEntry(selproton1_mom_CC0Pion0Proton_PID_300, "CC0P0#pi", "f");
  l3 -> AddEntry(selproton1_mom_CCNue_PID_300, "CC#nu_{e}", "f");
  l3 -> AddEntry(selproton1_mom_CC0Pion1Proton_PID_300, "CC1P0#pi", "f");
  l3 -> AddEntry(selproton1_mom_NC_PID_300, "NC", "f");
  l3 -> AddEntry(selproton1_mom_CC0Pion2Proton_PID_300, "CC2P0#pi", "f");
  l3 -> AddEntry(selproton1_mom_OOFV_PID_300, "OOFV", "f");
  l3 -> AddEntry(selproton1_mom_CC0PionNProton_PID_300, "CCNP0#pi", "f");
  l3 -> AddEntry(selproton1_mom_EXT_PID_300, "cosmic", "f");
  l3 -> AddEntry(selproton1_mom_CC1PionNProton_PID_300, "CCNP1#pi", "f");
  l3 -> AddEntry(selproton1_mom_OffBeam_PID, "off-beam data", "f");
  l3 -> AddEntry(selproton1_mom_CCNPionNProton_PID_300, "CCNPN#pi", "f");
  ...
  TH1 *last3 = (TH1*)selproton1_mom_PID_300->GetStack()->Last();
  ...
  c3->Update();
  c3->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/selproton1_mom_topo_PID_300.pdf");
  ...
  l4 -> SetNColumns(2);
  l4 -> AddEntry(selproton2_costheta_CC0Pion0Proton_PID_300, "CC0P0#pi", "f");
  l4 -> AddEntry(selproton2_costheta_CCNue_PID_300, "CC#nu_{e}", "f");
  l4 -> AddEntry(selproton2_costheta_CC0Pion1Proton_PID_300, "CC1P0#pi", "f");
  l4 -> AddEntry(selproton2_costheta_NC_PID_300, "NC", "f");
  l4 -> AddEntry(selproton2_costheta_CC0Pion2Proton_PID_300, "CC2P0#pi", "f");
  l4 -> AddEntry(selproton2_costheta_OOFV_PID_300, "OOFV", "f");
  l4 -> AddEntry(selproton2_costheta_CC0PionNProton_PID_300, "CCNP0#pi", "f");
  l4 -> AddEntry(selproton2_costheta_EXT_PID_300, "cosmic", "f");
  l4 -> AddEntry(selproton2_costheta_CC1PionNProton_PID_300, "CCNP1#pi", "f");
  l4 -> AddEntry(selproton2_costheta_OffBeam_PID, "off-beam data", "f");
  l4 -> AddEntry(selproton2_costheta_CCNPionNProton_PID_300, "CCNPN#pi", "f");
  ...
  TH1 *last4 = (TH1*)selproton2_costheta_PID_300->GetStack()->Last();
  ...
  c4->Update();
  c4->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/selproton2_costheta_topo_PID_300.pdf");
  ...
  l5 -> SetNColumns(2);
  l5 -> AddEntry(selproton2_phi_CC0Pion0Proton_PID_300, "CC0P0#pi", "f");
  l5 -> AddEntry(selproton2_phi_CCNue_PID_300, "CC#nu_{e}", "f");
  l5 -> AddEntry(selproton2_phi_CC0Pion1Proton_PID_300, "CC1P0#pi", "f");
  l5 -> AddEntry(selproton2_phi_NC_PID_300, "NC", "f");
  l5 -> AddEntry(selproton2_phi_CC0Pion2Proton_PID_300, "CC2P0#pi", "f");
  l5 -> AddEntry(selproton2_phi_OOFV_PID_300, "OOFV", "f");
  l5 -> AddEntry(selproton2_phi_CC0PionNProton_PID_300, "CCNP0#pi", "f");
  l5 -> AddEntry(selproton2_phi_EXT_PID_300, "cosmic", "f");
  l5 -> AddEntry(selproton2_phi_CC1PionNProton_PID_300, "CCNP1#pi", "f");
  l5 -> AddEntry(selproton2_phi_OffBeam_PID, "off-beam data", "f");
  l5 -> AddEntry(selproton2_phi_CCNPionNProton_PID_300, "CCNPN#pi", "f");
  ...
  TH1 *last5 = (TH1*)selproton2_phi_PID_300->GetStack()->Last();
  ...
  c5->Update();
  c5->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/selproton2_phi_topo_PID_300.pdf");
  ...
  l6 -> SetNColumns(2);
  l6 -> AddEntry(selproton2_mom_CC0Pion0Proton_PID_300, "CC0P0#pi", "f");
  l6 -> AddEntry(selproton2_mom_CCNue_PID_300, "CC#nu_{e}", "f");
  l6 -> AddEntry(selproton2_mom_CC0Pion1Proton_PID_300, "CC1P0#pi", "f");
  l6 -> AddEntry(selproton2_mom_NC_PID_300, "NC", "f");
  l6 -> AddEntry(selproton2_mom_CC0Pion2Proton_PID_300, "CC2P0#pi", "f");
  l6 -> AddEntry(selproton2_mom_OOFV_PID_300, "OOFV", "f");
  l6 -> AddEntry(selproton2_mom_CC0PionNProton_PID_300, "CCNP0#pi", "f");
  l6 -> AddEntry(selproton2_mom_EXT_PID_300, "cosmic", "f");
  l6 -> AddEntry(selproton2_mom_CC1PionNProton_PID_300, "CCNP1#pi", "f");
  l6 -> AddEntry(selproton2_mom_OffBeam_PID, "off-beam data", "f");
  l6 -> AddEntry(selproton2_mom_CCNPionNProton_PID_300, "CCNPN#pi", "f");
  ...
  TH1 *last6 = (TH1*)selproton2_mom_PID_300->GetStack()->Last();
  ...
  c6->Update();
  c6->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/selproton2_mom_topo_PID_300.pdf");
  ...
  THStack *cangle_p1p2_PID_300 = new THStack("angle_p1p2_PID_300","");
  ...
  l7 -> SetNColumns(2);
  l7 -> AddEntry(angle_p1p2_CC0Pion0Proton_PID_300, "CC0P0#pi", "f");
  l7 -> AddEntry(angle_p1p2_CCNue_PID_300, "CC#nu_{e}", "f");
  l7 -> AddEntry(angle_p1p2_CC0Pion1Proton_PID_300, "CC1P0#pi", "f");
  l7 -> AddEntry(angle_p1p2_NC_PID_300, "NC", "f");
  l7 -> AddEntry(angle_p1p2_CC0Pion2Proton_PID_300, "CC2P0#pi", "f");
  l7 -> AddEntry(angle_p1p2_OOFV_PID_300, "OOFV", "f");
  l7 -> AddEntry(angle_p1p2_CC0PionNProton_PID_300, "CCNP0#pi", "f");
  l7 -> AddEntry(angle_p1p2_EXT_PID_300, "cosmic", "f");
  l7 -> AddEntry(angle_p1p2_CC1PionNProton_PID_300, "CCNP1#pi", "f");
  l7 -> AddEntry(angle_p1p2_OffBeam_PID, "off-beam data", "f");
  l7 -> AddEntry(angle_p1p2_CCNPionNProton_PID_300, "CCNPN#pi", "f");
  ...
  TH1 *last7 = (TH1*)angle_p1p2_PID_300->GetStack()->Last();
  ...
  c7->Update();
  c7->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/cosangle_p1p2_topo_PID_300.pdf");
  */
  //////////////// *** nuevos histos
  ...
  reco_Enu_CCQE_PID_300-> SetFillColor(kRed -10);
  reco_Enu_CCRes_PID_300-> SetFillColor(kGreen-8);
  reco_Enu_CCCoh_PID_300-> SetFillColor(kAzure+4);
  reco_Enu_CCDIS_PID_300-> SetFillColor(kRed-9);
  reco_Enu_CCMEC_PID_300-> SetFillColor(kOrange);
  reco_Enu_CCNue_PID_300-> SetFillColor(kCyan-8);
  reco_Enu_NC_PID_300-> SetFillColor(31);
  reco_Enu_other_PID_300-> SetFillColor(kOrange+6);
  reco_Enu_OffBeam_PID-> SetFillColor(kGray);

  THStack *reco_Enu_PID_300 = new THStack("reco_Enu_PID_300","");
  reco_Enu_PID_300-> Add(reco_Enu_CCQE_PID_300);
  reco_Enu_PID_300-> Add(reco_Enu_CCRes_PID_300);
  reco_Enu_PID_300-> Add(reco_Enu_CCCoh_PID_300);
  reco_Enu_PID_300-> Add(reco_Enu_CCDIS_PID_300);
  reco_Enu_PID_300-> Add(reco_Enu_CCMEC_PID_300);
  reco_Enu_PID_300-> Add(reco_Enu_CCNue_PID_300);
  reco_Enu_PID_300-> Add(reco_Enu_NC_PID_300);
  reco_Enu_PID_300-> Add(reco_Enu_other_PID_300);
  reco_Enu_PID_300-> Add(reco_Enu_OffBeam_PID);
  reco_Enu_PID_300->SetMaximum(300.);
  reco_Enu_PID_300-> Draw();
  reco_Enu_PID_300->GetXaxis()->SetTitle("No. of Entries");
  ...
  l8 -> SetNColumns(2);
  l8 -> AddEntry(reco_Enu_CCQE_PID_300, "CCQE", "f");
  l8 -> AddEntry(reco_Enu_CCRes_PID_300, "CCRes", "f");
  l8 -> AddEntry(reco_Enu_CCCoh_PID_300, "CCCoh", "f");
  l8 -> AddEntry(reco_Enu_CCDIS_PID_300, "DIS", "f");
  l8 -> AddEntry(reco_Enu_CCMEC_PID_300, "CCMEC", "f");
  l8 -> AddEntry(reco_Enu_CCNue_PID_300, "CC#nu_{e}", "f");
  l8 -> AddEntry(reco_Enu_NC_PID_300, "NC", "f");
  l8 -> AddEntry(reco_Enu_other_PID_300, "other", "f");
  ...
  TH1 *last8 = (TH1*)reco_Enu_PID_300->GetStack()->Last();

  chi2test = Chi2Calc(last8,reco_Enu_OnBeam_PID, reco_Enu_OffBeam_PID, normOffBeam, normMCBNB);
  canvas++;
  outfileDataMC_PID_300<<"canvas: "<<canvas<<"  Enu reco chi2test : "<<chi2test<<std::endl;
  ...
  c8->Update();
  c8->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/EnuReco_topo_PID_300.pdf");
  ...
  reco_PT_CCQE_PID_300-> SetFillColor(kRed -10);
  reco_PT_CCRes_PID_300-> SetFillColor(kGreen-8);
  reco_PT_CCCoh_PID_300-> SetFillColor(kAzure+4);
  reco_PT_CCDIS_PID_300-> SetFillColor(kRed-9);
  reco_PT_CCMEC_PID_300-> SetFillColor(kOrange);
  reco_PT_CCNue_PID_300-> SetFillColor(kCyan-8);
  reco_PT_NC_PID_300-> SetFillColor(31);
  reco_PT_other_PID_300-> SetFillColor(kOrange+6);
  reco_PT_OffBeam_PID-> SetFillColor(kGray);

  THStack *reco_PT_PID_300 = new THStack("reco_PT_PID_300","");
  reco_PT_PID_300-> Add(reco_PT_CCQE_PID_300);
  reco_PT_PID_300-> Add(reco_PT_CCRes_PID_300);
  reco_PT_PID_300-> Add(reco_PT_CCCoh_PID_300);
  reco_PT_PID_300-> Add(reco_PT_CCDIS_PID_300);
  reco_PT_PID_300-> Add(reco_PT_CCMEC_PID_300);
  reco_PT_PID_300-> Add(reco_PT_CCNue_PID_300);
  reco_PT_PID_300-> Add(reco_PT_NC_PID_300);
  reco_PT_PID_300-> Add(reco_PT_other_PID_300);
  reco_PT_PID_300-> Add(reco_PT_OffBeam_PID);
  //reco_PT_PID_300->SetMaximum(50.);
  reco_PT_PID_300-> Draw();
  reco_PT_PID_300->GetXaxis()->SetTitle("No. of Entries");
  ...
  l9 -> SetNColumns(2);
  l9 -> AddEntry(reco_PT_CCQE_PID_300, "CCQE", "f");
  l9 -> AddEntry(reco_PT_CCRes_PID_300, "CCRes", "f");
  l9 -> AddEntry(reco_PT_CCCoh_PID_300, "CCCoh", "f");
  l9 -> AddEntry(reco_PT_CCDIS_PID_300, "DIS", "f");
  l9 -> AddEntry(reco_PT_CCMEC_PID_300, "CCMEC", "f");
  l9 -> AddEntry(reco_PT_CCNue_PID_300, "CC#nu_{e}", "f");
  l9 -> AddEntry(reco_PT_NC_PID_300, "NC", "f");
  l9 -> AddEntry(reco_PT_other_PID_300, "other", "f");
  ...
  TH1 *last9 = (TH1*)reco_PT_PID_300->GetStack()->Last();

  chi2test = Chi2Calc(last9,reco_PT_OnBeam_PID, reco_PT_OffBeam_PID, normOffBeam, normMCBNB);
  canvas++;
  outfileDataMC_PID_300<<"canvas: "<<canvas<<"  PT reco chi2test : "<<chi2test<<std::endl;
  ...
  c9->Update();
  c9->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/PTReco_topo_PID_300.pdf");
  ...
  reco_pn_CCQE_PID_300-> SetFillColor(kRed -10);
  reco_pn_CCRes_PID_300-> SetFillColor(kGreen-8);
  reco_pn_CCCoh_PID_300-> SetFillColor(kAzure+4);
  reco_pn_CCDIS_PID_300-> SetFillColor(kRed-9);
  reco_pn_CCMEC_PID_300-> SetFillColor(kOrange);
  reco_pn_CCNue_PID_300-> SetFillColor(kCyan-8);
  reco_pn_NC_PID_300-> SetFillColor(31);
  reco_pn_other_PID_300-> SetFillColor(kOrange+6);
  reco_pn_OffBeam_PID-> SetFillColor(kGray);

  THStack *reco_pn_PID_300 = new THStack("reco_pn_PID_300","");
  reco_pn_PID_300-> Add(reco_pn_CCQE_PID_300);
  reco_pn_PID_300-> Add(reco_pn_CCRes_PID_300);
  reco_pn_PID_300-> Add(reco_pn_CCCoh_PID_300);
  reco_pn_PID_300-> Add(reco_pn_CCDIS_PID_300);
  reco_pn_PID_300-> Add(reco_pn_CCMEC_PID_300);
  reco_pn_PID_300-> Add(reco_pn_CCNue_PID_300);
  reco_pn_PID_300-> Add(reco_pn_NC_PID_300);
  reco_pn_PID_300-> Add(reco_pn_other_PID_300);
  reco_pn_PID_300-> Add(reco_pn_OffBeam_PID);
  reco_pn_PID_300->SetMaximum(300.);
  reco_pn_PID_300-> Draw();
  reco_pn_PID_300->GetXaxis()->SetTitle("No. of Entries");
  ...
  l10 -> SetNColumns(2);
  l10 -> AddEntry(reco_pn_CCQE_PID_300, "CCQE", "f");
  l10 -> AddEntry(reco_pn_CCRes_PID_300, "CCRes", "f");
  l10 -> AddEntry(reco_pn_CCCoh_PID_300, "CCCoh", "f");
  l10 -> AddEntry(reco_pn_CCDIS_PID_300, "DIS", "f");
  l10 -> AddEntry(reco_pn_CCMEC_PID_300, "CCMEC", "f");
  l10 -> AddEntry(reco_pn_CCNue_PID_300, "CC#nu_{e}", "f");
  l10 -> AddEntry(reco_pn_NC_PID_300, "NC", "f");
  l10 -> AddEntry(reco_pn_other_PID_300, "other", "f");
  ...
  TH1 *last10 = (TH1*)reco_pn_PID_300->GetStack()->Last();

  chi2test = Chi2Calc(last10,reco_pn_OnBeam_PID, reco_pn_OffBeam_PID, normOffBeam, normMCBNB);
  canvas++;
  outfileDataMC_PID_300<<"canvas: "<<canvas<<"  pn reco chi2test : "<<chi2test<<std::endl;
  ...
  c10->Update();
  c10->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/pnReco_topo_PID_300.pdf");
  ...
  reco_angle_p1p2_CCQE_PID_300_LF-> SetFillColor(kRed -10);
  reco_angle_p1p2_CCRes_PID_300_LF-> SetFillColor(kGreen-8);
  reco_angle_p1p2_CCCoh_PID_300_LF-> SetFillColor(kAzure+4);
  reco_angle_p1p2_CCDIS_PID_300_LF-> SetFillColor(kRed-9);
  reco_angle_p1p2_CCMEC_PID_300_LF-> SetFillColor(kOrange);
  reco_angle_p1p2_CCNue_PID_300_LF-> SetFillColor(kCyan-8);
  reco_angle_p1p2_NC_PID_300_LF-> SetFillColor(31);
  reco_angle_p1p2_other_PID_300_LF-> SetFillColor(kOrange+6);
  reco_angle_p1p2_OffBeam_PID_LF-> SetFillColor(kGray);

  THStack *reco_angle_p1p2_PID_300_LF = new THStack("reco_angle_p1p2_PID_300_LF","");
  reco_angle_p1p2_PID_300_LF-> Add(reco_angle_p1p2_CCQE_PID_300_LF);
  reco_angle_p1p2_PID_300_LF-> Add(reco_angle_p1p2_CCRes_PID_300_LF);
  reco_angle_p1p2_PID_300_LF-> Add(reco_angle_p1p2_CCCoh_PID_300_LF);
  reco_angle_p1p2_PID_300_LF-> Add(reco_angle_p1p2_CCDIS_PID_300_LF);
  reco_angle_p1p2_PID_300_LF-> Add(reco_angle_p1p2_CCMEC_PID_300_LF);
  reco_angle_p1p2_PID_300_LF-> Add(reco_angle_p1p2_CCNue_PID_300_LF);
  reco_angle_p1p2_PID_300_LF-> Add(reco_angle_p1p2_NC_PID_300_LF);
  reco_angle_p1p2_PID_300_LF-> Add(reco_angle_p1p2_other_PID_300_LF);
  reco_angle_p1p2_PID_300_LF-> Add(reco_angle_p1p2_OffBeam_PID_LF);
  reco_angle_p1p2_PID_300_LF->SetMaximum(200.);
  reco_angle_p1p2_PID_300_LF-> Draw();
  reco_angle_p1p2_PID_300_LF->GetXaxis()->SetTitle("No. of Entries");
  ...
  l11 -> SetNColumns(2);
  l11 -> AddEntry(reco_angle_p1p2_CCQE_PID_300_LF, "CCQE", "f");
  l11 -> AddEntry(reco_angle_p1p2_CCRes_PID_300_LF, "CCRes", "f");
  l11 -> AddEntry(reco_angle_p1p2_CCCoh_PID_300_LF, "CCCoh", "f");
  l11 -> AddEntry(reco_angle_p1p2_CCDIS_PID_300_LF, "DIS", "f");
  l11 -> AddEntry(reco_angle_p1p2_CCMEC_PID_300_LF, "CCMEC", "f");
  l11 -> AddEntry(reco_angle_p1p2_CCNue_PID_300_LF, "CC#nu_{e}", "f");
  l11 -> AddEntry(reco_angle_p1p2_NC_PID_300_LF, "NC", "f");
  l11 -> AddEntry(reco_angle_p1p2_other_PID_300_LF, "other", "f");
  ...
  TH1 *last11 = (TH1*)reco_angle_p1p2_PID_300_LF->GetStack()->Last();

  chi2test = Chi2Calc(last11,reco_angle_p1p2_OnBeam_PID_LF, reco_angle_p1p2_OffBeam_PID_LF, normOffBeam, normMCBNB);
  canvas++;
  outfileDataMC_PID_300<<"canvas: "<<canvas<<"  cosangle LF reco chi2test : "<<chi2test<<std::endl;
  ...
  c11->Update();
  c11->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/cosanglep1p2RecoLF_topo_PID_300.pdf");
  ...
  reco_angle_p1p2_CCQE_PID_300_CM-> SetFillColor(kRed -10);
  reco_angle_p1p2_CCRes_PID_300_CM-> SetFillColor(kGreen-8);
  reco_angle_p1p2_CCCoh_PID_300_CM-> SetFillColor(kAzure+4);
  reco_angle_p1p2_CCDIS_PID_300_CM-> SetFillColor(kRed-9);
  reco_angle_p1p2_CCMEC_PID_300_CM-> SetFillColor(kOrange);
  reco_angle_p1p2_CCNue_PID_300_CM-> SetFillColor(kCyan-8);
  reco_angle_p1p2_NC_PID_300_CM-> SetFillColor(31);
  reco_angle_p1p2_other_PID_300_CM-> SetFillColor(kOrange+6);
  reco_angle_p1p2_OffBeam_PID_CM-> SetFillColor(kGray);

  THStack *reco_angle_p1p2_PID_300_CM = new THStack("reco_angle_p1p2_PID_300_CM","");
  reco_angle_p1p2_PID_300_CM-> Add(reco_angle_p1p2_CCQE_PID_300_CM);
  reco_angle_p1p2_PID_300_CM-> Add(reco_angle_p1p2_CCRes_PID_300_CM);
  reco_angle_p1p2_PID_300_CM-> Add(reco_angle_p1p2_CCCoh_PID_300_CM);
  reco_angle_p1p2_PID_300_CM-> Add(reco_angle_p1p2_CCDIS_PID_300_CM);
  reco_angle_p1p2_PID_300_CM-> Add(reco_angle_p1p2_CCMEC_PID_300_CM);
  reco_angle_p1p2_PID_300_CM-> Add(reco_angle_p1p2_CCNue_PID_300_CM);
  reco_angle_p1p2_PID_300_CM-> Add(reco_angle_p1p2_NC_PID_300_CM);
  reco_angle_p1p2_PID_300_CM-> Add(reco_angle_p1p2_other_PID_300_CM);
  reco_angle_p1p2_PID_300_CM-> Add(reco_angle_p1p2_OffBeam_PID_CM);
  //reco_angle_p1p2_PID_300_CM->SetMaximum(50.);
  reco_angle_p1p2_PID_300_CM-> Draw();
  reco_angle_p1p2_PID_300_CM->GetXaxis()->SetTitle("No. of Entries");
  ...
  l12 -> SetNColumns(2);
  l12 -> AddEntry(reco_angle_p1p2_CCQE_PID_300_CM, "CCQE", "f");
  l12 -> AddEntry(reco_angle_p1p2_CCRes_PID_300_CM, "CCRes", "f");
  l12 -> AddEntry(reco_angle_p1p2_CCCoh_PID_300_CM, "CCCoh", "f");
  l12 -> AddEntry(reco_angle_p1p2_CCDIS_PID_300_CM, "DIS", "f");
  l12 -> AddEntry(reco_angle_p1p2_CCMEC_PID_300_CM, "CCMEC", "f");
  l12 -> AddEntry(reco_angle_p1p2_CCNue_PID_300_CM, "CC#nu_{e}", "f");
  l12 -> AddEntry(reco_angle_p1p2_NC_PID_300_CM, "NC", "f");
  l12 -> AddEntry(reco_angle_p1p2_other_PID_300_CM, "other", "f");
  ...
  TH1 *last12 = (TH1*)reco_angle_p1p2_PID_300_CM->GetStack()->Last();

  chi2test = Chi2Calc(last12,reco_angle_p1p2_OnBeam_PID_CM, reco_angle_p1p2_OffBeam_PID_CM, normOffBeam, normMCBNB);
  canvas++;
  outfileDataMC_PID_300<<"canvas: "<<canvas<<"  cosangle CM reco chi2test : "<<chi2test<<std::endl;
  ...
  c12->Update();
  c12->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/cosanglep1p2RecoCM_topo_PID_300.pdf");
  ...
  c13->Update();
  c13-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/reco_angle_p1p2_p2_OnBeam_PID_LF.pdf");
  ...
  c14->Update();
  c14-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/reco_angle_p1p2_OnBeam_PID_LF_CM.pdf");
  ...
  c15->Update();
  c15-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/p1p2_OnBeam_PID.pdf");

  TCanvas *c16 = new TCanvas("c16", "c16", 900, 900);
  gStyle->SetOptStat(kFALSE);

  res_Enu_PID_300->GetXaxis()->SetTitle("Truth E_{#nu} [GeV]");
  res_Enu_PID_300->GetYaxis()->SetTitle("(Truth-Reco) E_{#nu} [GeV]");
  //res_Enu_PID_300->SetMaximum(400.);
  res_Enu_PID_300->Draw("colz");

  c16->Update();
  c16-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/res_Enu_PID_300.pdf");
  /////////////////
  ...
  reco_angle_p1p2_CCQE_PID_300_LF_btb-> SetFillColor(kRed -10);
  reco_angle_p1p2_CCRes_PID_300_LF_btb-> SetFillColor(kGreen-8);
  reco_angle_p1p2_CCCoh_PID_300_LF_btb-> SetFillColor(kAzure+4);
  reco_angle_p1p2_CCDIS_PID_300_LF_btb-> SetFillColor(kRed-9);
  reco_angle_p1p2_CCMEC_PID_300_LF_btb-> SetFillColor(kOrange);
  reco_angle_p1p2_CCNue_PID_300_LF_btb-> SetFillColor(kCyan-8);
  reco_angle_p1p2_NC_PID_300_LF_btb-> SetFillColor(31);
  reco_angle_p1p2_other_PID_300_LF_btb-> SetFillColor(kOrange+6);
  reco_angle_p1p2_OffBeam_PID_LF_btb-> SetFillColor(kGray);

  THStack *reco_angle_p1p2_PID_300_LF_btb = new THStack("reco_angle_p1p2_PID_300_LF_btb","");
  reco_angle_p1p2_PID_300_LF_btb-> Add(reco_angle_p1p2_CCQE_PID_300_LF_btb);
  reco_angle_p1p2_PID_300_LF_btb-> Add(reco_angle_p1p2_CCRes_PID_300_LF_btb);
  reco_angle_p1p2_PID_300_LF_btb-> Add(reco_angle_p1p2_CCCoh_PID_300_LF_btb);
  reco_angle_p1p2_PID_300_LF_btb-> Add(reco_angle_p1p2_CCDIS_PID_300_LF_btb);
  reco_angle_p1p2_PID_300_LF_btb-> Add(reco_angle_p1p2_CCMEC_PID_300_LF_btb);
  reco_angle_p1p2_PID_300_LF_btb-> Add(reco_angle_p1p2_CCNue_PID_300_LF_btb);
  reco_angle_p1p2_PID_300_LF_btb-> Add(reco_angle_p1p2_NC_PID_300_LF_btb);
  reco_angle_p1p2_PID_300_LF_btb-> Add(reco_angle_p1p2_other_PID_300_LF_btb);
  reco_angle_p1p2_PID_300_LF_btb-> Add(reco_angle_p1p2_OffBeam_PID_LF_btb);
  reco_angle_p1p2_PID_300_LF_btb->SetMaximum(30.);
  reco_angle_p1p2_PID_300_LF_btb-> Draw();
  reco_angle_p1p2_PID_300_LF_btb->GetXaxis()->SetTitle("No. of Entries");
  ...
  l17 -> SetNColumns(2);
  l17 -> AddEntry(reco_angle_p1p2_CCQE_PID_300_LF_btb, "CCQE", "f");
  l17 -> AddEntry(reco_angle_p1p2_CCRes_PID_300_LF_btb, "CCRes", "f");
  l17 -> AddEntry(reco_angle_p1p2_CCCoh_PID_300_LF_btb, "CCCoh", "f");
  l17 -> AddEntry(reco_angle_p1p2_CCDIS_PID_300_LF_btb, "DIS", "f");
  l17 -> AddEntry(reco_angle_p1p2_CCMEC_PID_300_LF_btb, "CCMEC", "f");
  l17 -> AddEntry(reco_angle_p1p2_CCNue_PID_300_LF_btb, "CC#nu_{e}", "f");
  l17 -> AddEntry(reco_angle_p1p2_NC_PID_300_LF_btb, "NC", "f");
  l17 -> AddEntry(reco_angle_p1p2_other_PID_300_LF_btb, "other", "f");
  ...
  TH1 *last17 = (TH1*)reco_angle_p1p2_PID_300_LF_btb->GetStack()->Last();

  chi2test = Chi2Calc(last17,reco_angle_p1p2_OnBeam_PID_LF_btb, reco_angle_p1p2_OffBeam_PID_LF_btb, normOffBeam, normMCBNB);
  canvas++;
  outfileDataMC_PID_300<<"canvas: "<<canvas<<"  cosangle LF reco chi2test btb : "<<chi2test<<std::endl;
  ...
  c17->Update();
  c17->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/cosanglep1p2RecoLF_topo_PID_300_btb.pdf");
  ...
  reco_angle_p1p2_CCQE_PID_300_CM_btb-> SetFillColor(kRed -10);
  reco_angle_p1p2_CCRes_PID_300_CM_btb-> SetFillColor(kGreen-8);
  reco_angle_p1p2_CCCoh_PID_300_CM_btb-> SetFillColor(kAzure+4);
  reco_angle_p1p2_CCDIS_PID_300_CM_btb-> SetFillColor(kRed-9);
  reco_angle_p1p2_CCMEC_PID_300_CM_btb-> SetFillColor(kOrange);
  reco_angle_p1p2_CCNue_PID_300_CM_btb-> SetFillColor(kCyan-8);
  reco_angle_p1p2_NC_PID_300_CM_btb-> SetFillColor(31);
  reco_angle_p1p2_other_PID_300_CM_btb-> SetFillColor(kOrange+6);
  reco_angle_p1p2_OffBeam_PID_CM_btb-> SetFillColor(kGray);

  THStack *reco_angle_p1p2_PID_300_CM_btb = new THStack("reco_angle_p1p2_PID_300_CM_btb","");
  reco_angle_p1p2_PID_300_CM_btb-> Add(reco_angle_p1p2_CCQE_PID_300_CM_btb);
  reco_angle_p1p2_PID_300_CM_btb-> Add(reco_angle_p1p2_CCRes_PID_300_CM_btb);
  reco_angle_p1p2_PID_300_CM_btb-> Add(reco_angle_p1p2_CCCoh_PID_300_CM_btb);
  reco_angle_p1p2_PID_300_CM_btb-> Add(reco_angle_p1p2_CCDIS_PID_300_CM_btb);
  reco_angle_p1p2_PID_300_CM_btb-> Add(reco_angle_p1p2_CCMEC_PID_300_CM_btb);
  reco_angle_p1p2_PID_300_CM_btb-> Add(reco_angle_p1p2_CCNue_PID_300_CM_btb);
  reco_angle_p1p2_PID_300_CM_btb-> Add(reco_angle_p1p2_NC_PID_300_CM_btb);
  reco_angle_p1p2_PID_300_CM_btb-> Add(reco_angle_p1p2_other_PID_300_CM_btb);
  reco_angle_p1p2_PID_300_CM_btb-> Add(reco_angle_p1p2_OffBeam_PID_CM_btb);
  //reco_angle_p1p2_PID_300_CM_btb->SetMaximum(50.);
  reco_angle_p1p2_PID_300_CM_btb-> Draw();
  reco_angle_p1p2_PID_300_CM_btb->GetXaxis()->SetTitle("No. of Entries");
  ...
  l18 -> SetNColumns(2);
  l18 -> AddEntry(reco_angle_p1p2_CCQE_PID_300_CM_btb, "CCQE", "f");
  l18 -> AddEntry(reco_angle_p1p2_CCRes_PID_300_CM_btb, "CCRes", "f");
  l18 -> AddEntry(reco_angle_p1p2_CCCoh_PID_300_CM_btb, "CCCoh", "f");
  l18 -> AddEntry(reco_angle_p1p2_CCDIS_PID_300_CM_btb, "DIS", "f");
  l18 -> AddEntry(reco_angle_p1p2_CCMEC_PID_300_CM_btb, "CCMEC", "f");
  l18 -> AddEntry(reco_angle_p1p2_CCNue_PID_300_CM_btb, "CC#nu_{e}", "f");
  l18 -> AddEntry(reco_angle_p1p2_NC_PID_300_CM_btb, "NC", "f");
  l18 -> AddEntry(reco_angle_p1p2_other_PID_300_CM_btb, "other", "f");
  ...
  TH1 *last18 = (TH1*)reco_angle_p1p2_PID_300_CM_btb->GetStack()->Last();

  chi2test = Chi2Calc(last18,reco_angle_p1p2_OnBeam_PID_CM_btb, reco_angle_p1p2_OffBeam_PID_CM_btb, normOffBeam, normMCBNB);
  canvas++;
  outfileDataMC_PID_300<<"canvas: "<<canvas<<"  cosangle CM reco chi2test btb : "<<chi2test<<std::endl;
  ...
  c18->Update();
  c18->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/cosanglep1p2RecoCM_topo_PID_300_btb.pdf");
  ...
  c19->Update();
  c19-> Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/reco_angle_p1p2_p2_OnBeam_PID_LF_btb.pdf");
  ...
  reco_angle_p1p2_CCQE_PID_300_LF_zoom-> SetFillColor(kRed -10);
  reco_angle_p1p2_CCRes_PID_300_LF_zoom-> SetFillColor(kGreen-8);
  reco_angle_p1p2_CCCoh_PID_300_LF_zoom-> SetFillColor(kAzure+4);
  reco_angle_p1p2_CCDIS_PID_300_LF_zoom-> SetFillColor(kRed-9);
  reco_angle_p1p2_CCMEC_PID_300_LF_zoom-> SetFillColor(kOrange);
  reco_angle_p1p2_CCNue_PID_300_LF_zoom-> SetFillColor(kCyan-8);
  reco_angle_p1p2_NC_PID_300_LF_zoom-> SetFillColor(31);
  reco_angle_p1p2_other_PID_300_LF_zoom-> SetFillColor(kOrange+6);
  reco_angle_p1p2_OffBeam_PID_LF_zoom-> SetFillColor(kGray);

  THStack *reco_angle_p1p2_PID_300_LF_zoom = new THStack("reco_angle_p1p2_PID_300_LF_zoom","");
  reco_angle_p1p2_PID_300_LF_zoom-> Add(reco_angle_p1p2_CCQE_PID_300_LF_zoom);
  reco_angle_p1p2_PID_300_LF_zoom-> Add(reco_angle_p1p2_CCRes_PID_300_LF_zoom);
  reco_angle_p1p2_PID_300_LF_zoom-> Add(reco_angle_p1p2_CCCoh_PID_300_LF_zoom);
  reco_angle_p1p2_PID_300_LF_zoom-> Add(reco_angle_p1p2_CCDIS_PID_300_LF_zoom);
  reco_angle_p1p2_PID_300_LF_zoom-> Add(reco_angle_p1p2_CCMEC_PID_300_LF_zoom);
  reco_angle_p1p2_PID_300_LF_zoom-> Add(reco_angle_p1p2_CCNue_PID_300_LF_zoom);
  reco_angle_p1p2_PID_300_LF_zoom-> Add(reco_angle_p1p2_NC_PID_300_LF_zoom);
  reco_angle_p1p2_PID_300_LF_zoom-> Add(reco_angle_p1p2_other_PID_300_LF_zoom);
  reco_angle_p1p2_PID_300_LF_zoom-> Add(reco_angle_p1p2_OffBeam_PID_LF_zoom);
  //reco_angle_p1p2_PID_300_LF_zoom->SetMaximum(50.);
  reco_angle_p1p2_PID_300_LF_zoom-> Draw();
  reco_angle_p1p2_PID_300_LF_zoom->GetXaxis()->SetTitle("No. of Entries");
  ...
  l20 -> SetNColumns(2);
  l20 -> AddEntry(reco_angle_p1p2_CCQE_PID_300_LF_zoom, "CCQE", "f");
  l20 -> AddEntry(reco_angle_p1p2_CCRes_PID_300_LF_zoom, "CCRes", "f");
  l20 -> AddEntry(reco_angle_p1p2_CCCoh_PID_300_LF_zoom, "CCCoh", "f");
  l20 -> AddEntry(reco_angle_p1p2_CCDIS_PID_300_LF_zoom, "DIS", "f");
  l20 -> AddEntry(reco_angle_p1p2_CCMEC_PID_300_LF_zoom, "CCMEC", "f");
  l20 -> AddEntry(reco_angle_p1p2_CCNue_PID_300_LF_zoom, "CC#nu_{e}", "f");
  l20 -> AddEntry(reco_angle_p1p2_NC_PID_300_LF_zoom, "NC", "f");
  l20 -> AddEntry(reco_angle_p1p2_other_PID_300_LF_zoom, "other", "f");
  ...
  TH1 *last20 = (TH1*)reco_angle_p1p2_PID_300_LF_zoom->GetStack()->Last();

  chi2test = Chi2Calc(last20,reco_angle_p1p2_OnBeam_PID_LF_zoom, reco_angle_p1p2_OffBeam_PID_LF_zoom, normOffBeam, normMCBNB);
  canvas++;
  outfileDataMC_PID_300<<"canvas: "<<canvas<<"  cosangle LF reco chi2test zoom : "<<chi2test<<std::endl;
  ...
  c20->Update();
  c20->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/cosanglep1p2RecoLF_topo_PID_300_zoom.pdf");
  ...
  reco_angle_p1p2_CCQE_PID_300_CM_zoom-> SetFillColor(kRed -10);
  reco_angle_p1p2_CCRes_PID_300_CM_zoom-> SetFillColor(kGreen-8);
  reco_angle_p1p2_CCCoh_PID_300_CM_zoom-> SetFillColor(kAzure+4);
  reco_angle_p1p2_CCDIS_PID_300_CM_zoom-> SetFillColor(kRed-9);
  reco_angle_p1p2_CCMEC_PID_300_CM_zoom-> SetFillColor(kOrange);
  reco_angle_p1p2_CCNue_PID_300_CM_zoom-> SetFillColor(kCyan-8);
  reco_angle_p1p2_NC_PID_300_CM_zoom-> SetFillColor(31);
  reco_angle_p1p2_other_PID_300_CM_zoom-> SetFillColor(kOrange+6);
  reco_angle_p1p2_OffBeam_PID_CM_zoom-> SetFillColor(kGray);

  THStack *reco_angle_p1p2_PID_300_CM_zoom = new THStack("reco_angle_p1p2_PID_300_CM_zoom","");
  reco_angle_p1p2_PID_300_CM_zoom-> Add(reco_angle_p1p2_CCQE_PID_300_CM_zoom);
  reco_angle_p1p2_PID_300_CM_zoom-> Add(reco_angle_p1p2_CCRes_PID_300_CM_zoom);
  reco_angle_p1p2_PID_300_CM_zoom-> Add(reco_angle_p1p2_CCCoh_PID_300_CM_zoom);
  reco_angle_p1p2_PID_300_CM_zoom-> Add(reco_angle_p1p2_CCDIS_PID_300_CM_zoom);
  reco_angle_p1p2_PID_300_CM_zoom-> Add(reco_angle_p1p2_CCMEC_PID_300_CM_zoom);
  reco_angle_p1p2_PID_300_CM_zoom-> Add(reco_angle_p1p2_CCNue_PID_300_CM_zoom);
  reco_angle_p1p2_PID_300_CM_zoom-> Add(reco_angle_p1p2_NC_PID_300_CM_zoom);
  reco_angle_p1p2_PID_300_CM_zoom-> Add(reco_angle_p1p2_other_PID_300_CM_zoom);
  reco_angle_p1p2_PID_300_CM_zoom-> Add(reco_angle_p1p2_OffBeam_PID_CM_zoom);
  //reco_angle_p1p2_PID_300_CM_zoom->SetMaximum(50.);
  reco_angle_p1p2_PID_300_CM_zoom-> Draw();
  reco_angle_p1p2_PID_300_CM_zoom->GetXaxis()->SetTitle("No. of Entries");
  ...
  l21 -> SetNColumns(2);
  l21 -> AddEntry(reco_angle_p1p2_CCQE_PID_300_CM_zoom, "CCQE", "f");
  l21 -> AddEntry(reco_angle_p1p2_CCRes_PID_300_CM_zoom, "CCRes", "f");
  l21 -> AddEntry(reco_angle_p1p2_CCCoh_PID_300_CM_zoom, "CCCoh", "f");
  l21 -> AddEntry(reco_angle_p1p2_CCDIS_PID_300_CM_zoom, "DIS", "f");
  l21 -> AddEntry(reco_angle_p1p2_CCMEC_PID_300_CM_zoom, "CCMEC", "f");
  l21 -> AddEntry(reco_angle_p1p2_CCNue_PID_300_CM_zoom, "CC#nu_{e}", "f");
  l21 -> AddEntry(reco_angle_p1p2_NC_PID_300_CM_zoom, "NC", "f");
  l21 -> AddEntry(reco_angle_p1p2_other_PID_300_CM_zoom, "other", "f");
  ...
  TH1 *last21 = (TH1*)reco_angle_p1p2_PID_300_CM_zoom->GetStack()->Last();
  ...
  c21->Update();
  c21->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/cosanglep1p2RecoCM_topo_PID_300_zoom.pdf");
  ...
  reco_angle_p1p2_CCQE_PID_300_LF_btb_zoom-> SetFillColor(kRed -10);
  reco_angle_p1p2_CCRes_PID_300_LF_btb_zoom-> SetFillColor(kGreen-8);
  reco_angle_p1p2_CCCoh_PID_300_LF_btb_zoom-> SetFillColor(kAzure+4);
  reco_angle_p1p2_CCDIS_PID_300_LF_btb_zoom-> SetFillColor(kRed-9);
  reco_angle_p1p2_CCMEC_PID_300_LF_btb_zoom-> SetFillColor(kOrange);
  reco_angle_p1p2_CCNue_PID_300_LF_btb_zoom-> SetFillColor(kCyan-8);
  reco_angle_p1p2_NC_PID_300_LF_btb_zoom-> SetFillColor(31);
  reco_angle_p1p2_other_PID_300_LF_btb_zoom-> SetFillColor(kOrange+6);
  reco_angle_p1p2_OffBeam_PID_LF_btb_zoom-> SetFillColor(kGray);

  THStack *reco_angle_p1p2_PID_300_LF_btb_zoom = new THStack("reco_angle_p1p2_PID_300_LF_btb_zoom","");
  reco_angle_p1p2_PID_300_LF_btb_zoom-> Add(reco_angle_p1p2_CCQE_PID_300_LF_btb_zoom);
  reco_angle_p1p2_PID_300_LF_btb_zoom-> Add(reco_angle_p1p2_CCRes_PID_300_LF_btb_zoom);
  reco_angle_p1p2_PID_300_LF_btb_zoom-> Add(reco_angle_p1p2_CCCoh_PID_300_LF_btb_zoom);
  reco_angle_p1p2_PID_300_LF_btb_zoom-> Add(reco_angle_p1p2_CCDIS_PID_300_LF_btb_zoom);
  reco_angle_p1p2_PID_300_LF_btb_zoom-> Add(reco_angle_p1p2_CCMEC_PID_300_LF_btb_zoom);
  reco_angle_p1p2_PID_300_LF_btb_zoom-> Add(reco_angle_p1p2_CCNue_PID_300_LF_btb_zoom);
  reco_angle_p1p2_PID_300_LF_btb_zoom-> Add(reco_angle_p1p2_NC_PID_300_LF_btb_zoom);
  reco_angle_p1p2_PID_300_LF_btb_zoom-> Add(reco_angle_p1p2_other_PID_300_LF_btb_zoom);
  reco_angle_p1p2_PID_300_LF_btb_zoom-> Add(reco_angle_p1p2_OffBeam_PID_LF_btb_zoom);
  reco_angle_p1p2_PID_300_LF_btb_zoom->SetMaximum(20.);
  reco_angle_p1p2_PID_300_LF_btb_zoom-> Draw();
  reco_angle_p1p2_PID_300_LF_btb_zoom->GetXaxis()->SetTitle("No. of Entries");
  ...
  l22 -> SetNColumns(2);
  l22 -> AddEntry(reco_angle_p1p2_CCQE_PID_300_LF_btb_zoom, "CCQE", "f");
  l22 -> AddEntry(reco_angle_p1p2_CCRes_PID_300_LF_btb_zoom, "CCRes", "f");
  l22 -> AddEntry(reco_angle_p1p2_CCCoh_PID_300_LF_btb_zoom, "CCCoh", "f");
  l22 -> AddEntry(reco_angle_p1p2_CCDIS_PID_300_LF_btb_zoom, "DIS", "f");
  l22 -> AddEntry(reco_angle_p1p2_CCMEC_PID_300_LF_btb_zoom, "CCMEC", "f");
  l22 -> AddEntry(reco_angle_p1p2_CCNue_PID_300_LF_btb_zoom, "CC#nu_{e}", "f");
  l22 -> AddEntry(reco_angle_p1p2_NC_PID_300_LF_btb_zoom, "NC", "f");
  l22 -> AddEntry(reco_angle_p1p2_other_PID_300_LF_btb_zoom, "other", "f");
  ...
  TH1 *last22 = (TH1*)reco_angle_p1p2_PID_300_LF_btb_zoom->GetStack()->Last();
  ...
  c22->Update();
  c22->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/cosanglep1p2RecoLF_topo_PID_300_btb_zoom.pdf");
  ...
  reco_angle_p1p2_CCQE_PID_300_CM_btb_zoom-> SetFillColor(kRed -10);
  reco_angle_p1p2_CCRes_PID_300_CM_btb_zoom-> SetFillColor(kGreen-8);
  reco_angle_p1p2_CCCoh_PID_300_CM_btb_zoom-> SetFillColor(kAzure+4);
  reco_angle_p1p2_CCDIS_PID_300_CM_btb_zoom-> SetFillColor(kRed-9);
  reco_angle_p1p2_CCMEC_PID_300_CM_btb_zoom-> SetFillColor(kOrange);
  reco_angle_p1p2_CCNue_PID_300_CM_btb_zoom-> SetFillColor(kCyan-8);
  reco_angle_p1p2_NC_PID_300_CM_btb_zoom-> SetFillColor(31);
  reco_angle_p1p2_other_PID_300_CM_btb_zoom-> SetFillColor(kOrange+6);
  reco_angle_p1p2_OffBeam_PID_CM_btb_zoom-> SetFillColor(kGray);

  THStack *reco_angle_p1p2_PID_300_CM_btb_zoom = new THStack("reco_angle_p1p2_PID_300_CM_btb_zoom","");
  reco_angle_p1p2_PID_300_CM_btb_zoom-> Add(reco_angle_p1p2_CCQE_PID_300_CM_btb_zoom);
  reco_angle_p1p2_PID_300_CM_btb_zoom-> Add(reco_angle_p1p2_CCRes_PID_300_CM_btb_zoom);
  reco_angle_p1p2_PID_300_CM_btb_zoom-> Add(reco_angle_p1p2_CCCoh_PID_300_CM_btb_zoom);
  reco_angle_p1p2_PID_300_CM_btb_zoom-> Add(reco_angle_p1p2_CCDIS_PID_300_CM_btb_zoom);
  reco_angle_p1p2_PID_300_CM_btb_zoom-> Add(reco_angle_p1p2_CCMEC_PID_300_CM_btb_zoom);
  reco_angle_p1p2_PID_300_CM_btb_zoom-> Add(reco_angle_p1p2_CCNue_PID_300_CM_btb_zoom);
  reco_angle_p1p2_PID_300_CM_btb_zoom-> Add(reco_angle_p1p2_NC_PID_300_CM_btb_zoom);
  reco_angle_p1p2_PID_300_CM_btb_zoom-> Add(reco_angle_p1p2_other_PID_300_CM_btb_zoom);
  reco_angle_p1p2_PID_300_CM_btb_zoom-> Add(reco_angle_p1p2_OffBeam_PID_CM_btb_zoom);
  //reco_angle_p1p2_PID_300_CM_btb_zoom->SetMaximum(50.);
  reco_angle_p1p2_PID_300_CM_btb_zoom-> Draw();
  reco_angle_p1p2_PID_300_CM_btb_zoom->GetXaxis()->SetTitle("No. of Entries");
  ...
  l23 -> SetNColumns(2);
  l23 -> AddEntry(reco_angle_p1p2_CCQE_PID_300_CM_btb_zoom, "CCQE", "f");
  l23 -> AddEntry(reco_angle_p1p2_CCRes_PID_300_CM_btb_zoom, "CCRes", "f");
  l23 -> AddEntry(reco_angle_p1p2_CCCoh_PID_300_CM_btb_zoom, "CCCoh", "f");
  l23 -> AddEntry(reco_angle_p1p2_CCDIS_PID_300_CM_btb_zoom, "DIS", "f");
  l23 -> AddEntry(reco_angle_p1p2_CCMEC_PID_300_CM_btb_zoom, "CCMEC", "f");
  l23 -> AddEntry(reco_angle_p1p2_CCNue_PID_300_CM_btb_zoom, "CC#nu_{e}", "f");
  l23 -> AddEntry(reco_angle_p1p2_NC_PID_300_CM_btb_zoom, "NC", "f");
  l23 -> AddEntry(reco_angle_p1p2_other_PID_300_CM_btb_zoom, "other", "f");
  ...
  TH1 *last23 = (TH1*)reco_angle_p1p2_PID_300_CM_btb_zoom->GetStack()->Last();
  ...
  c23->Update();
  c23->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/cosanglep1p2RecoCM_topo_PID_300_btb_zoom.pdf");
  ...
  reco_PT_CCQE_1binCM_PID_300-> SetFillColor(kRed -10);
  reco_PT_CCRes_1binCM_PID_300-> SetFillColor(kGreen-8);
  reco_PT_CCCoh_1binCM_PID_300-> SetFillColor(kAzure+4);
  reco_PT_CCDIS_1binCM_PID_300-> SetFillColor(kRed-9);
  reco_PT_CCMEC_1binCM_PID_300-> SetFillColor(kOrange);
  reco_PT_CCNue_1binCM_PID_300-> SetFillColor(kCyan-8);
  reco_PT_NC_1binCM_PID_300-> SetFillColor(31);
  reco_PT_other_1binCM_PID_300-> SetFillColor(kOrange+6);
  reco_PT_OffBeam_1binCM_PID-> SetFillColor(kGray);

  THStack *reco_PT_1binCM_PID_300 = new THStack("reco_PT_1binCM_PID_300","");
  reco_PT_1binCM_PID_300-> Add(reco_PT_CCQE_1binCM_PID_300);
  reco_PT_1binCM_PID_300-> Add(reco_PT_CCRes_1binCM_PID_300);
  reco_PT_1binCM_PID_300-> Add(reco_PT_CCCoh_1binCM_PID_300);
  reco_PT_1binCM_PID_300-> Add(reco_PT_CCDIS_1binCM_PID_300);
  reco_PT_1binCM_PID_300-> Add(reco_PT_CCMEC_1binCM_PID_300);
  reco_PT_1binCM_PID_300-> Add(reco_PT_CCNue_1binCM_PID_300);
  reco_PT_1binCM_PID_300-> Add(reco_PT_NC_1binCM_PID_300);
  reco_PT_1binCM_PID_300-> Add(reco_PT_other_1binCM_PID_300);
  reco_PT_1binCM_PID_300-> Add(reco_PT_OffBeam_1binCM_PID);
  //reco_PT_1binCM_PID_300->SetMaximum(50.);
  reco_PT_1binCM_PID_300-> Draw();
  reco_PT_1binCM_PID_300->GetXaxis()->SetTitle("No. of Entries");
  ...
  l24 -> SetNColumns(2);
  l24 -> AddEntry(reco_PT_CCQE_1binCM_PID_300, "CCQE", "f");
  l24 -> AddEntry(reco_PT_CCRes_1binCM_PID_300, "CCRes", "f");
  l24 -> AddEntry(reco_PT_CCCoh_1binCM_PID_300, "CCCoh", "f");
  l24 -> AddEntry(reco_PT_CCDIS_1binCM_PID_300, "DIS", "f");
  l24 -> AddEntry(reco_PT_CCMEC_1binCM_PID_300, "CCMEC", "f");
  l24 -> AddEntry(reco_PT_CCNue_1binCM_PID_300, "CC#nu_{e}", "f");
  l24 -> AddEntry(reco_PT_NC_1binCM_PID_300, "NC", "f");
  l24 -> AddEntry(reco_PT_other_1binCM_PID_300, "other", "f");
  ...
  TH1 *last24 = (TH1*)reco_PT_1binCM_PID_300->GetStack()->Last();

  chi2test = Chi2Calc(last24,reco_PT_OnBeam_1binCM_PID, reco_PT_OffBeam_1binCM_PID, normOffBeam, normMCBNB);
  canvas++;
  outfileDataMC_PID_300<<"canvas: "<<canvas<<"  PT reco 1binCM chi2test : "<<chi2test<<std::endl;
  ...
  c24->Update();
  c24->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/PTReco_topo_1bibCM_PID_300.pdf");
  ...
  reco_p1p2_CCQE_PID_300-> SetFillColor(kRed -10);
  reco_p1p2_CCRes_PID_300-> SetFillColor(kGreen-8);
  reco_p1p2_CCCoh_PID_300-> SetFillColor(kAzure+4);
  reco_p1p2_CCDIS_PID_300-> SetFillColor(kRed-9);
  reco_p1p2_CCMEC_PID_300-> SetFillColor(kOrange);
  reco_p1p2_CCNue_PID_300-> SetFillColor(kCyan-8);
  reco_p1p2_NC_PID_300-> SetFillColor(31);
  reco_p1p2_other_PID_300-> SetFillColor(kOrange+6);
  reco_p1p2_OffBeam_PID-> SetFillColor(kGray);

  THStack *reco_p1p2_PID_300 = new THStack("reco_p1p2_PID_300","");
  reco_p1p2_PID_300-> Add(reco_p1p2_CCQE_PID_300);
  reco_p1p2_PID_300-> Add(reco_p1p2_CCRes_PID_300);
  reco_p1p2_PID_300-> Add(reco_p1p2_CCCoh_PID_300);
  reco_p1p2_PID_300-> Add(reco_p1p2_CCDIS_PID_300);
  reco_p1p2_PID_300-> Add(reco_p1p2_CCMEC_PID_300);
  reco_p1p2_PID_300-> Add(reco_p1p2_CCNue_PID_300);
  reco_p1p2_PID_300-> Add(reco_p1p2_NC_PID_300);
  reco_p1p2_PID_300-> Add(reco_p1p2_other_PID_300);
  reco_p1p2_PID_300-> Add(reco_p1p2_OffBeam_PID);
  //reco_p1p2_PID_300->SetMaximum(50.);
  reco_p1p2_PID_300-> Draw();
  reco_p1p2_PID_300->GetXaxis()->SetTitle("No. of Entries");
  ...
  l25 -> SetNColumns(2);
  l25 -> AddEntry(reco_p1p2_CCQE_PID_300, "CCQE", "f");
  l25 -> AddEntry(reco_p1p2_CCRes_PID_300, "CCRes", "f");
  l25 -> AddEntry(reco_p1p2_CCCoh_PID_300, "CCCoh", "f");
  l25 -> AddEntry(reco_p1p2_CCDIS_PID_300, "DIS", "f");
  l25 -> AddEntry(reco_p1p2_CCMEC_PID_300, "CCMEC", "f");
  l25 -> AddEntry(reco_p1p2_CCNue_PID_300, "CC#nu_{e}", "f");
  l25 -> AddEntry(reco_p1p2_NC_PID_300, "NC", "f");
  l25 -> AddEntry(reco_p1p2_other_PID_300, "other", "f");
  ...
  TH1 *last25 = (TH1*)reco_p1p2_PID_300->GetStack()->Last();

  chi2test = Chi2Calc(last25,reco_p1p2_OnBeam_PID, reco_p1p2_OffBeam_PID, normOffBeam, normMCBNB);
  canvas++;
  outfileDataMC_PID_300<<"canvas: "<<canvas<<"  p1+ p2 reco chi2test : "<<chi2test<<std::endl;
  ...
  c25->Update();
  c25->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/p1p2Reco_topo_PID_300.pdf"); 
  ...
  reco_dp1p2_CCQE_PID_300-> SetFillColor(kRed -10);
  reco_dp1p2_CCRes_PID_300-> SetFillColor(kGreen-8);
  reco_dp1p2_CCCoh_PID_300-> SetFillColor(kAzure+4);
  reco_dp1p2_CCDIS_PID_300-> SetFillColor(kRed-9);
  reco_dp1p2_CCMEC_PID_300-> SetFillColor(kOrange);
  reco_dp1p2_CCNue_PID_300-> SetFillColor(kCyan-8);
  reco_dp1p2_NC_PID_300-> SetFillColor(31);
  reco_dp1p2_other_PID_300-> SetFillColor(kOrange+6);
  reco_dp1p2_OffBeam_PID-> SetFillColor(kGray);

  THStack *reco_dp1p2_PID_300 = new THStack("reco_dp1p2_PID_300","");
  reco_dp1p2_PID_300-> Add(reco_dp1p2_CCQE_PID_300);
  reco_dp1p2_PID_300-> Add(reco_dp1p2_CCRes_PID_300);
  reco_dp1p2_PID_300-> Add(reco_dp1p2_CCCoh_PID_300);
  reco_dp1p2_PID_300-> Add(reco_dp1p2_CCDIS_PID_300);
  reco_dp1p2_PID_300-> Add(reco_dp1p2_CCMEC_PID_300);
  reco_dp1p2_PID_300-> Add(reco_dp1p2_CCNue_PID_300);
  reco_dp1p2_PID_300-> Add(reco_dp1p2_NC_PID_300);
  reco_dp1p2_PID_300-> Add(reco_dp1p2_other_PID_300);
  reco_dp1p2_PID_300-> Add(reco_dp1p2_OffBeam_PID);
  //reco_dp1p2_PID_300->SetMaximum(50.);
  reco_dp1p2_PID_300-> Draw();
  reco_dp1p2_PID_300->GetXaxis()->SetTitle("No. of Entries");
  ...
  l26 -> SetNColumns(2);
  l26 -> AddEntry(reco_dp1p2_CCQE_PID_300, "CCQE", "f");
  l26 -> AddEntry(reco_dp1p2_CCRes_PID_300, "CCRes", "f");
  l26 -> AddEntry(reco_dp1p2_CCCoh_PID_300, "CCCoh", "f");
  l26 -> AddEntry(reco_dp1p2_CCDIS_PID_300, "DIS", "f");
  l26 -> AddEntry(reco_dp1p2_CCMEC_PID_300, "CCMEC", "f");
  l26 -> AddEntry(reco_dp1p2_CCNue_PID_300, "CC#nu_{e}", "f");
  l26 -> AddEntry(reco_dp1p2_NC_PID_300, "NC", "f");
  l26 -> AddEntry(reco_dp1p2_other_PID_300, "other", "f");
  ...
  TH1 *last26 = (TH1*)reco_dp1p2_PID_300->GetStack()->Last();
  ...
  c26->Update();
  c26->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/dp1p2Reco_topo_PID_300.pdf"); 
  ...
  reco_kp1p2_CCQE_PID_300-> SetFillColor(kRed -10);
  reco_kp1p2_CCRes_PID_300-> SetFillColor(kGreen-8);
  reco_kp1p2_CCCoh_PID_300-> SetFillColor(kAzure+4);
  reco_kp1p2_CCDIS_PID_300-> SetFillColor(kRed-9);
  reco_kp1p2_CCMEC_PID_300-> SetFillColor(kOrange);
  reco_kp1p2_CCNue_PID_300-> SetFillColor(kCyan-8);
  reco_kp1p2_NC_PID_300-> SetFillColor(31);
  reco_kp1p2_other_PID_300-> SetFillColor(kOrange+6);
  reco_kp1p2_OffBeam_PID-> SetFillColor(kGray);

  THStack *reco_kp1p2_PID_300 = new THStack("reco_kp1p2_PID_300","");
  reco_kp1p2_PID_300-> Add(reco_kp1p2_CCQE_PID_300);
  reco_kp1p2_PID_300-> Add(reco_kp1p2_CCRes_PID_300);
  reco_kp1p2_PID_300-> Add(reco_kp1p2_CCCoh_PID_300);
  reco_kp1p2_PID_300-> Add(reco_kp1p2_CCDIS_PID_300);
  reco_kp1p2_PID_300-> Add(reco_kp1p2_CCMEC_PID_300);
  reco_kp1p2_PID_300-> Add(reco_kp1p2_CCNue_PID_300);
  reco_kp1p2_PID_300-> Add(reco_kp1p2_NC_PID_300);
  reco_kp1p2_PID_300-> Add(reco_kp1p2_other_PID_300);
  reco_kp1p2_PID_300-> Add(reco_kp1p2_OffBeam_PID);
  //reco_kp1p2_PID_300->SetMaximum(50.);
  reco_kp1p2_PID_300-> Draw();
  reco_kp1p2_PID_300->GetXaxis()->SetTitle("No. of Entries");
  ...
  l27 -> SetNColumns(2);
  l27 -> AddEntry(reco_kp1p2_CCQE_PID_300, "CCQE", "f");
  l27 -> AddEntry(reco_kp1p2_CCRes_PID_300, "CCRes", "f");
  l27 -> AddEntry(reco_kp1p2_CCCoh_PID_300, "CCCoh", "f");
  l27 -> AddEntry(reco_kp1p2_CCDIS_PID_300, "DIS", "f");
  l27 -> AddEntry(reco_kp1p2_CCMEC_PID_300, "CCMEC", "f");
  l27 -> AddEntry(reco_kp1p2_CCNue_PID_300, "CC#nu_{e}", "f");
  l27 -> AddEntry(reco_kp1p2_NC_PID_300, "NC", "f");
  l27 -> AddEntry(reco_kp1p2_other_PID_300, "other", "f");
  ...
  TH1 *last27 = (TH1*)reco_kp1p2_PID_300->GetStack()->Last();

  chi2test = Chi2Calc(last27,reco_kp1p2_OnBeam_PID, reco_kp1p2_OffBeam_PID, normOffBeam, normMCBNB);
  canvas++;
  outfileDataMC_PID_300<<"canvas: "<<canvas<<"  k (p1+ p2) reco chi2test : "<<chi2test<<std::endl;
  ...
  c27->Update();
  c27->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/kp1p2Reco_topo_PID_300.pdf"); 
  ...
  reco_kp1p2_CCQE_PID_300_btb-> SetFillColor(kRed -10);
  reco_kp1p2_CCRes_PID_300_btb-> SetFillColor(kGreen-8);
  reco_kp1p2_CCCoh_PID_300_btb-> SetFillColor(kAzure+4);
  reco_kp1p2_CCDIS_PID_300_btb-> SetFillColor(kRed-9);
  reco_kp1p2_CCMEC_PID_300_btb-> SetFillColor(kOrange);
  reco_kp1p2_CCNue_PID_300_btb-> SetFillColor(kCyan-8);
  reco_kp1p2_NC_PID_300_btb-> SetFillColor(31);
  reco_kp1p2_other_PID_300_btb-> SetFillColor(kOrange+6);
  reco_kp1p2_OffBeam_PID_btb-> SetFillColor(kGray);

  THStack *reco_kp1p2_PID_300_btb = new THStack("reco_kp1p2_PID_300_btb","");
  reco_kp1p2_PID_300_btb-> Add(reco_kp1p2_CCQE_PID_300_btb);
  reco_kp1p2_PID_300_btb-> Add(reco_kp1p2_CCRes_PID_300_btb);
  reco_kp1p2_PID_300_btb-> Add(reco_kp1p2_CCCoh_PID_300_btb);
  reco_kp1p2_PID_300_btb-> Add(reco_kp1p2_CCDIS_PID_300_btb);
  reco_kp1p2_PID_300_btb-> Add(reco_kp1p2_CCMEC_PID_300_btb);
  reco_kp1p2_PID_300_btb-> Add(reco_kp1p2_CCNue_PID_300_btb);
  reco_kp1p2_PID_300_btb-> Add(reco_kp1p2_NC_PID_300_btb);
  reco_kp1p2_PID_300_btb-> Add(reco_kp1p2_other_PID_300_btb);
  reco_kp1p2_PID_300_btb-> Add(reco_kp1p2_OffBeam_PID_btb);
  //reco_kp1p2_PID_300_btb->SetMaximum(50.);
  reco_kp1p2_PID_300_btb-> Draw();
  reco_kp1p2_PID_300_btb->GetXaxis()->SetTitle("No. of Entries");
  ...
  l28 -> SetNColumns(2);
  l28 -> AddEntry(reco_kp1p2_CCQE_PID_300_btb, "CCQE", "f");
  l28 -> AddEntry(reco_kp1p2_CCRes_PID_300_btb, "CCRes", "f");
  l28 -> AddEntry(reco_kp1p2_CCCoh_PID_300_btb, "CCCoh", "f");
  l28 -> AddEntry(reco_kp1p2_CCDIS_PID_300_btb, "DIS", "f");
  l28 -> AddEntry(reco_kp1p2_CCMEC_PID_300_btb, "CCMEC", "f");
  l28 -> AddEntry(reco_kp1p2_CCNue_PID_300_btb, "CC#nu_{e}", "f");
  l28 -> AddEntry(reco_kp1p2_NC_PID_300_btb, "NC", "f");
  l28 -> AddEntry(reco_kp1p2_other_PID_300_btb, "other", "f");
  ...
  TH1 *last28 = (TH1*)reco_kp1p2_PID_300_btb->GetStack()->Last();

  chi2test = Chi2Calc(last28,reco_kp1p2_OnBeam_PID_btb, reco_kp1p2_OffBeam_PID_btb, normOffBeam, normMCBNB);
  canvas++;
  outfileDataMC_PID_300<<"canvas: "<<canvas<<"  k (p1+ p2) btb reco chi2test : "<<chi2test<<std::endl;
  ...
  c28->Update();
  c28->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/kp1p2Reco_topo_PID_300_btb.pdf"); 
  ...
  reco_angle_SRCrest_p1p2_CCQE_PID_300_CM-> SetFillColor(kRed -10);
  reco_angle_SRCrest_p1p2_CCRes_PID_300_CM-> SetFillColor(kGreen-8);
  reco_angle_SRCrest_p1p2_CCCoh_PID_300_CM-> SetFillColor(kAzure+4);
  reco_angle_SRCrest_p1p2_CCDIS_PID_300_CM-> SetFillColor(kRed-9);
  reco_angle_SRCrest_p1p2_CCMEC_PID_300_CM-> SetFillColor(kOrange);
  reco_angle_SRCrest_p1p2_CCNue_PID_300_CM-> SetFillColor(kCyan-8);
  reco_angle_SRCrest_p1p2_NC_PID_300_CM-> SetFillColor(31);
  //reco_angle_SRCrest_p1p2_other_PID_300_CM-> SetFillColor(kOrange+6);
  reco_angle_SRCrest_p1p2_OffBeam_PID_CM-> SetFillColor(kGray);

  THStack *reco_angle_SRCrest_p1p2_PID_300 = new THStack("reco_angle_SRCrest_p1p2_PID_300","");
  reco_angle_SRCrest_p1p2_PID_300-> Add(reco_angle_SRCrest_p1p2_CCQE_PID_300_CM);
  reco_angle_SRCrest_p1p2_PID_300-> Add(reco_angle_SRCrest_p1p2_CCRes_PID_300_CM);
  reco_angle_SRCrest_p1p2_PID_300-> Add(reco_angle_SRCrest_p1p2_CCCoh_PID_300_CM);
  reco_angle_SRCrest_p1p2_PID_300-> Add(reco_angle_SRCrest_p1p2_CCDIS_PID_300_CM);
  reco_angle_SRCrest_p1p2_PID_300-> Add(reco_angle_SRCrest_p1p2_CCMEC_PID_300_CM);
  reco_angle_SRCrest_p1p2_PID_300-> Add(reco_angle_SRCrest_p1p2_CCNue_PID_300_CM);
  reco_angle_SRCrest_p1p2_PID_300-> Add(reco_angle_SRCrest_p1p2_NC_PID_300_CM);
  //reco_angle_SRCrest_p1p2_PID_300-> Add(reco_angle_SRCrest_p1p2_other_PID_300_CM);
  reco_angle_SRCrest_p1p2_PID_300-> Add(reco_angle_SRCrest_p1p2_OffBeam_PID_CM);
  //reco_angle_SRCrest_p1p2_PID_300->SetMaximum(50.);
  reco_angle_SRCrest_p1p2_PID_300-> Draw();
  reco_angle_SRCrest_p1p2_PID_300->GetXaxis()->SetTitle("No. of Entries");
  ...
  l29 -> SetNColumns(2);
  l29 -> AddEntry(reco_angle_SRCrest_p1p2_CCQE_PID_300_CM, "CCQE", "f");
  l29 -> AddEntry(reco_angle_SRCrest_p1p2_CCRes_PID_300_CM, "CCRes", "f");
  l29 -> AddEntry(reco_angle_SRCrest_p1p2_CCCoh_PID_300_CM, "CCCoh", "f");
  l29 -> AddEntry(reco_angle_SRCrest_p1p2_CCDIS_PID_300_CM, "DIS", "f");
  l29 -> AddEntry(reco_angle_SRCrest_p1p2_CCMEC_PID_300_CM, "CCMEC", "f");
  l29 -> AddEntry(reco_angle_SRCrest_p1p2_CCNue_PID_300_CM, "CC#nu_{e}", "f");
  l29 -> AddEntry(reco_angle_SRCrest_p1p2_NC_PID_300_CM, "NC", "f");
  //l29 -> AddEntry(reco_angle_SRCrest_p1p2_other_PID_300_CM, "other", "f");
  ...
  TH1 *last29 = (TH1*)reco_angle_SRCrest_p1p2_PID_300->GetStack()->Last();
  ...
  canvas++;
  outfileDataMC_PID_300<<"canvas: "<<canvas<<"  cos thetaCM (p1= p2) chi2test : "<<chi2test<<std::endl;
  ...
  c29->Update();
  c29->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/costhetaCM_SRCrest_PID_300.pdf"); 
  ...
  c30->Update();
  c30->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/data_cosanglep1p2RecoCM_topo_PID_300_zoom.pdf");
  ...
  c32->Update();
  c32->Print("/uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/DataMC/Plots/angles_300/data_PTReco_topo_1bibCM_PID_300.pdf");
