...
// Mon Aug 13 12:11:16 2018 by ROOT version 6.06/08
// from TTree cc1unptree/
// found on file: /uboone/app/users/rcastill/ubooneprefilterv06_26_01_13XSEC/work/PlotsPID/files/merged_output_Aug092018_2135_v4/ubxsec_output_data_extbnb_merged.root
//////////////////////////////////////////////////////////

#ifndef hanalysis_fOffBeam_minColl_h
#define hanalysis_fOffBeam_minColl_h
...
class hanalysis_fOffBeam_minColl : public TSelector {
public :
   ...
   hanalysis_fOffBeam_minColl(TTree * /*tree*/ =0) { }
   virtual ~hanalysis_fOffBeam_minColl() { }
   ...
   ClassDef(hanalysis_fOffBeam_minColl,0);

};

#endif

#ifdef hanalysis_fOffBeam_minColl_cxx
void hanalysis_fOffBeam_minColl::Init(TTree *tree)
{
...
Bool_t hanalysis_fOffBeam_minColl::Notify()
{
...
#endif // #ifdef hanalysis_fOffBeam_minColl_cxx
