...
// Mon Aug 13 12:10:34 2018 by ROOT version 6.06/08
...
#ifndef hanalysis_fOffBeam_2pcont_h
#define hanalysis_fOffBeam_2pcont_h
...
class hanalysis_fOffBeam_2pcont : public TSelector {
public :
   ...
   hanalysis_fOffBeam_2pcont(TTree * /*tree*/ =0) { }
   virtual ~hanalysis_fOffBeam_2pcont() { }
   ...
   ClassDef(hanalysis_fOffBeam_2pcont,0);

};

#endif

#ifdef hanalysis_fOffBeam_2pcont_cxx
void hanalysis_fOffBeam_2pcont::Init(TTree *tree)
{
...
Bool_t hanalysis_fOffBeam_2pcont::Notify()
{
...
#endif // #ifdef hanalysis_fOffBeam_2pcont_cxx
