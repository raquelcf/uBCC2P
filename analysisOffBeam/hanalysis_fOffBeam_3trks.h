...
// Mon Aug 13 12:10:26 2018 by ROOT version 6.06/08
...
#ifndef hanalysis_fOffBeam_3trks_h
#define hanalysis_fOffBeam_3trks_h
...
class hanalysis_fOffBeam_3trks : public TSelector {
public :
   ...
   hanalysis_fOffBeam_3trks(TTree * /*tree*/ =0) { }
   virtual ~hanalysis_fOffBeam_3trks() { }
   ...
   ClassDef(hanalysis_fOffBeam_3trks,0);

};

#endif

#ifdef hanalysis_fOffBeam_3trks_cxx
void hanalysis_fOffBeam_3trks::Init(TTree *tree)
{
...
Bool_t hanalysis_fOffBeam_3trks::Notify()
{
...
#endif // #ifdef hanalysis_fOffBeam_3trks_cxx
