...
// Mon Aug 13 12:16:57 2018 by ROOT version 6.06/08
...
#ifndef hanalysis_fOffBeam_PID_h
#define hanalysis_fOffBeam_PID_h
...
class hanalysis_fOffBeam_PID : public TSelector {
public :
   ...
   hanalysis_fOffBeam_PID(TTree * /*tree*/ =0) { }
   virtual ~hanalysis_fOffBeam_PID() { }
   ...
   ClassDef(hanalysis_fOffBeam_PID,0);

};

#endif

#ifdef hanalysis_fOffBeam_PID_cxx
void hanalysis_fOffBeam_PID::Init(TTree *tree)
{
...
Bool_t hanalysis_fOffBeam_PID::Notify()
{
...
#endif // #ifdef hanalysis_fOffBeam_PID_cxx
